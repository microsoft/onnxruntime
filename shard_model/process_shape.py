...
#model = onnx.load('./onnx_models/bert_base_cased_1_fp16_gpu.onnx')
model = onnx.load('./onnx_models/bert_base_cased_1_fp32_gpu.onnx')
...
onnx.save(model, 'bert_base_cased_1_fp32_gpu_shaped.onnx')
