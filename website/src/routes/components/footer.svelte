...
<footer class="footer p-10 mt-10 bg-base-200 text-base-content">
	<div>
		...
		<div class="grid grid-flow-col gap-4">
			<a href="https://www.youtube.com/onnxruntime" target="_blank"><div class="icon pt-0.5"><FaYoutube /></div></a>
			<a href="https://www.linkedin.com/company/onnxruntime" target="_blank"><div class="icon"><FaLinkedinIn /></div></a>
			<a href="https://www.tiktok.com/@onnxruntimeai" target="_blank"><svg xmlns="http://www.w3.org/2000/svg" height="2em" viewBox="0 0 448 512"><!--! Font Awesome Free 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. --><path
			...
			<a href="https://github.com/microsoft/onnxruntime" target="_blank"><div class="icon"><FaGithub /></div></a>
		</div>
	</div>
	<div />
	<div>
