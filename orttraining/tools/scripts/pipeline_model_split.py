...
def split_graph(model, edgeIds):
    ...
    new_send.op_type = 'Send'
    new_receive.op_type = 'Recv'
    new_wait.op_type = 'WaitEvent'
    new_record.op_type = 'RecordEvent'
    ...
    new_record.input.extend([record_signal.name])
    new_wait.input.extend([wait_signal.name])
