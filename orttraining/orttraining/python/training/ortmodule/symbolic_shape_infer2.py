...
class SymbolicShapeInference2:
    ...
    def _onnx_infer_subgraph(self, node, subgraph, use_node_input=True, inc_subgraph_id=True):
        ...
        symbolic_shape_inference = SymbolicShapeInference2(
            self.int_max_,
            self.auto_merge_,
    ...
    def infer_shapes(in_mp, int_max=2**31 - 1, auto_merge=False, guess_output_rank=False, verbose=0):
        ...
        if (not onnx_opset) or onnx_opset < 7:
            ...
            return None
        symbolic_shape_inference = SymbolicShapeInference2(int_max, auto_merge, guess_output_rank, verbose)
...
if __name__ == "__main__":
    ...
    out_mp = SymbolicShapeInference2.infer_shapes(
