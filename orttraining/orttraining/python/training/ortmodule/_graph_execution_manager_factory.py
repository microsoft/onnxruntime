...
class GraphExecutionManagerFactory(object):
    def __init__(self, module, debug_options: DebugOptions, fallback_manager: _FallbackManager, custom_ops):
        self._training_manager = TrainingManager(module, debug_options, fallback_manager, custom_ops)
        self._inference_manager = InferenceManager(module, debug_options, fallback_manager, custom_ops)
