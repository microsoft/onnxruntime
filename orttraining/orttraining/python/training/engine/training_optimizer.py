...
class TrainingOptimizer:
    ...
    def __init__(self, train_optimizer_uri , parameters , env=None, session_options=None, providers=None, **kwargs) -> None:
        """
    ...
    def _create_training_optimizer(self):
        ...
        optimizer = C.Optimizer(self._train_optimizer_uri, self._parameters, self._session_options, self._env, self._providers )
