...
distributed_megatron_full_precision_adam_path = os.path.join(checkpoint_dir, 'distributed_megatron', 'full_precision', 'adam')
distributed_megatron_mixed_precision_adam_path = os.path.join(checkpoint_dir, 'distributed_megatron', 'mixed_precision', 'adam')
distributed_megatron_full_precision_lamb_path = os.path.join(checkpoint_dir, 'distributed_megatron', 'full_precision', 'lamb')
distributed_megatron_mixed_precision_lamb_path = os.path.join(checkpoint_dir, 'distributed_megatron', 'mixed_precision', 'lamb')
distributed_zero_megatron_full_precision_adam_path = os.path.join(checkpoint_dir, 'distributed_zero_megatron', 'full_precision', 'adam')
distributed_zero_megatron_mixed_precision_adam_path = os.path.join(checkpoint_dir, 'distributed_zero_megatron', 'mixed_precision', 'adam')
distributed_zero_megatron_full_precision_lamb_path = os.path.join(checkpoint_dir, 'distributed_zero_megatron', 'full_precision', 'lamb')
distributed_zero_megatron_mixed_precision_lamb_path = os.path.join(checkpoint_dir, 'distributed_zero_megatron', 'mixed_precision', 'lamb')
