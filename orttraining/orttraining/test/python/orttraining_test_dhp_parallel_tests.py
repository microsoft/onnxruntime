...
def main():
    ...
    distributed_test_files = [
        os.path.join("dhp_parallel", "orttraining_test_parallel_train_simple_model.py"),
        os.path.join("dhp_parallel", "orttraining_test_parallel_train_simple_model_fp16.py"),
    ]
