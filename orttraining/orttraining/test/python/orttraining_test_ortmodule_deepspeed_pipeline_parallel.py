...
# deepspeed orttraining_test_ortmodule_deepspeed_pipeline.py --deepspeed_config=orttraining_test_ortmodule_deepspeed_pipeline_config.json --pipeline-parallel-size 2 --steps=100
