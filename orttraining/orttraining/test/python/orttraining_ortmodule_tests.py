...
def run_ortmodule_hierarchal_ortmodule_tests(cwd, log):
    log.debug('Running: ORTModule-Hierarchal model tests')

    command = [sys.executable, '-m', 'pytest', '-sv', 'orttraining_test_hierarchal_ortmodule.py']
...
def main():
    ...
    run_ortmodule_hierarchal_ortmodule_tests(cwd, log,)
