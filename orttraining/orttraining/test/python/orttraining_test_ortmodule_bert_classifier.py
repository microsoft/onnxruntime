...
def main():
    ...
    model._module_manager._execution_manager(model._is_training())._save_onnx = False
    model._module_manager._execution_manager(model._is_training())._save_onnx_prefix = 'BertForSequenceClassification'
