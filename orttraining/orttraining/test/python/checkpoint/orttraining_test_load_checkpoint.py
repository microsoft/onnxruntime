...
def test_load_from_single_node_mixed_precision_into_single_node_mixed_precision(checkpoint_dir, device="cuda"):
    opts = {"device": {"id": device}, "mixed_precision": {"enabled": True}, "debug": {"deterministic_compute": True}}
...
def test_load_from_megatron_to_non_model_parallel_node(
    state_dict_post_checkpoint, expected_state_dict, model, checkpoint_dir
):
...
def test_load_from_distributed_megatron_full_precision_into_single_node_full_precision(checkpoint_dir, device="cuda"):
    ...
    # extract state dictionaries to compare
    state_dict_post_checkpoint, expected_state_dict, model = create_orttrainer_and_load_checkpoint_bart(
        device, opts, checkpoint_dir
    )
    test_load_from_megatron_to_non_model_parallel_node(
        state_dict_post_checkpoint, expected_state_dict, model, checkpoint_dir
    )
...
def test_load_from_distributed_zero_megatron_full_precision_into_single_node_full_precision(
...
def test_load_from_distributed_zero_megatron_mixed_precision_into_single_node_full_precision(
    checkpoint_dir, device="cuda"
):
    opts = {"device": {"id": device}, "debug": {"deterministic_compute": True}}
...
def test_load_from_distributed_zero_megatron_mixed_precision_into_single_node_mixed_precision(
    checkpoint_dir, device="cuda"
):
    opts = {"device": {"id": device}, "mixed_precision": {"enabled": True}, "debug": {"deterministic_compute": True}}
...
def test_load_from_distributed_zero_megatron_full_precision_into_single_node_mixed_precision(
    checkpoint_dir, device="cuda"
):
    opts = {"device": {"id": device}, "mixed_precision": {"enabled": True}, "debug": {"deterministic_compute": True}}
...
@distributed_setup
def test_load_from_single_node_full_precision_into_data_parallelism_full_precision(
    world_rank, world_size, device, checkpoint_dir
):
    opts = {
        "device": {"id": device},
        "distributed": {"world_rank": world_rank, "world_size": world_size, "allreduce_post_accumulation": True},
...
@distributed_setup
def test_load_from_single_node_full_precision_into_data_parallelism_mixed_precision(
    world_rank, world_size, device, checkpoint_dir
):
    opts = {
        "device": {"id": device},
...
@distributed_setup
def test_load_from_data_parallelism_full_precision_into_data_parallelism_full_precision(
    world_rank, world_size, device, checkpoint_dir
):
    opts = {
        "device": {"id": device},
...
@distributed_setup
def test_load_from_data_parallelism_mixed_precision_into_data_parallelism_full_precision(
    world_rank, world_size, device, checkpoint_dir
):
    opts = {
        "device": {"id": device},
...
@distributed_setup
def test_load_from_data_parallelism_mixed_precision_into_data_parallelism_mixed_precision(
    world_rank, world_size, device, checkpoint_dir
):
    opts = {
        "device": {"id": device},
...
@distributed_setup
def test_load_from_data_parallelism_full_precision_into_data_parallelism_mixed_precision(
    world_rank, world_size, device, checkpoint_dir
):
    opts = {
        "device": {"id": device},
...
@distributed_setup
def test_load_from_distributed_zero_mixed_precision_into_data_parallelism_full_precision(
    world_rank, world_size, device, checkpoint_dir
):
    opts = {
        "device": {"id": device},
...
@distributed_setup
def test_load_from_distributed_zero_mixed_precision_into_data_parallelism_mixed_precision(
    world_rank, world_size, device, checkpoint_dir
):
    opts = {
        "device": {"id": device},
...
@distributed_setup
def test_load_from_distributed_megatron_full_precision_into_data_parallelism_full_precision(
    world_rank, world_size, device, checkpoint_dir
):
    opts = {
        "device": {"id": device},
...
@distributed_setup
def test_load_from_distributed_megatron_mixed_precision_into_data_parallelism_full_precision(
    world_rank, world_size, device, checkpoint_dir
):
    opts = {
        "device": {"id": device},
...
@distributed_setup
def test_load_from_distributed_megatron_mixed_precision_into_data_parallelism_mixed_precision(
    world_rank, world_size, device, checkpoint_dir
):
    opts = {
        "device": {"id": device},
...
@distributed_setup
def test_load_from_distributed_megatron_full_precision_into_data_parallelism_mixed_precision(
    world_rank, world_size, device, checkpoint_dir
):
    opts = {
        "device": {"id": device},
...
@distributed_setup
def test_load_from_distributed_zero_megatron_full_precision_into_data_parallelism_full_precision(
    world_rank, world_size, device, checkpoint_dir
):
    opts = {
        "device": {"id": device},
...
@distributed_setup
def test_load_from_distributed_zero_megatron_mixed_precision_into_data_parallelism_full_precision(
    world_rank, world_size, device, checkpoint_dir
):
    opts = {
        "device": {"id": device},
...
@distributed_setup
def test_load_from_distributed_zero_megatron_mixed_precision_into_data_parallelism_mixed_precision(
    world_rank, world_size, device, checkpoint_dir
):
    opts = {
        "device": {"id": device},
...
@distributed_setup
def test_load_from_distributed_zero_megatron_full_precision_into_data_parallelism_mixed_precision(
    world_rank, world_size, device, checkpoint_dir
):
    opts = {
        "device": {"id": device},
...
@distributed_setup
def test_load_from_single_node_mixed_precision_into_distributed_zero_mixed_precision(
    world_rank, world_size, device, checkpoint_dir
):
    opts = {
        "device": {"id": device},
...
@distributed_setup
def test_load_from_single_node_full_precision_into_distributed_zero_mixed_precision(
    world_rank, world_size, device, checkpoint_dir
):
    opts = {
        "device": {"id": device},
...
@distributed_setup
def test_load_from_data_parallelism_full_precision_into_distributed_zero_full_precision(
    world_rank, world_size, device, checkpoint_dir
):
    opts = {
        "device": {"id": device},
...
@distributed_setup
def test_load_from_data_parallelism_mixed_precision_into_distributed_zero_full_precision(
    world_rank, world_size, device, checkpoint_dir
):
    opts = {
        "device": {"id": device},
...
@distributed_setup
def test_load_from_data_parallelism_mixed_precision_into_distributed_zero_mixed_precision(
    world_rank, world_size, device, checkpoint_dir
):
    opts = {
        "device": {"id": device},
...
@distributed_setup
def test_load_from_data_parallelism_full_precision_into_distributed_zero_mixed_precision(
    world_rank, world_size, device, checkpoint_dir
):
    opts = {
        "device": {"id": device},
...
@distributed_setup
def test_load_from_distributed_zero_full_precision_into_distributed_zero_full_precision(
    world_rank, world_size, device, checkpoint_dir
):
    opts = {
        "device": {"id": device},
...
def test_load_from_distributed_zero_mixed_precision_into_distributed_zero_full_precision(
    ...
    if world_rank == 0:
        ...
        aggregated_state_dict2 = aggregate_states(
            checkpoint_dir, filename_prefix="distributed_state", state_dict_key_name=None
        )
...
@distributed_setup
def test_load_from_distributed_zero_mixed_precision_into_distributed_zero_mixed_precision(
    world_rank, world_size, device, checkpoint_dir
):
    opts = {
        "device": {"id": device},
...
@distributed_setup
def test_load_from_distributed_megatron_full_precision_into_distributed_zero_full_precision(
    world_rank, world_size, device, checkpoint_dir
):
    opts = {
        "device": {"id": device},
    ...
    if world_rank == 0:
        # manually aggregate the states for the current full precision zero trainer
        aggregated_state_dict_loaded = aggregate_states(
            checkpoint_dir, filename_prefix="distributed_state", state_dict_key_name=None
        )
...
@distributed_setup
def test_load_from_distributed_megatron_mixed_precision_into_distributed_zero_full_precision(
    world_rank, world_size, device, checkpoint_dir
):
    opts = {
        "device": {"id": device},
...
@distributed_setup
def test_load_from_distributed_megatron_mixed_precision_into_distributed_zero_mixed_precision(
    world_rank, world_size, device, checkpoint_dir
):
    opts = {
        "device": {"id": device},
...
@distributed_setup
def test_load_from_distributed_megatron_full_precision_into_distributed_zero_mixed_precision(
    world_rank, world_size, device, checkpoint_dir
):
    opts = {
        "device": {"id": device},
...
@distributed_setup
def test_load_from_distributed_zero_megatron_full_precision_into_distributed_zero_full_precision(
    world_rank, world_size, device, checkpoint_dir
):
    opts = {
        "device": {"id": device},
...
@distributed_setup
def test_load_from_distributed_zero_megatron_mixed_precision_into_distributed_zero_full_precision(
    world_rank, world_size, device, checkpoint_dir
):
    opts = {
        "device": {"id": device},
...
@distributed_setup
def test_load_from_distributed_zero_megatron_mixed_precision_into_distributed_zero_mixed_precision(
    world_rank, world_size, device, checkpoint_dir
):
    opts = {
        "device": {"id": device},
...
@distributed_setup
def test_load_from_distributed_zero_megatron_full_precision_into_distributed_zero_mixed_precision(
    world_rank, world_size, device, checkpoint_dir
):
    opts = {
        "device": {"id": device},
...
@distributed_setup
def test_load_from_single_node_full_precision_into_distributed_megatron_full_precision(
    world_rank, world_size, device, checkpoint_dir
):
    opts = {
        "device": {"id": device},
...
@distributed_setup
def test_load_from_single_node_mixed_precision_into_distributed_megatron_full_precision(
    world_rank, world_size, device, checkpoint_dir
):
    opts = {
        "device": {"id": device},
...
@distributed_setup
def test_load_from_single_node_full_precision_into_distributed_megatron_mixed_precision(
    world_rank, world_size, device, checkpoint_dir
):
    opts = {
        "device": {"id": device},
...
@distributed_setup
def test_load_from_distributed_zero_full_precision_into_distributed_megatron_mixed_precision(
    world_rank, world_size, device, checkpoint_dir
):
    opts = {
        "device": {"id": device},
...
@distributed_setup
def test_load_from_distributed_megatron_mixed_precision_into_distributed_megatron_full_precision(
    world_rank, world_size, device, checkpoint_dir
):
    opts = {
        "device": {"id": device},
...
@distributed_setup
def test_load_from_distributed_megatron_mixed_precision_into_distributed_megatron_mixed_precision(
    world_rank, world_size, device, checkpoint_dir
):
    opts = {
        "device": {"id": device},
...
@distributed_setup
def test_load_from_distributed_megatron_full_precision_into_distributed_megatron_mixed_precision(
    world_rank, world_size, device, checkpoint_dir
):
    opts = {
        "device": {"id": device},
...
@distributed_setup
def test_load_from_distributed_zero_megatron_full_precision_into_distributed_megatron_mixed_precision(
    world_rank, world_size, device, checkpoint_dir
):
    opts = {
        "device": {"id": device},
...
@distributed_setup
def test_load_from_single_node_full_precision_into_distributed_zero_megatron_full_precision(
    world_rank, world_size, device, checkpoint_dir
):
    opts = {
        "device": {"id": device},
...
@distributed_setup
def test_load_from_data_parallelism_mixed_precision_into_distributed_zero_megatron_mixed_precision(
    world_rank, world_size, device, checkpoint_dir
):
    opts = {
        "device": {"id": device},
...
@distributed_setup
def test_load_from_distributed_zero_megatron_mixed_precision_into_distributed_zero_megatron_full_precision(
    world_rank, world_size, device, checkpoint_dir
):
    opts = {
        "device": {"id": device},
...
@distributed_setup
def test_load_from_distributed_zero_megatron_full_precision_into_distributed_zero_megatron_mixed_precision(
    world_rank, world_size, device, checkpoint_dir
):
    opts = {
        "device": {"id": device},
