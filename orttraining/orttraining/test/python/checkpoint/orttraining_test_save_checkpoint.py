...
def distributed_zero_full_precision_adam(world_rank, world_size, device, checkpoint_dir):
    ...
    create_orttrainer_and_save_checkpoint(
        device, opts, checkpoint_dir, state_dict_key_name="state_dict_" + str(world_rank), use_lamb=False
    )
...
def distributed_zero_full_precision_lamb(world_rank, world_size, device, checkpoint_dir):
    ...
    create_orttrainer_and_save_checkpoint(
        device, opts, checkpoint_dir, state_dict_key_name="state_dict_" + str(world_rank)
    )
