...
TEST(HipKernelTest, ReduceSum_Scalar) {
...
TEST(HipKernelTest, ReduceSum_2DtoLastDim) {
...
TEST(HipKernelTest, ReduceSum_SmallTensor) {
...
TEST(HipKernelTest, ReduceSum_MidTensor) {
...
TEST(HipKernelTest, ReduceSum_LargeTensor) {
