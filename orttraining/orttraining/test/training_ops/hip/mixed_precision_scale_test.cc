...
TEST(HipKernelTest, MixedPrecisionScaleF2F) {
...
TEST(HipKernelTest, MixedPrecisionScaleF2F_MultiInputs) {
  MixedPrecisionScaleInputOutput data;
  OpTester test("MixedPrecisionScale", 9, onnxruntime::kOnnxDomain);
  test.AddAttribute("to", int64_t(ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT));
  test.AddInput<float>("scale", {1}, data.scale);
...
TEST(HipKernelTest, MixedPrecisionScaleF2H) {
  MixedPrecisionScaleInputOutput data;
  OpTester test("MixedPrecisionScale", 9, onnxruntime::kOnnxDomain);
...
TEST(HipKernelTest, MixedPrecisionScaleF2H_MultiInput_FuseOutput) {
  MixedPrecisionScaleInputOutput data;
  OpTester test("MixedPrecisionScale", 9, onnxruntime::kOnnxDomain);
  test.AddAttribute("to", int64_t(ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT16));
...
TEST(HipKernelTest, MixedPrecisionScaleH2F) {
  MixedPrecisionScaleInputOutput data;
  OpTester test("MixedPrecisionScale", 9, onnxruntime::kOnnxDomain);
  test.AddAttribute("to", int64_t(ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT));
  test.AddInput<float>("scale", {1}, data.scale);
...
TEST(HipKernelTest, MixedPrecisionScaleH2F_MultiInputs) {
  MixedPrecisionScaleInputOutput data;
  OpTester test("MixedPrecisionScale", 9, onnxruntime::kOnnxDomain);
  test.AddAttribute("to", int64_t(ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT));
  test.AddInput<float>("scale", {1}, data.scale);
...
TEST(HipKernelTest, MixedPrecisionScaleH2F_MultiInput_FuseOutput) {
  MixedPrecisionScaleInputOutput data;
  OpTester test("MixedPrecisionScale", 9, onnxruntime::kOnnxDomain);
  test.AddAttribute("to", int64_t(ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT));
  test.AddAttribute("fuse_outputs", int64_t(1));
...
TEST(HipKernelTest, MixedPrecisionScaleH2H) {
  MixedPrecisionScaleInputOutput data;
  OpTester test("MixedPrecisionScale", 9, onnxruntime::kOnnxDomain);
  test.AddAttribute("to", int64_t(ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT16));
  test.AddInput<float>("scale", {1}, data.scale);
