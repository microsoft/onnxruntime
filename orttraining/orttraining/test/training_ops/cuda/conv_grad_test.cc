...
TEST(ConvGradTest, Conv2D) {
  ...
  vector<float> dY(49, 1.0f);
  vector<int64_t> dY_shape = {1, 1, 7, 7};
  vector<float> X = {1.3175f,  -0.2202f, -2.3520f, -2.3942f, 0.5968f,  -0.9698f, -0.8287f, -0.5278f, 0.8996f, 0.1229f,
                     -0.4458f, -0.3613f, 0.2516f,  0.3610f,  -0.1302f, 1.6155f,  -0.0953f, 0.3887f,  0.0527f, -0.7381f,
                     -0.5116f, 0.4898f,  1.4216f,  -0.5585f, -1.2954f, 1.0292f,  1.4570f,  0.2884f,  0.6099f, 0.4668f,
  ...
  vector<float> dX = {-1.1080f, -1.1080f, -1.1080f, -1.1080f, -1.1080f, -1.1080f, -1.1080f, -1.1080f, -1.1080f,
                      -1.1080f, -1.1080f, -1.1080f, -1.1080f, -1.1080f, -1.1080f, -1.1080f, -1.1080f, -1.1080f,
                      -1.1080f, -1.1080f, -1.1080f, -1.1080f, -1.1080f, -1.1080f, -1.1080f, -1.1080f, -1.1080f,
                      -1.1080f, -1.1080f, -1.1080f, -1.1080f, -1.1080f, -1.1080f, -1.1080f, -1.1080f, -1.1080f,
                      -1.1080f, -1.1080f, -1.1080f, -1.1080f, -1.1080f, -1.1080f, -1.1080f, -1.1080f, -1.1080f,
                      -1.1080f, -1.1080f, -1.1080f, -1.1080f};
  vector<int64_t> dX_shape = {1, 1, 7, 7};
...
TEST(ConvGradTest, Conv3D) {
  ...
  vector<float> dY(64, 1.0f);
  vector<int64_t> dY_shape = {1, 1, 4, 4, 4};
  vector<float> X = {-1.7622f, -0.4264f, 0.1990f,  -0.7666f, 1.0733f,  0.7785f,  0.8036f,  0.3811f,  0.2928f,  -1.1445f,
                     2.5172f,  -0.3193f, 0.2974f,  1.4834f,  0.1827f,  0.2851f,  -0.2684f, 1.6861f,  -1.9250f, 0.7712f,
                     0.5708f,  1.2153f,  -0.8464f, -1.1737f, 0.6874f,  0.3763f,  0.9535f,  -0.7238f, 0.0993f,  -0.1377f,
                     -0.7175f, 0.7727f,  1.0681f,  2.4251f,  -0.6988f, -0.7789f, -1.2560f, -1.0348f, 1.7029f,  -1.1522f,
                     0.1746f,  1.2720f,  2.3796f,  -2.3989f, -0.4526f, -0.8492f, 0.4867f,  -1.3942f, 1.2623f,  -0.3079f,
                     0.2340f,  2.5356f,  -0.9465f, -0.7411f, 2.0195f,  -0.3935f, -1.3096f, -0.8836f, -0.0671f, 1.0134f,
                     0.7971f,  0.3454f,  0.8945f,  -1.5312f};
  vector<int64_t> X_shape = {1, 1, 4, 4, 4};
  vector<float> W = {-0.1198f};
  vector<int64_t> W_shape = {1, 1, 1, 1, 1};
  vector<float> dX = {-0.1198f, 0.0000f, -0.1198f, 0.0000f, 0.0000f,  0.0000f, 0.0000f, 0.0000f, -0.1198f, 0.0000f,
                      -0.1198f, 0.0000f, 0.0000f,  0.0000f, 0.0000f,  0.0000f, 0.0000f, 0.0000f, 0.0000f,  0.0000f,
                      0.0000f,  0.0000f, 0.0000f,  0.0000f, 0.0000f,  0.0000f, 0.0000f, 0.0000f, 0.0000f,  0.0000f,
                      0.0000f,  0.0000f, -0.1198f, 0.0000f, -0.1198f, 0.0000f, 0.0000f, 0.0000f, 0.0000f,  0.0000f,
                      -0.1198f, 0.0000f, -0.1198f, 0.0000f, 0.0000f,  0.0000f, 0.0000f, 0.0000f, 0.0000f,  0.0000f,
                      0.0000f,  0.0000f, 0.0000f,  0.0000f, 0.0000f,  0.0000f, 0.0000f, 0.0000f, 0.0000f,  0.0000f,
                      0.0000f,  0.0000f, 0.0000f,  0.0000f};
  vector<int64_t> dX_shape = {1, 1, 4, 4, 4};
