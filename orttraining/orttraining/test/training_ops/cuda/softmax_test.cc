...
constexpr float gpu_grad_fp16_tolerance = 1e-3;
#elif USE_ROCM
constexpr const char* kGpuExecutionProvider = kRocmExecutionProvider;
constexpr float gpu_grad_fp16_tolerance = 5e-2;
#endif
...
TEST(CudaKernelTest, SoftmaxGrad_LargeTensor_LastAxis_Float16) {
  ...
  std::vector<int64_t> Y_dims{8, 16, 2048};
  std::vector<int64_t> dX_dims{8, 16, 2048};
  TestSoftmaxGrad<MLFloat16>(dY_dims, Y_dims, dX_dims, 2, false, gpu_grad_fp16_tolerance, gpu_grad_fp16_tolerance);
}
...
TEST(CudaKernelTest, SoftmaxGrad_LargeTensor_AllAxis_Float16) {
  ...
  std::vector<int64_t> Y_dims{8, 16, 512};
  std::vector<int64_t> dX_dims{8, 16, 512};
  TestSoftmaxGrad<MLFloat16>(dY_dims, Y_dims, dX_dims, 0, false, gpu_grad_fp16_tolerance, gpu_grad_fp16_tolerance);
  TestSoftmaxGrad<MLFloat16>(dY_dims, Y_dims, dX_dims, 1, false, gpu_grad_fp16_tolerance, gpu_grad_fp16_tolerance);
}
...
TEST(CudaKernelTest, LogSoftmaxGrad_LargeTensor_LastAxis_Float16) {
  ...
  std::vector<int64_t> Y_dims{8, 16, 2048};
  std::vector<int64_t> dX_dims{8, 16, 2048};
  TestSoftmaxGrad<MLFloat16>(dY_dims, Y_dims, dX_dims, 2, true, gpu_grad_fp16_tolerance, gpu_grad_fp16_tolerance);
}
...
TEST(CudaKernelTest, LogSoftmaxGrad_LargeTensor_AllAxis_Float16) {
  ...
  std::vector<int64_t> Y_dims{8, 16, 512};
  std::vector<int64_t> dX_dims{8, 16, 512};
  TestSoftmaxGrad<MLFloat16>(dY_dims, Y_dims, dX_dims, 0, true, gpu_grad_fp16_tolerance, gpu_grad_fp16_tolerance);
  TestSoftmaxGrad<MLFloat16>(dY_dims, Y_dims, dX_dims, 1, true, gpu_grad_fp16_tolerance, gpu_grad_fp16_tolerance);
}
