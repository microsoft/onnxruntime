...
static void TestBatchNormInternal(bool test_double = false, bool T_is_half = false, bool T1_is_half = false, bool T2_is_half = false, const std::vector<int64_t>& input_output_dims = {2, 2, 2, 2}) {
...
TEST(CudaKernelTest, BNInternal1DInput) {  // float case, 1d input
  ...
  test.AddOutput<float>("Y", input_output_dims, {-0.1948f, 0.2086f, 1.1646f, -0.0951f, -0.1017f, 0.0703f, 1.5754f, 0.1009f, -0.9638f, -1.4131f, 0.5158f, -0.8645f, 0.8622f, -0.3049f, -2.1659f, 1.6059f});
