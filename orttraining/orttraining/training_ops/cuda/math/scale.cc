...
#define REGISTER_SCALE_KERNEL_TYPED(T)                                                                                                                                                                                                       \
  ONNX_OPERATOR_TYPED_KERNEL_EX(                                                                                                                                                                                                             \
      ...
      (*KernelDefBuilder::Create())                                                                                                                                                                                                          \
          ...
          .TypeConstraint("ScaleT", {DataTypeImpl::GetTensorType<float>(), DataTypeImpl::GetTensorType<double>(), DataTypeImpl::GetTensorType<MLFloat16>(), DataTypeImpl::GetTensorType<int64_t>(), DataTypeImpl::GetTensorType<int32_t>()}) \
