...
#ifdef USE_TORCH
class ONNX_OPERATOR_KERNEL_CLASS_NAME(kCpuExecutionProvider, kMSDomain, 1, TorchEmbeddingGrad);
#endif
...
#ifdef USE_TORCH
      BuildKernelCreateInfo<ONNX_OPERATOR_KERNEL_CLASS_NAME(kCpuExecutionProvider, kMSDomain, 1, TorchEmbeddingGrad)>,
#endif
