...
void HostLayerNormGradient(
  ...
  if (mean == nullptr && !simplified) {
    ...
    hipLaunchKernelGGL(HIP_KERNEL_NAME(cuComputePartGradGammaBeta<T, U, false, false>), dim3(blocks2), dim3(threads2), nshared2, 0, 
      dout,
      input,
      output,
      gamma,
    ...
    hipLaunchKernelGGL(HIP_KERNEL_NAME(cuComputePartGradGammaBeta<T, U, true, simplified>), dim3(blocks2), dim3(threads2), nshared2, 0, 
      dout,
      input,
      output,
      gamma,
  ...
  hipLaunchKernelGGL(HIP_KERNEL_NAME(cuComputeGradGammaBeta<T, U, simplified>), dim3(blocks3), dim3(threads3), nshared3, 0, 
      part_grad_gamma,
      part_grad_beta,
      part_size,
      n1, n2,
  ...
  if (mean == nullptr && !simplified) {
    hipLaunchKernelGGL(HIP_KERNEL_NAME(cuComputeGradInput<T, U, false, false>), dim3(blocks1), dim3(threads1), nshared, 0, 
      dout,
      input,
      output,
      gamma,
    ...
    hipLaunchKernelGGL(HIP_KERNEL_NAME(cuComputeGradInput<T, U, true, simplified>), dim3(blocks1), dim3(threads1), nshared, 0, 
        dout,
        input,
        output,
        gamma,
...
#define LAYERNORMGRAD_IMPL(T, U, simplified)                                                                                                  \
  template void HostLayerNormGradient<T, U, simplified>(const hipDeviceProp_t& prop, const T* dout, const T* input, const T* output,           \
