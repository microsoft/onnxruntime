...
#include "orttraining/training_ops/rocm/tensor/split.h"
...
Status SplitTraining::ComputeInternal(OpKernelContext* ctx) const {
  ...
  HipAsyncBuffer<void*> output_ptr(this, num_outputs);
  ...
  if (input_tensor->Shape().Size() > 0) {
    ...
    HipAsyncBuffer<int64_t> split_sizes_gpu(this, split_sizes);
    ...
    HipAsyncBuffer<int64_t> split_sizes_range_gpu(this, split_sizes_range);
