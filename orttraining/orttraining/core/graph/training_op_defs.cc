...
Return true if all elements are true and false otherwise.
  ...
  ONNX_CONTRIB_OPERATOR_SCHEMA(ATenOp)
      ...
      .Attr("requires_grad", "Indices of inputs that requires grad.", AttributeProto::INTS, false)
      .TypeConstraint("T", OpSchema::all_tensor_types(), "Allow inputs and outputs to be any kind of tensor.");
  ...
  ONNX_CONTRIB_OPERATOR_SCHEMA(ATenOpGrad)
      ...
      .SetSupportLevel(OpSchema::SupportType::EXPERIMENTAL)
      .SetDoc("ATenOpGrad")
      .Input(0, "output_grad", "ATenOpGrad's output grad.", "T")
      .Input(1, "context_id", "Context ID generated by the corresponding ATenOp.", "TInt64")
      .Output(0, "input_grads", "ATenOpGrad's input grads.", "T", OpSchema::Variadic,
              /*is_homogeneous*/ false,
              /*min_arity*/ 1)
      .TypeConstraint("T", OpSchema::all_tensor_types(), "Allow inputs and outputs to be any kind of tensor.")
      .TypeConstraint("TInt64", {"tensor(int64)"}, "Constrain input type to 64-bit integer.");
#endif
