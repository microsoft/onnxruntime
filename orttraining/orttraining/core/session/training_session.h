 ...
 public:
  ...
  struct TrainingConfiguration {
    ...
    struct CutEdge {
      ...
      CutEdge(std::string edge, std::vector<std::string> nodes, bool is_non_differentiable_edge) : node_arg_name(edge), consumer_nodes(nodes), non_differentiable_edge(is_non_differentiable_edge){};
    };
