...
class TrainingSession : public InferenceSession {
  ...
  */
  ...
  /** Discover all trainable initializers by reverse DFS from output
  ...
  */
  std::unordered_set<std::string> GetTrainableModelInitializers(const ImmutableWeights& immutable_weights, const std::string& backprop_source_name) const;
