 ...
 * @param candidate_output_args_map  A map from node to its candidate activations. The candidate activations are
 * generated by forward node, and consumed by backward nodes.
