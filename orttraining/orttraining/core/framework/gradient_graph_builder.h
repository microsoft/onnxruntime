...
static std::unordered_map<std::string, std::pair<std::unordered_set<size_t>, std::unordered_set<size_t>>>
    STOP_GRADIENT_EDGES = {
        // {"OpType", {{Input Indices}, {Output Indices}}}
        {"Not", {{0}, {0}}},
        {"And", {{0, 1}, {0}}},
        {"Or", {{0, 1}, {0}}},
        {"Xor", {{0, 1}, {0}}},
