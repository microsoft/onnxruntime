...
Status GradientGraphBuilder::Build(const std::unordered_set<std::string>* p_weights_to_train) {
  ...
  return GraphAugmenter::AugmentGraph(*graph_, gradient_graph_defs, p_weights_to_train);
}
