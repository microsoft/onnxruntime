...
// This method compute the resulting shape from broadcasting.
...
at::IntArrayRef BroadcastShape(const std::string& node_name, OrtValue lhs, OrtValue rhs, onnxruntime::TensorShape& out_shape) {
