...
void CreateMLValue(void* data_ptr, const OrtMemoryInfo& memory_info, onnxruntime::MLDataType element_type, const std::vector<int64_t>& dims, ptrdiff_t offset, const std::vector<int64_t>& strides, OrtValue* p_mlvalue);
