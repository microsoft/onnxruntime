...
void CreateMLValue(void* data_ptr, onnxruntime::AllocatorPtr alloc, onnxruntime::MLDataType element_type, const std::vector<int64_t>& dims, const std::vector<int64_t>& strides, OrtValue* p_mlvalue);
