...
for (const model of models) {
  ...
  describe(`node - ${model}`, () => {
    ...
    const skipModel = [
      ...
      // failed tests
      'test_unique_not_sorted_without_axis',  // bad expected data. enable after https://github.com/onnx/onnx/pull/2381
                                              // is picked up
...
function areEqual(actual: Tensor, expected: Tensor): boolean {
  ...
  switch (actualType) {
    ...
    case 'string':
      return fullEqual(
          actual.data as number[] | string[] | Uint8Array | Int8Array | Uint16Array | Int16Array | Uint32Array |
              Int32Array | BigUint64Array | BigInt64Array,
          expected.data as number[] | string[] | Uint8Array | Int8Array | Uint16Array | Int16Array | Uint32Array |
              Int32Array | BigUint64Array | BigInt64Array);
...
function fullEqual(
    actual: number[]|string[]|Uint8Array|Int8Array|Uint16Array|Int16Array|Uint32Array|Int32Array|BigUint64Array|
    BigInt64Array,
    expected: number[]|string[]|Uint8Array|Int8Array|Uint16Array|Int16Array|Uint32Array|Int32Array|BigUint64Array|
