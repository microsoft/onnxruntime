...
ORT_API_STATUS_IMPL(
  ...
  OrtMemoryInfo mem_info(
    "", OrtAllocatorType::OrtArenaAllocator, execution_provider->GetOrtDeviceByMemType(::OrtMemType::OrtMemTypeDefault)
  );
...
ORT_API_STATUS_IMPL(winmla::GetProviderMemoryInfo, _In_ OrtExecutionProvider* provider, OrtMemoryInfo** memory_info) {
  ...
  *memory_info = new (std::nothrow) OrtMemoryInfo("", ::OrtAllocatorType::OrtArenaAllocator, device);
