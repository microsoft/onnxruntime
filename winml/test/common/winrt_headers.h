...
#define CPPWINRT_INTERNAL_HEADER(root_ns) comp_generated/winrt/##root_ns##.AI.MachineLearning.Internal.h
...
#define CREATE_CPPWINRT_INTERNAL_COMPONENT_HEADER() XSTRINGIFY(CPPWINRT_INTERNAL_HEADER(WINML_ROOT_NS))
...
#include CREATE_CPPWINRT_INTERNAL_COMPONENT_HEADER()
#endif
