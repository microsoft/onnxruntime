...
#define CPPWINRT_TUNING_HEADER(root_ns) comp_generated/winrt/##root_ns##.AI.MachineLearning.Tuning.h
...
#define CREATE_CPPWINRT_TUNING_COMPONENT_HEADER() XSTRINGIFY(CPPWINRT_TUNING_HEADER(WINML_ROOT_NS))
...
#include CREATE_CPPWINRT_TUNING_COMPONENT_HEADER()
#endif
