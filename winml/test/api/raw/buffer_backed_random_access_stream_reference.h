...
struct RandomAccessStream
 ...
 public:
  ...
  /* [propget] */ virtual HRESULT STDMETHODCALLTYPE get_ContentType(
      /* [retval, out] */ __RPC__deref_out_opt HSTRING* value) override {
  ...
  /* [propget] */ virtual HRESULT STDMETHODCALLTYPE get_Size(
      /* [retval, out] */ __RPC__out UINT64* value) override {
    *value = 0;
    uint32_t length;
  ...
  virtual HRESULT STDMETHODCALLTYPE GetInputStreamAt(
      /* [in] */ UINT64 position,
      /* [retval, out] */ __RPC__deref_out_opt ABI::Windows::Storage::Streams::IInputStream** stream) override {
  ...
  virtual HRESULT STDMETHODCALLTYPE Seek(
      /* [in] */ UINT64 position) override {
    position_ = position;
    return S_OK;
  }

  virtual HRESULT STDMETHODCALLTYPE CloneStream(
      /* [retval, out] */ __RPC__deref_out_opt ABI::Windows::Storage::Streams::IRandomAccessStream** stream) override {
  ...
  /* [propget] */ virtual HRESULT STDMETHODCALLTYPE get_CanRead(
      /* [retval, out] */ __RPC__out::boolean* value) override {
    UINT32 length;
    buffer_->get_Length(&length);
  ...
  virtual HRESULT STDMETHODCALLTYPE ReadAsync(
      ...
      /* [retval, out] */ __RPC__deref_out_opt __FIAsyncOperationWithProgress_2_Windows__CStorage__CStreams__CIBuffer_UINT32** operation) override {
...
struct BufferBackedRandomAccessStreamReferenceOpenReadAsync
    : public Microsoft::WRL::RuntimeClass<
          ...
          ABI::Windows::Foundation::IAsyncInfo> {
  InspectableClass(L"WinMLTest.BufferBackedRandomAccessStreamReferenceOpenReadAsync", BaseTrust) public : Microsoft::WRL::ComPtr<ABI::Windows::Storage::Streams::IRandomAccessStreamWithContentType> ras_;
...
struct BufferBackedRandomAccessStreamReference
 ...
 public:
  ...
  virtual HRESULT STDMETHODCALLTYPE OpenReadAsync(
      /* [retval, out] */ __RPC__deref_out_opt __FIAsyncOperation_1_Windows__CStorage__CStreams__CIRandomAccessStreamWithContentType** operation) override {
