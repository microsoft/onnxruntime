...
struct learning_model_device {
 ...
 protected:
  learning_model_device(Details::learning_model_device&& learning_model_device) : m_device(std::move(learning_model_device)) {}
...
struct learning_model_session {
  ...
  learning_model_session(const learning_model& model, const learning_model_device& device) : m_session(model.m_model, device.m_device) {}
