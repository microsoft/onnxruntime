...
template <> struct Tensor<float>          { using Type = ABI::Windows::AI::MachineLearning::ITensorFloat;     };
template <> struct Tensor<float16>        { using Type = ABI::Windows::AI::MachineLearning::ITensorFloat16Bit;};
template <> struct Tensor<int8_t>         { using Type = ABI::Windows::AI::MachineLearning::ITensorInt8Bit;   };
template <> struct Tensor<uint8_t>        { using Type = ABI::Windows::AI::MachineLearning::ITensorUInt8Bit;  };
template <> struct Tensor<uint16_t>       { using Type = ABI::Windows::AI::MachineLearning::ITensorUInt16Bit; };
template <> struct Tensor<int16_t>        { using Type = ABI::Windows::AI::MachineLearning::ITensorInt16Bit;  };
template <> struct Tensor<uint32_t>       { using Type = ABI::Windows::AI::MachineLearning::ITensorUInt32Bit; };
template <> struct Tensor<int32_t>        { using Type = ABI::Windows::AI::MachineLearning::ITensorInt32Bit;  };
template <> struct Tensor<uint64_t>       { using Type = ABI::Windows::AI::MachineLearning::ITensorUInt64Bit; };
template <> struct Tensor<int64_t>        { using Type = ABI::Windows::AI::MachineLearning::ITensorInt64Bit;  };
template <> struct Tensor<bool>           { using Type = ABI::Windows::AI::MachineLearning::ITensorBoolean;   };
template <> struct Tensor<double>         { using Type = ABI::Windows::AI::MachineLearning::ITensorDouble;    };
...
__declspec(selectany) const wchar_t* TensorRuntimeClassID<float>::RuntimeClass_ID = RuntimeClass_Windows_AI_MachineLearning_TensorFloat;
__declspec(selectany) const wchar_t* TensorRuntimeClassID<float16>::RuntimeClass_ID = RuntimeClass_Windows_AI_MachineLearning_TensorFloat16Bit;
__declspec(selectany) const wchar_t* TensorRuntimeClassID<int8_t>::RuntimeClass_ID = RuntimeClass_Windows_AI_MachineLearning_TensorInt8Bit;
__declspec(selectany) const wchar_t* TensorRuntimeClassID<uint8_t>::RuntimeClass_ID = RuntimeClass_Windows_AI_MachineLearning_TensorUInt8Bit;
__declspec(selectany) const wchar_t* TensorRuntimeClassID<uint16_t>::RuntimeClass_ID = RuntimeClass_Windows_AI_MachineLearning_TensorUInt16Bit;
__declspec(selectany) const wchar_t* TensorRuntimeClassID<int16_t>::RuntimeClass_ID = RuntimeClass_Windows_AI_MachineLearning_TensorInt16Bit;
__declspec(selectany) const wchar_t* TensorRuntimeClassID<uint32_t>::RuntimeClass_ID = RuntimeClass_Windows_AI_MachineLearning_TensorUInt32Bit;
__declspec(selectany) const wchar_t* TensorRuntimeClassID<int32_t>::RuntimeClass_ID = RuntimeClass_Windows_AI_MachineLearning_TensorInt32Bit;
__declspec(selectany) const wchar_t* TensorRuntimeClassID<uint64_t>::RuntimeClass_ID = RuntimeClass_Windows_AI_MachineLearning_TensorUInt64Bit;
__declspec(selectany) const wchar_t* TensorRuntimeClassID<int64_t>::RuntimeClass_ID = RuntimeClass_Windows_AI_MachineLearning_TensorInt64Bit;
__declspec(selectany) const wchar_t* TensorRuntimeClassID<bool>::RuntimeClass_ID = RuntimeClass_Windows_AI_MachineLearning_TensorBoolean;
__declspec(selectany) const wchar_t* TensorRuntimeClassID<double>::RuntimeClass_ID = RuntimeClass_Windows_AI_MachineLearning_TensorDouble;

template <typename T> struct TensorFactory { };
template <> struct TensorFactory<float>          { using Factory = ABI::Windows::AI::MachineLearning::ITensorFloatStatics;     };
template <> struct TensorFactory<float16>        { using Factory = ABI::Windows::AI::MachineLearning::ITensorFloat16BitStatics;};
template <> struct TensorFactory<int8_t>         { using Factory = ABI::Windows::AI::MachineLearning::ITensorInt8BitStatics;   };
template <> struct TensorFactory<uint8_t>        { using Factory = ABI::Windows::AI::MachineLearning::ITensorUInt8BitStatics;  };
template <> struct TensorFactory<uint16_t>       { using Factory = ABI::Windows::AI::MachineLearning::ITensorUInt16BitStatics; };
template <> struct TensorFactory<int16_t>        { using Factory = ABI::Windows::AI::MachineLearning::ITensorInt16BitStatics;  };
template <> struct TensorFactory<uint32_t>       { using Factory = ABI::Windows::AI::MachineLearning::ITensorUInt32BitStatics; };
template <> struct TensorFactory<int32_t>        { using Factory = ABI::Windows::AI::MachineLearning::ITensorInt32BitStatics;  };
template <> struct TensorFactory<uint64_t>       { using Factory = ABI::Windows::AI::MachineLearning::ITensorUInt64BitStatics; };
template <> struct TensorFactory<int64_t>        { using Factory = ABI::Windows::AI::MachineLearning::ITensorInt64BitStatics;  };
template <> struct TensorFactory<bool>           { using Factory = ABI::Windows::AI::MachineLearning::ITensorBooleanStatics;   };
template <> struct TensorFactory<double>         { using Factory = ABI::Windows::AI::MachineLearning::ITensorDoubleStatics;    };


template <typename T> struct TensorFactory2 { };
template <> struct TensorFactory2<float> { using Factory = ABI::Windows::AI::MachineLearning::ITensorFloatStatics2; };
template <> struct TensorFactory2<float16> { using Factory = ABI::Windows::AI::MachineLearning::ITensorFloat16BitStatics2; };
template <> struct TensorFactory2<int8_t> { using Factory = ABI::Windows::AI::MachineLearning::ITensorInt8BitStatics2; };
template <> struct TensorFactory2<uint8_t> { using Factory = ABI::Windows::AI::MachineLearning::ITensorUInt8BitStatics2; };
template <> struct TensorFactory2<uint16_t> { using Factory = ABI::Windows::AI::MachineLearning::ITensorUInt16BitStatics2; };
template <> struct TensorFactory2<int16_t> { using Factory = ABI::Windows::AI::MachineLearning::ITensorInt16BitStatics2; };
template <> struct TensorFactory2<uint32_t> { using Factory = ABI::Windows::AI::MachineLearning::ITensorUInt32BitStatics2; };
template <> struct TensorFactory2<int32_t> { using Factory = ABI::Windows::AI::MachineLearning::ITensorInt32BitStatics2; };
template <> struct TensorFactory2<uint64_t> { using Factory = ABI::Windows::AI::MachineLearning::ITensorUInt64BitStatics2; };
template <> struct TensorFactory2<int64_t> { using Factory = ABI::Windows::AI::MachineLearning::ITensorInt64BitStatics2; };
template <> struct TensorFactory2<bool> { using Factory = ABI::Windows::AI::MachineLearning::ITensorBooleanStatics2; };
template <> struct TensorFactory2<double> { using Factory = ABI::Windows::AI::MachineLearning::ITensorDoubleStatics2; };
...
__declspec(selectany) const GUID TensorFactoryIID<float>::IID    = ABI::Windows::AI::MachineLearning::IID_ITensorFloatStatics;
__declspec(selectany) const GUID TensorFactoryIID<float16>::IID  = ABI::Windows::AI::MachineLearning::IID_ITensorFloat16BitStatics;
__declspec(selectany) const GUID TensorFactoryIID<int8_t>::IID   = ABI::Windows::AI::MachineLearning::IID_ITensorInt8BitStatics;
__declspec(selectany) const GUID TensorFactoryIID<uint8_t>::IID  = ABI::Windows::AI::MachineLearning::IID_ITensorUInt8BitStatics;
__declspec(selectany) const GUID TensorFactoryIID<uint16_t>::IID = ABI::Windows::AI::MachineLearning::IID_ITensorUInt16BitStatics;
__declspec(selectany) const GUID TensorFactoryIID<int16_t>::IID  = ABI::Windows::AI::MachineLearning::IID_ITensorInt16BitStatics;
__declspec(selectany) const GUID TensorFactoryIID<uint32_t>::IID = ABI::Windows::AI::MachineLearning::IID_ITensorUInt32BitStatics;
__declspec(selectany) const GUID TensorFactoryIID<int32_t>::IID  = ABI::Windows::AI::MachineLearning::IID_ITensorInt32BitStatics;
__declspec(selectany) const GUID TensorFactoryIID<uint64_t>::IID = ABI::Windows::AI::MachineLearning::IID_ITensorUInt64BitStatics;
__declspec(selectany) const GUID TensorFactoryIID<int64_t>::IID  = ABI::Windows::AI::MachineLearning::IID_ITensorInt64BitStatics;
__declspec(selectany) const GUID TensorFactoryIID<bool>::IID     = ABI::Windows::AI::MachineLearning::IID_ITensorBooleanStatics;
__declspec(selectany) const GUID TensorFactoryIID<double>::IID   = ABI::Windows::AI::MachineLearning::IID_ITensorDoubleStatics;
...
__declspec(selectany) const GUID TensorFactory2IID<float>::IID = ABI::Windows::AI::MachineLearning::IID_ITensorFloatStatics2;
__declspec(selectany) const GUID TensorFactory2IID<float16>::IID = ABI::Windows::AI::MachineLearning::IID_ITensorFloat16BitStatics2;
__declspec(selectany) const GUID TensorFactory2IID<int8_t>::IID = ABI::Windows::AI::MachineLearning::IID_ITensorInt8BitStatics2;
__declspec(selectany) const GUID TensorFactory2IID<uint8_t>::IID = ABI::Windows::AI::MachineLearning::IID_ITensorUInt8BitStatics2;
__declspec(selectany) const GUID TensorFactory2IID<uint16_t>::IID = ABI::Windows::AI::MachineLearning::IID_ITensorUInt16BitStatics2;
__declspec(selectany) const GUID TensorFactory2IID<int16_t>::IID = ABI::Windows::AI::MachineLearning::IID_ITensorInt16BitStatics2;
__declspec(selectany) const GUID TensorFactory2IID<uint32_t>::IID = ABI::Windows::AI::MachineLearning::IID_ITensorUInt32BitStatics2;
__declspec(selectany) const GUID TensorFactory2IID<int32_t>::IID = ABI::Windows::AI::MachineLearning::IID_ITensorInt32BitStatics2;
__declspec(selectany) const GUID TensorFactory2IID<uint64_t>::IID = ABI::Windows::AI::MachineLearning::IID_ITensorUInt64BitStatics2;
__declspec(selectany) const GUID TensorFactory2IID<int64_t>::IID = ABI::Windows::AI::MachineLearning::IID_ITensorInt64BitStatics2;
__declspec(selectany) const GUID TensorFactory2IID<bool>::IID = ABI::Windows::AI::MachineLearning::IID_ITensorBooleanStatics2;
__declspec(selectany) const GUID TensorFactory2IID<double>::IID = ABI::Windows::AI::MachineLearning::IID_ITensorDoubleStatics2;
