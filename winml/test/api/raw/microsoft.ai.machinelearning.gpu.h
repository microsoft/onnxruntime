...
enum directx_device_kind { directx,
                           directx_high_power,
                           directx_min_power };
...
struct directx_device : public learning_model_device {
  ...
  directx_device(ABI::Windows::Graphics::DirectX::Direct3D11::IDirect3DDevice* d3dDevice) : learning_model_device(create_device(d3dDevice)) {}
