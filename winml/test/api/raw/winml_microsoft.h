...
struct Tensor {};
template <>
struct Tensor<float> { using Type = ABI::Microsoft::AI::MachineLearning::ITensorFloat; };
template <>
struct Tensor<float16> { using Type = ABI::Microsoft::AI::MachineLearning::ITensorFloat16Bit; };
template <>
struct Tensor<int8_t> { using Type = ABI::Microsoft::AI::MachineLearning::ITensorInt8Bit; };
template <>
struct Tensor<uint8_t> { using Type = ABI::Microsoft::AI::MachineLearning::ITensorUInt8Bit; };
template <>
struct Tensor<uint16_t> { using Type = ABI::Microsoft::AI::MachineLearning::ITensorUInt16Bit; };
template <>
struct Tensor<int16_t> { using Type = ABI::Microsoft::AI::MachineLearning::ITensorInt16Bit; };
template <>
struct Tensor<uint32_t> { using Type = ABI::Microsoft::AI::MachineLearning::ITensorUInt32Bit; };
template <>
struct Tensor<int32_t> { using Type = ABI::Microsoft::AI::MachineLearning::ITensorInt32Bit; };
template <>
struct Tensor<uint64_t> { using Type = ABI::Microsoft::AI::MachineLearning::ITensorUInt64Bit; };
template <>
struct Tensor<int64_t> { using Type = ABI::Microsoft::AI::MachineLearning::ITensorInt64Bit; };
template <>
struct Tensor<bool> { using Type = ABI::Microsoft::AI::MachineLearning::ITensorBoolean; };
template <>
struct Tensor<double> { using Type = ABI::Microsoft::AI::MachineLearning::ITensorDouble; };

template <typename T>
struct TensorRuntimeClassID {};
template <>
struct TensorRuntimeClassID<float> { static const wchar_t* RuntimeClass_ID; };
template <>
struct TensorRuntimeClassID<float16> { static const wchar_t* RuntimeClass_ID; };
template <>
struct TensorRuntimeClassID<int8_t> { static const wchar_t* RuntimeClass_ID; };
template <>
struct TensorRuntimeClassID<uint8_t> { static const wchar_t* RuntimeClass_ID; };
template <>
struct TensorRuntimeClassID<uint16_t> { static const wchar_t* RuntimeClass_ID; };
template <>
struct TensorRuntimeClassID<int16_t> { static const wchar_t* RuntimeClass_ID; };
template <>
struct TensorRuntimeClassID<uint32_t> { static const wchar_t* RuntimeClass_ID; };
template <>
struct TensorRuntimeClassID<int32_t> { static const wchar_t* RuntimeClass_ID; };
template <>
struct TensorRuntimeClassID<uint64_t> { static const wchar_t* RuntimeClass_ID; };
template <>
struct TensorRuntimeClassID<int64_t> { static const wchar_t* RuntimeClass_ID; };
template <>
struct TensorRuntimeClassID<bool> { static const wchar_t* RuntimeClass_ID; };
template <>
struct TensorRuntimeClassID<double> { static const wchar_t* RuntimeClass_ID; };
...
template <>
struct TensorFactory<float> { using Factory = ABI::Microsoft::AI::MachineLearning::ITensorFloatStatics; };
template <>
struct TensorFactory<float16> { using Factory = ABI::Microsoft::AI::MachineLearning::ITensorFloat16BitStatics; };
template <>
struct TensorFactory<int8_t> { using Factory = ABI::Microsoft::AI::MachineLearning::ITensorInt8BitStatics; };
template <>
struct TensorFactory<uint8_t> { using Factory = ABI::Microsoft::AI::MachineLearning::ITensorUInt8BitStatics; };
template <>
struct TensorFactory<uint16_t> { using Factory = ABI::Microsoft::AI::MachineLearning::ITensorUInt16BitStatics; };
template <>
struct TensorFactory<int16_t> { using Factory = ABI::Microsoft::AI::MachineLearning::ITensorInt16BitStatics; };
template <>
struct TensorFactory<uint32_t> { using Factory = ABI::Microsoft::AI::MachineLearning::ITensorUInt32BitStatics; };
template <>
struct TensorFactory<int32_t> { using Factory = ABI::Microsoft::AI::MachineLearning::ITensorInt32BitStatics; };
template <>
struct TensorFactory<uint64_t> { using Factory = ABI::Microsoft::AI::MachineLearning::ITensorUInt64BitStatics; };
template <>
struct TensorFactory<int64_t> { using Factory = ABI::Microsoft::AI::MachineLearning::ITensorInt64BitStatics; };
template <>
struct TensorFactory<bool> { using Factory = ABI::Microsoft::AI::MachineLearning::ITensorBooleanStatics; };
template <>
struct TensorFactory<double> { using Factory = ABI::Microsoft::AI::MachineLearning::ITensorDoubleStatics; };

template <typename T>
struct TensorFactory2 {};
template <>
struct TensorFactory2<float> { using Factory = ABI::Microsoft::AI::MachineLearning::ITensorFloatStatics2; };
template <>
struct TensorFactory2<float16> { using Factory = ABI::Microsoft::AI::MachineLearning::ITensorFloat16BitStatics2; };
template <>
struct TensorFactory2<int8_t> { using Factory = ABI::Microsoft::AI::MachineLearning::ITensorInt8BitStatics2; };
template <>
struct TensorFactory2<uint8_t> { using Factory = ABI::Microsoft::AI::MachineLearning::ITensorUInt8BitStatics2; };
template <>
struct TensorFactory2<uint16_t> { using Factory = ABI::Microsoft::AI::MachineLearning::ITensorUInt16BitStatics2; };
template <>
struct TensorFactory2<int16_t> { using Factory = ABI::Microsoft::AI::MachineLearning::ITensorInt16BitStatics2; };
template <>
struct TensorFactory2<uint32_t> { using Factory = ABI::Microsoft::AI::MachineLearning::ITensorUInt32BitStatics2; };
template <>
struct TensorFactory2<int32_t> { using Factory = ABI::Microsoft::AI::MachineLearning::ITensorInt32BitStatics2; };
template <>
struct TensorFactory2<uint64_t> { using Factory = ABI::Microsoft::AI::MachineLearning::ITensorUInt64BitStatics2; };
template <>
struct TensorFactory2<int64_t> { using Factory = ABI::Microsoft::AI::MachineLearning::ITensorInt64BitStatics2; };
template <>
struct TensorFactory2<bool> { using Factory = ABI::Microsoft::AI::MachineLearning::ITensorBooleanStatics2; };
template <>
struct TensorFactory2<double> { using Factory = ABI::Microsoft::AI::MachineLearning::ITensorDoubleStatics2; };

template <typename T>
struct TensorFactoryIID {};
template <>
struct TensorFactoryIID<float> { static const GUID IID; };
template <>
struct TensorFactoryIID<float16> { static const GUID IID; };
template <>
struct TensorFactoryIID<int8_t> { static const GUID IID; };
template <>
struct TensorFactoryIID<uint8_t> { static const GUID IID; };
template <>
struct TensorFactoryIID<uint16_t> { static const GUID IID; };
template <>
struct TensorFactoryIID<int16_t> { static const GUID IID; };
template <>
struct TensorFactoryIID<uint32_t> { static const GUID IID; };
template <>
struct TensorFactoryIID<int32_t> { static const GUID IID; };
template <>
struct TensorFactoryIID<uint64_t> { static const GUID IID; };
template <>
struct TensorFactoryIID<int64_t> { static const GUID IID; };
template <>
struct TensorFactoryIID<bool> { static const GUID IID; };
template <>
struct TensorFactoryIID<double> { static const GUID IID; };
...
template <>
struct TensorFactory2IID<float> { static const GUID IID; };
template <>
struct TensorFactory2IID<float16> { static const GUID IID; };
template <>
struct TensorFactory2IID<int8_t> { static const GUID IID; };
template <>
struct TensorFactory2IID<uint8_t> { static const GUID IID; };
template <>
struct TensorFactory2IID<uint16_t> { static const GUID IID; };
template <>
struct TensorFactory2IID<int16_t> { static const GUID IID; };
template <>
struct TensorFactory2IID<uint32_t> { static const GUID IID; };
template <>
struct TensorFactory2IID<int32_t> { static const GUID IID; };
template <>
struct TensorFactory2IID<uint64_t> { static const GUID IID; };
template <>
struct TensorFactory2IID<int64_t> { static const GUID IID; };
template <>
struct TensorFactory2IID<bool> { static const GUID IID; };
template <>
struct TensorFactory2IID<double> { static const GUID IID; };
...
class WinMLLearningModelDevice {
 ...
 public:
  WinMLLearningModelDevice() : WinMLLearningModelDevice(ABI::Microsoft::AI::MachineLearning::LearningModelDeviceKind_Default) {}

  WinMLLearningModelDevice(WinMLLearningModelDevice&& device) : m_learning_model_device(std::move(device.m_learning_model_device)) {}

  WinMLLearningModelDevice(const WinMLLearningModelDevice& device) : m_learning_model_device(device.m_learning_model_device) {}
...
class WinMLLearningModelSessionOptions {
 ...
 private:
  int32_t Initialize() {
    ...
    RETURN_HR_IF_FAILED(
        GetActivationFactory(
            RuntimeClass_Microsoft_AI_MachineLearning_LearningModelSessionOptions,
 ...
 private:
  Microsoft::WRL::ComPtr<ABI::Microsoft::AI::MachineLearning::ILearningModelSessionOptions> m_learning_model_session_options;
};
...
class WinMLLearningModelSession {
 ...
 private:
  int32_t Initialize(const Model& model, const Device& device, const Options& options) {
    ...
    Microsoft::WRL::ComPtr<ABI::Microsoft::AI::MachineLearning::ILearningModelSessionFactory2> learning_model_session_factory2;
