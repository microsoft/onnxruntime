...
namespace Windows::AI::MachineLearning
{
        ...
        ONNX_NAMESPACE::TensorProto_DataType dataType)
    {
        ...
        switch (dataType)
        {
        case TensorType::TensorProto_DataType_BOOL: { return TensorKind::Boolean; }
        case TensorType::TensorProto_DataType_STRING: { return TensorKind::String; }
        case TensorType::TensorProto_DataType_FLOAT16: { return TensorKind::Float16; }
        case TensorType::TensorProto_DataType_FLOAT: { return TensorKind::Float; }
        case TensorType::TensorProto_DataType_DOUBLE: { return TensorKind::Double; }
        case TensorType::TensorProto_DataType_INT8: { return TensorKind::Int8; }
        case TensorType::TensorProto_DataType_INT16: { return TensorKind::Int16; }
        case TensorType::TensorProto_DataType_INT32: { return TensorKind::Int32; }
        case TensorType::TensorProto_DataType_INT64: { return TensorKind::Int64; }
        case TensorType::TensorProto_DataType_UINT8: { return TensorKind::UInt8; }
        case TensorType::TensorProto_DataType_UINT16: { return TensorKind::UInt16; }
        case TensorType::TensorProto_DataType_UINT32: { return TensorKind::UInt32; }
        case TensorType::TensorProto_DataType_UINT64: { return TensorKind::UInt64; }
        case TensorType::TensorProto_DataType_COMPLEX64: { return TensorKind::Complex64; }
        case TensorType::TensorProto_DataType_COMPLEX128: { return TensorKind::Complex128; }
    ...
    TensorKindToString(TensorKind tensorKind)
    {
        switch (tensorKind)
        {
        case TensorKind::Float:      { return "float"; }
        ...
        case TensorKind::Boolean:    { return "boolean"; }
        case TensorKind::Float16:    { return "float16"; }
        case TensorKind::Double:     { return "double"; }
    ...
    static
    std::pair<wgi::BitmapPixelFormat, wgi::BitmapAlphaMode>
        ...
        const char* pixel_format)
    {
        if (pixel_format)
        {
            ...
            if (0 == comparator("Gray8")) { return { wgi::BitmapPixelFormat::Gray8, wgi::BitmapAlphaMode::Premultiplied }; }
            else if (0 == comparator("Rgb8")) { return { wgi::BitmapPixelFormat::Rgba8, wgi::BitmapAlphaMode::Premultiplied }; }
            else if (0 == comparator("Bgr8")) { return { wgi::BitmapPixelFormat::Bgra8, wgi::BitmapAlphaMode::Premultiplied }; }
            else if (0 == comparator("Rgba8")) { return { wgi::BitmapPixelFormat::Rgba8, wgi::BitmapAlphaMode::Straight }; }
            else if (0 == comparator("Bgra8")) { return { wgi::BitmapPixelFormat::Bgra8, wgi::BitmapAlphaMode::Straight }; }
        }
    ...
    CreateImageColorSpaceGamma(const char* color_space_gamma)
    {
        ...
        if (color_space_gamma)
        {
            ...
            if (0 == comparator("Linear")) { return ImageColorSpaceGamma::ImageColorSpaceGamma_Linear; }
            else if (0 == comparator("SRGB")) { return ImageColorSpaceGamma::ImageColorSpaceGamma_SRGB; }
        }
    ...
    CreateImageNominalPixelRange(const char* nominal_range)
    {
        ...
        if (nominal_range)
        {
            ...
            if (0 == comparator("NominalRange_0_255")) { return ImageNominalPixelRange::ImageNominalPixelRange_NominalRange_0_255; }
            else if (0 == comparator("Normalized_0_1")) { return ImageNominalPixelRange::ImageNominalPixelRange_Normalized_0_1; }
            else if (0 == comparator("Normalized_1_1")) { return ImageNominalPixelRange::ImageNominalPixelRange_Normalized_1_1; }
            else if (0 == comparator("NominalRange_16_235")) { return ImageNominalPixelRange::ImageNominalPixelRange_NominalRange_16_235; }
        }
        ...
        const std::unordered_map<std::string, std::string>& metadata)
    {
        ...
        {
            TraceLoggingWrite(g_hWinMLTraceLoggingProvider,
