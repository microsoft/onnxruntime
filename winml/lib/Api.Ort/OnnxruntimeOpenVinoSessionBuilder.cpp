...
#include "E:\work\onnxruntime\include\onnxruntime\core\providers\openvino\openvino_provider_factory.h"

using namespace _winml;

HRESULT OnnxruntimeOpenVinoSessionBuilder::RuntimeClassInitialize(OnnxruntimeEngineFactory* engine_factory) {
