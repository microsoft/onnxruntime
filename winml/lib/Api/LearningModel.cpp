...
namespace winrt::Windows::AI::MachineLearning::implementation
{
    LearningModel::LearningModel(
        ...
        const winml::ILearningModelOperatorProvider op_provider) try :
            LearningModel(
                WinML::Strings::utf8_from_hstring(path),
                op_provider)
    {}
    WINML_CATCH_ALL
    ...
    {
        _winmlt::PerformanceTelemetryEvent load_model_event(
            WINML_RUNTIME_PERF::LOAD_MODEL);
    ...
    void
    LearningModel::LogCreationEvent(bool fromStream)
    {
    ...
    {
        return WinML::Strings::hstring_from_utf8(model_info_->author_);
    }
    WINML_CATCH_ALL
    ...
    {
        return WinML::Strings::hstring_from_utf8(
            model_info_->name_);
    }
    WINML_CATCH_ALL
    ...
    LearningModel::Metadata() try
    {
        ...
        {
            auto key = WinML::Strings::hstring_from_utf8(pair.first);
            auto value = WinML::Strings::hstring_from_utf8(pair.second);
    ...
    void
    LearningModel::OverrideShapeInferenceMethods()
    {
...
namespace winrt::Windows::AI::MachineLearning::factory_implementation
{
        ...
        IUnknown ** pp_model_unk)
    {
        try
        {
            ...
            auto path = WinML::Strings::utf8_from_unicode(p_model_path, model_path_size);
