...
namespace compatibility_details
{
    ...
    {
        auto name = WinML::Strings::utf8_from_hstring(descriptor.Name());
    ...
    */
    ...
    template <> void verify<K::Tensor, K::Tensor>(
    ...
    template <> void verify<K::Map, K::Map>(
        ILearningModelFeatureValue value,
        ILearningModelFeatureDescriptor descriptor)
    {
        thrower fail = std::bind(not_compatible_hr, std::placeholders::_1, value, descriptor);
    ...
    template <> void verify<K::Sequence, K::Sequence>(
        ILearningModelFeatureValue value,
        ILearningModelFeatureDescriptor descriptor)
    {
        thrower fail = std::bind(not_compatible_hr, std::placeholders::_1, value, descriptor);
    ...
    template <> void verify<K::Image, K::Image>(
        ILearningModelFeatureValue value,
        ILearningModelFeatureDescriptor descriptor)
    {
    ...
    template <> void verify<K::Tensor, K::Image>(
        ILearningModelFeatureValue value,
        ILearningModelFeatureDescriptor descriptor)
    {
        thrower fail = std::bind(not_compatible_hr, std::placeholders::_1, value, descriptor);
    ...
    */
    template <> void verify<K::Image, K::Tensor>(
        ILearningModelFeatureValue value,
        ILearningModelFeatureDescriptor descriptor)
    {
        thrower fail = std::bind(not_compatible_hr, std::placeholders::_1, value, descriptor);
