        ...
        WinML::ILotusValueProviderPrivate>
{
    ...
    template <typename T> struct ValidLotusType
       { using Type = T; };
    template <> struct ValidLotusType<winrt::hstring>
        { using Type = std::string; };
    template<> struct ValidLotusType<AbiMapStringToFloat>
        { using Type = std::map<std::string, float>; };
    template<> struct ValidLotusType<AbiMapInt64BitToFloat>
        ...
        OrtValue* ml_value)
    {
        ...
        auto sequence = context.Type == WinML::BindingType::Input
    ...
    {
        return WinML::Strings::hstring_from_utf8(lotus_value);
    }
