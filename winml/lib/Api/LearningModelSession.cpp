...
namespace winrt::Windows::AI::MachineLearning::implementation
{
    ...
    class InferenceSessionProtectedLoadAccessor :
    ...
    LearningModelSession::LearningModelSession(
        winml::LearningModel const& model) try :
    ...
    LearningModelSession::LearningModelSession(
        winml::LearningModel const& model,
        winml::LearningModelDevice const& deviceToRunOn) try :
            LearningModelSession(
                model,
                deviceToRunOn,
                nullptr)
    ...
    LearningModelSession::LearningModelSession(
        ...
        winml::LearningModelSessionOptions const& learningModelSessionOptions) try :
            model_(model),
    ...
    LearningModelSession::GetOptimizedModel(bool should_close_model)
    {
...

        {
            ...
            CWinML_AutoLock lock(&session_creation_lock_);
    ...
    LearningModelSession::Initialize()
    {
        ...
        _winmlt::TelemetryEvent session_creation_event(
            _winmlt::EventCategory::SessionCreation);
        ...
        g_Telemetry.LogSessionCreation(
            WinML::Strings::utf8_from_hstring(model_.Name()),
        ...
        winml::LearningModel& model)
    {
        ...
        std::transform(
            ...
            [&](auto& descriptor)
            {
                ...
                return WinML::Strings::utf8_from_unicode(p_name, size);
            });
        ...
        winrt::com_ptr<winmlp::LearningModelBinding> binding_impl)
    {
        ...
        CWinML_AutoLock lock(!device->IsCpuDevice() ? &evaluate_lock_ : nullptr);
        ...
        uint64_t evaluation_complete_fence)
    {
        ...
        CWinML_AutoLock lock(is_gpu_evaluation ? &evaluate_lock_ : nullptr);
    ...
    LearningModelSession::EvaluateAsync(
        ...
        hstring const correlation_id)
    {
        _winmlt::PerformanceTelemetryEvent eval_model_event(WINML_RUNTIME_PERF::EVAL_MODEL);
    ...
    void
    LearningModelSession::ApplyEvaluationProperties() try
    {
    ...
    void
    LearningModelSession::ToggleProfiler()
    {
        CheckClosed();
    ...
    void
    LearningModelSession::CheckClosed()
    {
