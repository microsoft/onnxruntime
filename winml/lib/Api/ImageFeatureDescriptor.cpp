...
namespace winrt::Windows::AI::MachineLearning::implementation
{
    ImageFeatureDescriptor::ImageFeatureDescriptor(
        ...
        ImageColorSpaceGamma color_space_gamma) :
            name_(WinML::Strings::hstring_from_utf8(name)),
            description_(WinML::Strings::hstring_from_utf8(description)),
    ...
    bool
    ImageFeatureDescriptor::IsRequired() try
    {
        return is_required_;
    }
    WINML_CATCH_ALL
