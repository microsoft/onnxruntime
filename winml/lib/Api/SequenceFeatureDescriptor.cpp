...
hstring SequenceFeatureDescriptor::Name() try { return name_; }
WINML_CATCH_ALL

hstring SequenceFeatureDescriptor::Description() try { return description_; }
WINML_CATCH_ALL

winml::LearningModelFeatureKind SequenceFeatureDescriptor::Kind() try { return LearningModelFeatureKind::Sequence; }
WINML_CATCH_ALL

bool SequenceFeatureDescriptor::IsRequired() try { return is_required_; }
WINML_CATCH_ALL

HRESULT
SequenceFeatureDescriptor::GetName(const wchar_t** name, uint32_t* cchName) {
  *name = name_.data();
...
HRESULT
SequenceFeatureDescriptor::GetDescription(const wchar_t** description, uint32_t* cchDescription) {
...
HRESULT
SequenceFeatureDescriptor::GetDescriptorInfo(_winml::IEngineFactory* engine_factory, _winml::IDescriptorInfo** info) {
