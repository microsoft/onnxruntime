...
ConverterResources::ConverterResources(Pool& pool, CONVERTER_RESOURCE_DESC& descriptor) :
    m_pool(pool),
...
ConverterResourceStore::ConverterResourceStore(size_t nCacheSize) :
    m_cacheSize(nCacheSize)
{
}

std::shared_ptr<ConverterResources> ConverterResourceStore::Fetch(CONVERTER_RESOURCE_DESC& descriptor)
{
...
std::shared_ptr<ConverterResources> ConverterResourceStore::FetchAndRemoveObject(CONVERTER_RESOURCE_DESC& desc)
{
