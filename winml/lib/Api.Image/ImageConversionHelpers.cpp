...
IMG_TENSOR_CHANNEL_TYPE ImageConversionHelpers::GetChannelTypeFromSoftwareBitmap(_In_ const SoftwareBitmap& softwareBitmap)
{
    assert(softwareBitmap != nullptr);

    switch (softwareBitmap.BitmapPixelFormat())
    {
    case BitmapPixelFormat::Bgra8: return IMG_TENSOR_CHANNEL_TYPE_BGR_8;
    case BitmapPixelFormat::Rgba8: return IMG_TENSOR_CHANNEL_TYPE_RGB_8;
    case BitmapPixelFormat::Gray8: return IMG_TENSOR_CHANNEL_TYPE_GRAY_8;
    }

    WINML_THROW_HR(E_INVALIDARG);
}

BitmapPixelFormat ImageConversionHelpers::GetBitmapPixelFormatFromChannelType(_In_ IMG_TENSOR_CHANNEL_TYPE channelType)
{
    switch (channelType)
    {
    case IMG_TENSOR_CHANNEL_TYPE_BGR_8: return BitmapPixelFormat::Bgra8;
    case IMG_TENSOR_CHANNEL_TYPE_RGB_8: return BitmapPixelFormat::Rgba8;
    case IMG_TENSOR_CHANNEL_TYPE_GRAY_8: return BitmapPixelFormat::Gray8;
    }

    WINML_THROW_HR(E_INVALIDARG);
}

IMG_TENSOR_CHANNEL_TYPE ImageConversionHelpers::GetChannelTypeFromDirect3DSurface(_In_ const IDirect3DSurface& direct3DSurface)
{
    ...
    case DirectXPixelFormat::B8G8R8A8UIntNormalized:
    case DirectXPixelFormat::B8G8R8X8UIntNormalized:
        return IMG_TENSOR_CHANNEL_TYPE_BGR_8;

    case DirectXPixelFormat::R8G8B8A8UIntNormalized:
        return IMG_TENSOR_CHANNEL_TYPE_RGB_8;

    case DirectXPixelFormat::R8UIntNormalized:
        return IMG_TENSOR_CHANNEL_TYPE_GRAY_8;
    }
...
DirectXPixelFormat ImageConversionHelpers::GetDirectXPixelFormatFromDXGIFormat(_In_ DXGI_FORMAT dxgiFormat)
{
    ...
    case DXGI_FORMAT_B8G8R8X8_UNORM: return DirectXPixelFormat::B8G8R8X8UIntNormalized;
...
DXGI_FORMAT ImageConversionHelpers::GetDXGIFormatFromDirectXPixelFormat(_In_ DirectXPixelFormat directXPixelFormat)
{
    ...
    {
    case DirectXPixelFormat::B8G8R8A8UIntNormalized: return DXGI_FORMAT_B8G8R8A8_UNORM;
    case DirectXPixelFormat::B8G8R8X8UIntNormalized: return DXGI_FORMAT_B8G8R8X8_UNORM;
    case DirectXPixelFormat::R8G8B8A8UIntNormalized: return DXGI_FORMAT_R8G8B8A8_UNORM;
    case DirectXPixelFormat::R8UIntNormalized:return DXGI_FORMAT_R8_UNORM;
    }

    WINML_THROW_HR(E_INVALIDARG);
}

DirectXPixelFormat ImageConversionHelpers::GetDirectXPixelFormatFromChannelType(_In_ IMG_TENSOR_CHANNEL_TYPE channelType)
{
    switch (channelType)
    {
    case IMG_TENSOR_CHANNEL_TYPE_BGR_8: return DirectXPixelFormat::B8G8R8A8UIntNormalized;
    case IMG_TENSOR_CHANNEL_TYPE_RGB_8: return DirectXPixelFormat::R8G8B8A8UIntNormalized;
    case IMG_TENSOR_CHANNEL_TYPE_GRAY_8: return DirectXPixelFormat::R8UIntNormalized;
    }
