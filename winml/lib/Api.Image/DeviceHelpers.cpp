...
namespace DeviceHelpers
{
        ...
        switch (vendorId)
        {
            case c_intelVendorId:
            {
                ...
                return (majorVersion < 25)
                    || (majorVersion == 25 && minorVersion < 6574)
    ...
    HRESULT GetAdapterEnumerationSupport(AdapterEnumerationSupport* support)
    {
        if (!s_adapterEnumerationSupport.has_value())
        {
            ...
            HRESULT(WINAPI* pDxCoreTestFunc)(REFIID, void**) = DXCoreCreateAdapterFactory;
#endif
            ...
            {
                adapterEnumerationSupport.hasDxgi = true;
            }
#ifdef ENABLE_DXCORE
            ...
            if (!(adapterEnumerationSupport.hasDxgi || adapterEnumerationSupport.hasDxcore))
            {
    ...
    HRESULT GetDXCoreHardwareAdapterWithPreference(DXGI_GPU_PREFERENCE preference, IDXCoreAdapter **ppAdapter)
    {
        ...
        RETURN_HR_IF(ERROR_NOT_FOUND, !firstHardwareAdapterFound);
