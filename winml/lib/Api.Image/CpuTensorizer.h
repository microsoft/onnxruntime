...
namespace Windows::AI::MachineLearning::Internal
{
    ...
    public:
        ...
        static HRESULT TensorizeData(
            _In_ IMG_TENSOR_CHANNEL_TYPE formatFrom,
            _In_ IMG_TENSOR_CHANNEL_TYPE formatTo,
            _In_ BYTE* pBuffer,
...
#pragma warning(disable: 26014) // warning about possible out of bounds accesing pData, but input is checked for BGRA8 format, so uiCapacity should be in multiples of 4
            ...
            uint32_t bytesPerPixel = formatFrom == IMG_TENSOR_CHANNEL_TYPE_GRAY_8 ? 1 : 4;
            ...
            if (formatFrom == IMG_TENSOR_CHANNEL_TYPE_BGR_8 && formatTo == IMG_TENSOR_CHANNEL_TYPE_BGR_8 || formatFrom == IMG_TENSOR_CHANNEL_TYPE_RGB_8 && formatTo == IMG_TENSOR_CHANNEL_TYPE_RGB_8)
            {
            ...
            else if (formatFrom == IMG_TENSOR_CHANNEL_TYPE_BGR_8 && formatTo == IMG_TENSOR_CHANNEL_TYPE_RGB_8 || formatFrom == IMG_TENSOR_CHANNEL_TYPE_RGB_8 && formatTo == IMG_TENSOR_CHANNEL_TYPE_BGR_8)
            {
            ...
            else if (formatTo == IMG_TENSOR_CHANNEL_TYPE_GRAY_8 && (formatFrom == IMG_TENSOR_CHANNEL_TYPE_BGR_8 || formatFrom == IMG_TENSOR_CHANNEL_TYPE_RGB_8))
            {
                // Convert BGR8 -> GRAY8 or RGB8 -> GRAY8
                uint32_t blueIncrement = formatFrom == IMG_TENSOR_CHANNEL_TYPE_BGR_8 ? 0 : 2;
                uint32_t redIncrement = formatFrom == IMG_TENSOR_CHANNEL_TYPE_BGR_8 ? 2 : 0;
            ...
            else if (formatFrom == IMG_TENSOR_CHANNEL_TYPE_GRAY_8 && (formatTo == IMG_TENSOR_CHANNEL_TYPE_BGR_8 || formatTo == IMG_TENSOR_CHANNEL_TYPE_RGB_8))
            {
            ...
            else if (formatFrom == IMG_TENSOR_CHANNEL_TYPE_GRAY_8 && formatTo == IMG_TENSOR_CHANNEL_TYPE_GRAY_8)
            {
                // Convert GRAY8 -> GRAY8
                for (UINT32 i = start; i < end; i += bufferWidth)
                {
