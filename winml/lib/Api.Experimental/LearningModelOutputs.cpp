...
LearningModelOutputs::LearningModelOutputs(winml_experimental::LearningModelBuilder builder) : output_descriptors_(winrt::single_threaded_vector<winml::ILearningModelFeatureDescriptor>()),
                                                                                               builder_(builder) {
}
