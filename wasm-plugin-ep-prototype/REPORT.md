...
| `MAIN_MODULE=1`, legacy EH | **1623.6 KB** | 2.9 KB | PASS | PASS |
| `MAIN_MODULE=1`, legacy EH, ASYNCIFY | **2351.1 KB** | 5.4 KB | PASS | PASS |
| `MAIN_MODULE=2`, legacy EH | 31.7 KB | 2.9 KB | **FAIL** | – |
| `MAIN_MODULE=2`, wasm EH | 33.3 KB | 2.7 KB | PASS | PASS |
| `MAIN_MODULE=2`, wasm EH, pthreads | 46.8 KB | 2.9 KB | PASS | PASS |
| `MAIN_MODULE=2`, wasm EH, pthreads, JSPI | 46.8 KB | 76.1 KB | – | PASS |
...
`-sMAIN_MODULE=2` keeps DCE (33.3 KB vs 27.5 KB baseline — about a 6 KB / 20% overhead), but
