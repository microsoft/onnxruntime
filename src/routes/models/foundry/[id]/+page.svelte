		...
		<div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8 mb-8">
			<div class="flex flex-col lg:flex-row gap-6">
				<div class="flex-1">
					...
					<p class="text-xl text-gray-600 dark:text-gray-300 mb-4">Version {model.version}</p>
					...
					<div class="flex flex-wrap gap-3 mb-6">
						...
						{/each}
						{#if model.framework}
							<span class="badge badge-outline badge-lg">{model.framework}</span>
						{/if}
						{#if model.taskType}
							<span class="badge badge-outline badge-lg">{model.taskType}</span>
						{/if}
					</div>
					...
					<div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-6">
						...
						<div class="space-y-3 text-sm">
							...
							<div class="flex justify-between">
								...
								<span class="font-medium">{model.framework}</span>
							</div>
							<div class="flex justify-between">
