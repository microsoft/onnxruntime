<div class="container mx-auto px-8">
	...
	<div class="grid grid-cols-1 lg:grid-cols-2 divide-x">
		<div class="p-4">
			<h2 class="text-xl font-bold mt-2">ONNX Runtime 1.19.2</h2>
			<p class="font-thin">
				<strong>Released:</strong> 8/26/2024
			</p>
			...
			<p class="font-thin">
				We are planning to upgrade ONNX Runtime support for the following (where the first value is
				the highest version previously supported and the second value is the version support that will
				be added in ORT 1.20):
			</p>
			<ul class="list-disc ml-8">
			...
			<p class="font-thin">
				For a complete list of (tentative) ORT 1.20 features, see <a
					href="#"
						class="text-blue-600 underline bg-warning">here</a
				>.
			</p>
	
			<h2 class="text-xl font-bold mt-2">Feature Requests</h2>
			<p class="font-thin">
				To request new ONNX Runtime features to be included in a future release, please submit a
				feature request through <a href="https://github.com/microsoft/onnxruntime/issues/new?assignees=&labels=feature+request&projects=&template=07-feature_request.yml&title=%5BFeature+Request%5D+" class="text-blue-600 underline">GitHub Issues</a> or
				through <a href="https://github.com/microsoft/onnxruntime/discussions/new?category=ideas-feature-requests" class="text-blue-600 underline">GitHub Discussions</a>.
			</p>
			<p class="font-thin">
		...
		<h2 class="text-xl font-bold mt-2">Core</h2>
		<ul class="list-disc ml-8">
			<li>Add MultiLoRA support.</li>
			<li>
				Improve ThreadPool to spend less time busy waiting (<a
					href="#"
					class="text-blue-600 underline">#21545</a
				>).
			</li>
		...
		<h2 class="text-xl font-bold mt-2">Mobile</h2>
		<ul class="list-disc ml-8">
			<li>
				Add Android QNN support, including a pre-build package, performance improvements, and Phi-3
				model support.
			</li>
		...
		<h2 class="text-xl font-bold mt-2">Web</h2>
		<ul class="list-disc ml-8">
			<li>Add quantized embedding support.</li>
			<li>
				Add on-demand weight loading support, which offloads wasm32 heap and enabled 8B-parameter
				LLM models.
			</li>
			<li>
		...
		<h2 class="text-xl font-bold mt-2">GenAI</h2>
		<ul class="list-disc ml-8">
		...
		<h2 class="text-xl font-bold mt-2">Extensions</h2>
		<ul class="list-disc ml-8">
