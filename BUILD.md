...
* iOS Platforms
   ...
   * [OS64] iOS device (iPhone, iPad) with arm64 architecture
   * [SIMULATOR64] iOS simulator with x86_64 architecture
...
/build.sh --config <Release|Debug|RelWithDebInfo|MinSizeRel> --use_xcode \
           --ios --ios_platform SIMULATOR64 --apple_deploy_target <minimal iOS version>
```
##### Cross build for iOS device
```
/build.sh --config <Release|Debug|RelWithDebInfo|MinSizeRel> --use_xcode \
           --ios --ios_platform OS64 --apple_deploy_target <minimal iOS version>
```
