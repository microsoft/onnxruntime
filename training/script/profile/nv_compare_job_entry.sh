...

{
    ...
    "resources": {
        "workers": {
            ...
            "commandLine": "$PHILLY_DATA_DIRECTORY/$PHILLY_VC/pengwa/profile/nv_compare_job_entry.sh",
            "constraints": [
                {
...
echo "############## 844d9106 ##############"
commitid="844d9106"
bash $ORT_SCRIPT_PATH"/nv_compare_run.sh" $commitid " --use_nccl=True --use_nccl_tensor_fusion=True --cuda_mem_limit=30"
