...
#ifndef FLATBUFFERS_GENERATED_LORASCHEMA_ONNXRUNTIME_LORA_FORMAT_H_
#define FLATBUFFERS_GENERATED_LORASCHEMA_ONNXRUNTIME_LORA_FORMAT_H_
...
struct Parameter FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  onnxruntime::lora_format::TensorDataType data_type() const {
    return static_cast<onnxruntime::lora_format::TensorDataType>(GetField<int32_t>(VT_DATA_TYPE, 0));
  }
...
struct ParameterBuilder {
  ...
  void add_data_type(onnxruntime::lora_format::TensorDataType data_type) {
...
inline ::flatbuffers::Offset<Parameter> CreateParameter(
    ...
    onnxruntime::lora_format::TensorDataType data_type = onnxruntime::lora_format::TensorDataType::UNDEFINED,
...
inline ::flatbuffers::Offset<Parameter> CreateParameterDirect(
  ...
  return onnxruntime::lora_format::CreateParameter(
      _fbb,
      name__,
      dims__,
      data_type,
...
struct Adapter FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  const ::flatbuffers::Vector<::flatbuffers::Offset<onnxruntime::lora_format::Parameter>> *parameters() const {
    return GetPointer<const ::flatbuffers::Vector<::flatbuffers::Offset<onnxruntime::lora_format::Parameter>> *>(VT_PARAMETERS);
  }
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
...
struct AdapterBuilder {
  ...
  void add_parameters(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<onnxruntime::lora_format::Parameter>>> parameters) {
...
inline ::flatbuffers::Offset<Adapter> CreateAdapter(
    ...
    ::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<onnxruntime::lora_format::Parameter>>> parameters = 0) {
...
inline ::flatbuffers::Offset<Adapter> CreateAdapterDirect(
    ...
    int32_t adapter_version = 0,
    int32_t model_version = 0,
    const std::vector<::flatbuffers::Offset<onnxruntime::lora_format::Parameter>> *parameters = nullptr) {
  auto parameters__ = parameters ? _fbb.CreateVector<::flatbuffers::Offset<onnxruntime::lora_format::Parameter>>(*parameters) : 0;
  return onnxruntime::lora_format::CreateAdapter(
      _fbb,
      format_version,
      adapter_version,
      model_version,
...
inline const onnxruntime::lora_format::Adapter *GetAdapter(const void *buf) {
  return ::flatbuffers::GetRoot<onnxruntime::lora_format::Adapter>(buf);
}

inline const onnxruntime::lora_format::Adapter *GetSizePrefixedAdapter(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<onnxruntime::lora_format::Adapter>(buf);
}
...
inline bool VerifyAdapterBuffer(
  ...
  return verifier.VerifyBuffer<onnxruntime::lora_format::Adapter>(AdapterIdentifier());
}

inline bool VerifySizePrefixedAdapterBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<onnxruntime::lora_format::Adapter>(AdapterIdentifier());
}

inline void FinishAdapterBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<onnxruntime::lora_format::Adapter> root) {
...
#endif  // FLATBUFFERS_GENERATED_LORASCHEMA_ONNXRUNTIME_LORA_FORMAT_H_
