...
void addGlobalMethods(py::module& m, Environment& env) {
  ...
  m.def("register_aten_op_executor",
        [](const std::string& is_tensor_argument_address_str, const std::string& aten_op_executor_address_str,
           const std::string& aten_op_backward_executor_address_str) -> void {
          size_t is_tensor_argument_address_int, aten_op_executor_address_int, aten_op_backward_executor_address_int;
          ORT_THROW_IF_ERROR(
          ...
          ORT_THROW_IF_ERROR(ParseStringWithClassicLocale(aten_op_backward_executor_address_str,
                                                          aten_op_backward_executor_address_int));
          ...
          void* p_aten_op_backward_executor = reinterpret_cast<void*>(aten_op_backward_executor_address_int);
          contrib::aten_ops::ATenOperatorExecutor::Initialize(p_is_tensor_argument, p_aten_op_executor,
                                                              p_aten_op_backward_executor);
        });
