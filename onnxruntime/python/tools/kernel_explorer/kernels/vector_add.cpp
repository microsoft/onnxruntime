...
#define REGISTER_OP_VEC_SIZES(name, type, threads_per_block)  \
...
#define REGISTER_OP_VEC_SIZES_TYPES(name, type)  \
  ...
  REGISTER_OP_VEC_SIZES(name, type, 256)         \
  REGISTER_OP_VEC_SIZES(name, type, 320)         \
  REGISTER_OP_VEC_SIZES(name, type, 384)         \
  REGISTER_OP_VEC_SIZES(name, type, 448)         \
