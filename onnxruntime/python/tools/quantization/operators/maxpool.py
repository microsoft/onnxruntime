...
from ..quant_utils import find_by_name, attribute_to_kwarg, ms_domain, QuantizedValue, QuantizedValueType
...
class QMaxPool(QuantOperatorBase):
    ...
    def quantize(self):
        ...
        quantized_output_value = QuantizedValue(node.output[0],
