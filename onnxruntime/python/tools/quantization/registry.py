...
def CreateQDQQuantizer(onnx_quantizer, node, op_types_to_exclude_output_quantization):
    disable_qdq_for_node_output = True if node.op_type in op_types_to_exclude_output_quantization else False
