...
def get_args():
    ...
    parser.add_argument("--input_model", default="./resnet50-v1-7.onnx", help="input model")
    parser.add_argument("--output_model", default="./resnet50-v1-7.quant.onnx", help="output model")
    parser.add_argument("--dataset", default="./test_images", help="calibration data set")
