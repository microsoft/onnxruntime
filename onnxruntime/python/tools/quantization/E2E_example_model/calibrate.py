...
class ONNXCalibrater:
    ...
    def _calculate_scale_zeropoint(self, node, next_node, rmin, rmax):
        zp_and_scale = []
        ...
        for node in model.graph.node:
            ...
            for next_node in next_nodes:
                if node_output_name in quantization_thresholds:
                    ...
                    node_params = self._calculate_scale_zeropoint(node, next_node, node_thresholds[0],node_thresholds[1])
