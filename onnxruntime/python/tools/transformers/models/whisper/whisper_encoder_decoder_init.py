...
class WhisperEncoderDecoderInit(torch.nn.Module):
    ...
    def forward(
        ...
        decinit_out = self.whisper_decoder_init(decoder_input_ids, encoder_hidden_states) # encoder_attention_mask, encoder_hidden_states)
...
class WhisperEncoderDecoderInitInputs:
    def __init__(self, encoder_input_ids, decoder_input_ids=None): # encoder_attention_mask, decoder_input_ids=None):
    ...
    def create_dummy(
        ...
        return WhisperEncoderDecoderInitInputs(encoder_inputs.input_ids, decoder_input_ids) # encoder_attention_mask, decoder_input_ids)
...
class WhisperEncoderDecoderInitHelper:
    ...
    def export_onnx(
        ...
        out = model(inputs.encoder_input_ids, inputs.decoder_input_ids) # inputs.encoder_attention_mask, inputs.decoder_input_ids)
        present = out[2]
        # pdb.set_trace()
