...
# sub32_1 -> present_31
IO_MAPPING = {}
IO_MAPPING["key_states"] = "past_key_0"
IO_MAPPING["value_states"] = "past_value_0"
for i in range(32):
    IO_MAPPING[f"key_states_{i}"] = f"past_key_{i}"
    IO_MAPPING[f"value_states_{i}"] = f"past_value_{i}"
    IO_MAPPING[f"model_layers_{i}_1"] = f"present_key_{i}"
    IO_MAPPING[f"model_layers_{i}_1_1"] = f"present_value_{i}"
IO_MAPPING["lm_head_1"] = "logits"
