...
def run_onnxruntime(args, models):
    ...
    # when doing benchmark, read failing ep information generated by validation phase if file exists
    ...
    if args.failing_models:
        ...
        parse_models_info_from_file(args.failing_models, known_failing_models)
...
def parse_arguments():
    ...
    parser.add_argument("-e", "--failing_models", required=False, default=None, help="List of already known failing models for skipping test.")
