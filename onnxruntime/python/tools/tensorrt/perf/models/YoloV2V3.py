...
class YoloV2V3(BaseModel):
    def __init__(self, model_name='yolov2v3', providers=None): 
        BaseModel.__init__(self, model_name, providers)
        self.inputs_ = []
        self.ref_outputs_ = []
        self.validate_decimal_ = 3 

        self.cvs_model_path_ = os.path.join(os.getcwd(), "..", "cvs_models", "yolov2v3_general", "Animal661", "yolov2v3_general.onnx")
        self.cvs_model_test_data_dir_ = os.path.join(os.getcwd(), "..", "cvs_models", "yolov2v3_general", "Animal661") 
