...
class VehicleDetector(BaseModel):
    def __init__(self, model_name='vehicle-detector', providers=None): 
        BaseModel.__init__(self, model_name, providers)
        self.inputs_ = []
        self.ref_outputs_ = []
        self.validate_decimal_ = 3 

        self.cvs_model_path_ = os.path.join(os.getcwd(), "..", "cvs_models", "Vehicle_detector", "coco_vehicle_rewrite_output-shape.onnx")
        self.cvs_model_test_data_dir_ = os.path.join(os.getcwd(), "..", "cvs_models", "Vehicle_detector") 
