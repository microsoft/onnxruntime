...
class SymbolicShapeInference:
    ...
    def _infer_PythonOp(self, node):  # noqa: N802
        ...
        if get_attribute(node, "name").decode() in ["_ORTTensorInspector", "_IncrementStep"]:
            # PythonOp with name being "_ORTTensorInspector" or "_IncrementStep" will behave exactly same as a normal
