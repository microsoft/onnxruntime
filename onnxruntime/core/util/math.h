...
void Exp(uint64_t N, const T* x, T* y, Provider* provider);
template <typename T, class Provider>
void Log(uint64_t N, const T* x, T* y, Provider* provider);
template <typename T, class Provider>
void Sqr(uint64_t N, const T* x, T* y, Provider* provider);

#define DECLARE_BINARY_OP(name)                                                     \
  template <typename T, class Provider>                                             \
  void name(uint64_t N, const T* a, const T* b, T* y, Provider* provider);          \
  template <typename T, class Provider>                                             \
...
template <typename T, class Provider>
void Sum(uint64_t N, const T* x, T* y, Provider* provider);

template <typename T, class Provider>
void Scale(uint64_t N, float alpha, const T* x, T* y, Provider* provider);
...
// for example on GPU.
template <typename T, class Provider>
void Scale(uint64_t N, const float* alpha, const T* x, T* y, Provider* provider);
