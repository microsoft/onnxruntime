...
ONNX_MS_OPERATOR_SET_SCHEMA(BeamSearch, 1,
                            OpSchema()
                                ...
                                // bugbug: zcode correctness check, use decoder without caching the past.
                                .Attr("encoder", "subgraph for initialization of encoder and decoder. It will be called once before decoder subgraph.", AttributeProto::GRAPH, OPTIONAL_VALUE)
                                ...
                                .Input(10, "attention_mask", "attention mask. Shape is (batch_size, sequence_length)", "I", OpSchema::Optional)
