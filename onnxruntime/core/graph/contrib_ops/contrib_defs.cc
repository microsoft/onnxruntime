...
ONNX_MS_OPERATOR_SET_SCHEMA(MoE, 1,
                            OpSchema()
                                ...
                                .Input(3, "fc1_scales", "shape ?", "T", OpSchema::Optional)
                                .Input(4, "fc1_experts_bias", "2D optional input tensor with shape (num_experts, inter_size)", "T", OpSchema::Optional)
                                .Input(5, "fc2_experts_weights", "3D input tensor with shape (num_experts, inter_size, hidden_size)", "T")
                                .Input(6, "fc2_scales", "shape ?", "T", OpSchema::Optional)
                                .Input(7, "fc2_experts_bias", "2D optional input tensor with shape (num_experts, hidden_size)", "T", OpSchema::Optional)
                                .Input(8, "fc3_experts_weights", "3D optional input tensor with shape (num_experts, hidden_size, inter_size)", "T", OpSchema::Optional)
                                .Input(9, "fc3_scales", "shape ?", "T", OpSchema::Optional)
