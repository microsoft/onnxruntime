...
void RegisterBertSchemas() {
  ...
  ONNX_CONTRIB_OPERATOR_SCHEMA(AttentionDynamicQuant)
      ...
      .Input(3, "mask_index", "Attention mask index with shape (batch_size)", "M")
      .Input(4, "weight_scale", "Weight scale. It's a scalar, which means a per-tensor/layer quantization.", "T1")
      .Input(5, "input_scale", "Input scale. It's a scalar, which means a per-tensor/layer quantization.", "T1", OpSchema::Optional )
