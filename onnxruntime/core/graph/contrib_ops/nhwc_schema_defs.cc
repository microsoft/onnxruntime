...
ONNX_MS_OPERATOR_SET_SCHEMA(QLinearGlobalAveragePool, 1, OpSchema()
    .SetDoc(R"DOC(
...
ONNX_MS_OPERATOR_SET_SCHEMA(QLinearAveragePool, 1,     
    OpSchema().SetDoc(QLinearAveragePoolDoc_ver1)
    .Attr(
        "count_include_pad",
