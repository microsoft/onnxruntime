...
class InferenceSession {
 ...
 private:
  ...
  TimePoint time_sent_last_evalutation_stop_;
  const long long kDurationBetweenSendingEvaluationStop = 1000 * 50; // duration in (us). send a EvaluationStop Event every 50 ms;
