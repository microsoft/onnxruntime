...
class InferenceSession {
 ...
 private:
  ...
  // for the model and the all the necessary criteria for CUDA graph capture has been met.
  // At Run() time, if this member is not nullptr, simply invoke GraphReplay() using it.
  IExecutionProvider* cached_cuda_execution_provider_for_cuda_graph_replay = nullptr;
};
