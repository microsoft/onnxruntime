...
struct ProviderHostImpl : ProviderHost {
  ...
  int IExecutionProvider__GenerateMetaDefId(const IExecutionProvider* p, const onnxruntime::GraphViewer& graph_viewer, uint64_t& model_hash, bool enhensive_hashing_enable) override {
    return p->IExecutionProvider::GenerateMetaDefId(graph_viewer, model_hash, enhensive_hashing_enable);
  }
