...
struct ProviderHostImpl : ProviderHost {
  ...
  void TensorSeq__Insert(TensorSeq* p, Tensor&& tensor, size_t pos) override { p->Insert(std::move(tensor), pos); }
  void TensorSeq__Erase(TensorSeq* p, size_t pos) override { p->Erase(pos); }
