...
struct ProviderHostImpl : ProviderHost {
  ...
  std::string ToUTF8String(std::wstring_view s) override { return onnxruntime::ToUTF8String(s); }
  std::wstring ToWideString(std::string_view s) override { return onnxruntime::ToWideString(s); }
#endif
