...
ORT_API_STATUS_IMPL(InteropEpWait, _In_ OrtSession* session, _In_ void* extSemFence, _In_ OrtSyncStream* stream, _In_ const int fenceState);
ORT_API_STATUS_IMPL(InteropEpSignal, _In_ OrtSession* session, _In_ void* extSemFence, _In_ OrtSyncStream* stream, _In_ const int fenceState);
