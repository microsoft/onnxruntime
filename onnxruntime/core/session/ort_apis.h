...
ORT_API_STATUS_IMPL(GetOrtFenceForGraphicsInterop, _In_ OrtSession* session, _In_ const struct GraphicsInteropParams* graphicsInteropParams, _In_ struct FenceInteropParams* fenceInteropParams, _Outptr_ void** ortFence);
ORT_API_STATUS_IMPL(InteropEpWait, _In_ OrtSession* session, _In_ void* ortFence, _In_ OrtSyncStream* stream, _In_ uint64_t fenceValue);
ORT_API_STATUS_IMPL(InteropEpSignal, _In_ OrtSession* session, _In_ void* ortFence, _In_ OrtSyncStream* stream, _In_ uint64_t fenceValue);
