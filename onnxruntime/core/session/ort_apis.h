...
ORT_API_STATUS_IMPL(GraphViewer_IsConstantInitializer, _In_ const OrtGraphViewer* graph_viewer, _In_ const char* name, _In_ bool check_outer_scope, _Out_ bool* out);
}  // namespace OrtApis
