...
ORT_API_STATUS_IMPL(GetOrtHardwareDevices, _In_ const OrtEnv* env, _Outptr_ const OrtHardwareDevice* const** devices, _Out_ size_t* num_devices);

ORT_API_STATUS_IMPL(GetHardwareDeviceEPIncompatibilityReasons, _In_ const OrtEnv* env, _In_ const char* ep_name, _In_ const OrtHardwareDevice* hw, _Outptr_ OrtDeviceEpIncompatibilityDetails** details);
