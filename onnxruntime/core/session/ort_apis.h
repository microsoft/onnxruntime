...
ORT_API_STATUS_IMPL(SetUserLoggingFunction, _Inout_ OrtSessionOptions* options, OrtLoggingFunction user_logging_function);
ORT_API_STATUS_IMPL(SetUserLoggingParam, _Inout_ OrtSessionOptions* options, void* user_logging_param);
}  // namespace OrtApis
