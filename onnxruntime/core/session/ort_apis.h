...
ORT_API_STATUS_IMPL(CreateAndRegisterExecutionProvider, _Inout_ OrtEnv* env, _In_ bool use_arena, _In_ const char* provider_type, _In_reads_(num_keys) const char* const* provider_options_keys,
...
ORT_API_STATUS_IMPL(CreateAndRegisterExecutionProvider_CPU, _Inout_ OrtEnv* env, _In_ bool use_arena, _Out_ int* provider_global_index);
