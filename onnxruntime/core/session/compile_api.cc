...
ORT_API(void, ReleaseModelCompilationOptions,
...
ORT_API_STATUS_IMPL(CreateModelCompilationOptions, _In_ const OrtEnv* env,
...
ORT_API_STATUS_IMPL(ModelCompilationOptions_SetInputModelPath,
...
ORT_API_STATUS_IMPL(ModelCompilationOptions_SetInputModelFromBuffer,
                    _In_ OrtModelCompilationOptions* model_compile_options,
...
ORT_API_STATUS_IMPL(ModelCompilationOptions_SetOutputModelPath,
                    _In_ OrtModelCompilationOptions* model_compile_options,
...
ORT_API_STATUS_IMPL(ModelCompilationOptions_SetOutputModelBuffer,
                    _In_ OrtModelCompilationOptions* model_compile_options,
...
ORT_API_STATUS_IMPL(ModelCompilationOptions_SetEpContextEmbedMode,
                    _In_ OrtModelCompilationOptions* model_compile_options,
...
ORT_API_STATUS_IMPL(CompileModel, _In_ const OrtEnv* env,
