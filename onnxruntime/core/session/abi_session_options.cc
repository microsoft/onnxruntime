...
ORT_API(void, OrtApis::SetConstantInitializerSparseFlags, _Inout_ OrtSessionOptions* options, int sparse_flags) {
  options->value.constant_initializers_sparse_flags = sparse_flags;
}
