...
CustomExecutionProvider* ProviderLibrary2::CreateExternalEPInstance(const std::unordered_map<std::string, std::string>& provider_options) {
  if (handle_) {
...
CustomExecutionProvider* Environment::CreateExternalEPInstance(const std::string& provider_type, const std::unordered_map<std::string, std::string>& provider_options) {
