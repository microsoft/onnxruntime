...
// The corresponding kernels are registered inside the appropriate execution provider.
    ...
    static std::vector<std::string> all_types = [] () {
      std::vector<std::string> all_supported_types;
      ...
      all_supported_types.insert(all_types.end(), all_tensor_types.begin(), all_tensor_types.end());
      all_supported_types.insert(all_types.end(), all_sequence_types.begin(), all_sequence_types.end());
      all_supported_types.emplace_back("seq(tensor(bfloat16))");
