...
struct AllocPlanPerValue {
  ...
  // reused_tensor_in_tensor_sequence is valid only if value_type == SequenceTensorType. It indicates
  // which tensor within the tensor sequence must be reused for this OrtValue.
