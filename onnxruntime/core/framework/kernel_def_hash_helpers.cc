...
void UpdateHashForBackwardsCompatibility(HashValue& hash) {
  ...
  static const std::unordered_map<HashValue, HashValue> hashes{
      ...
      {4058615579523172864ULL, 4827261308628792072ULL},     // kOnnxDomain, LayerNormalization, 1, float
      {8466416990072218056ULL, 18418354579469131656ULL},    // kOnnxDomain, LayerNormalization, 1, double
