...
struct ProviderHostImpl : ProviderHost {
  ...
  // IExecutionProvider
  AllocatorPtr IExecutionProvider__GetAllocator(const IExecutionProvider* p, int id, OrtMemType mem_type) { return p->IExecutionProvider::GetAllocator(id, mem_type); }
