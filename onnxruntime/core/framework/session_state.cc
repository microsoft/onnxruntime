...
static Status KernelStorePrePackedWeight(OpKernel* kernel, int input_idx,
                                         const PrepackedWeight& prepacked_weight,
              ...
              if (constant_initialized_tensors.count(ort_value_idx)) {
                ...
                if (is_shared_initializer && should_cache_prepacked_weights_for_shared_initializers &&
                  ...
                  if (is_packed) {
                    ...
                    auto prepacked_weight_hash = weight_to_be_filled_in.GetHash();
                    ...
                    if (container_contains_packed_weight) {
                      ...
                      ++used_cached_pre_packed_weight_counter_;
                      ...
                      prepacked_weights_container_->WriteCachedWeight(prepacked_weights_container_key, std::move(weight_to_be_filled_in));
