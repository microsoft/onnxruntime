...
#endif
  // This hashmap is used during model load with prepacked initializer saved in ONNX data file.
  // ORT reads prepacked initializers and store them into this hashmap so we could skip PrePack
