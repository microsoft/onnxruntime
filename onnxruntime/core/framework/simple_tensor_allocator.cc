...
common::Status SimpleTensorAllocator::GetPreallocatedBuffer(int ort_value_index, const std::string& /*name*/, std::optional<MemBuffer>& /*buf_out*/, AllocatorPtr& alloc_out) {
