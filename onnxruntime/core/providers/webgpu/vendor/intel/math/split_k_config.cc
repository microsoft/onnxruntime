...
SplitKConfig CreateSplitKConfig(std::string_view architecture) {
  ...
  if (architecture == "xe-2lpg" || architecture == "xe-2hpg" ||
    ...
    return SplitKConfig{
        max_batch_size, split_dim_inner, min_dim_inner_with_split_k,
        {{768, 52.0}, {2304, 35.0}, {3072, 21.5}, {4096, 16.0}}};
  }
