...
class MatMulNaiveProgram final : public Program<MatMulNaiveProgram> {
 public:
  MatMulNaiveProgram(const Activation& activation, const int64_t output_size, int64_t output_number, bool has_bias)
      : Program{"MatMulNaive"}, activation_(activation), output_size_(output_size), output_number_(output_number), has_bias_{has_bias} {
  }
