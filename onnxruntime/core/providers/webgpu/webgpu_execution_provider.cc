...
class ONNX_OPERATOR_VERSIONED_KERNEL_CLASS_NAME(kWebGpuExecutionProvider, kOnnxDomain, 19, 21, QuantizeLinear);
class ONNX_OPERATOR_VERSIONED_KERNEL_CLASS_NAME(kWebGpuExecutionProvider, kOnnxDomain, 22, 24, QuantizeLinear);
...
std::unique_ptr<KernelRegistry> RegisterKernels(bool enable_graph_capture = false) {
  ...
  static const BuildKernelCreateInfoFn function_table[] = {
      ...
      KERNEL_CREATE_INFO_VERSIONED(19, 21, QuantizeLinear),
      KERNEL_CREATE_INFO_VERSIONED(22, 24, QuantizeLinear),
