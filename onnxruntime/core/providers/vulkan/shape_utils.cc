...
// TODO: These helpers were copied from the CoreML EP. We could move to a shared location and if possible unify
// with the slightly different implementation for the NNAPI EP which uses 0 for an empty shape.
