...
class Shaper {
 public:
  ...
  common::Status Split(const std::string& input_name, int32_t axis, int32_t count,
 ...
 private:
  ...
  common::Status SplitImpl(const std::string& input_name, int32_t axis, int32_t count,
                           const std::vector<std::string>& output_names);
