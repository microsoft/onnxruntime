...
class Shaper {
 public:
  ...
  common::Status DepthToSpace(const std::string& input_name, const int32_t blocksize, const std::string& output_name);
 ...
 private:
  ...
  common::Status DepthToSpaceImpl(const std::string& input_names, const int32_t blocksize, const std::string& output_name);
