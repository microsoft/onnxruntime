  ...
  Status operator()(const GemmParams<T>* params) {
    ...
    return ROCBLAS_CALL(
        rocblas_gemm_ex(
            ...
            &h_a,
            params->b,
            RocBlasDataTypeFor(params->b),
            params->ldb,
            params->a,
            RocBlasDataTypeFor(params->a),
            params->lda,
            &h_b,
            params->c,
            RocBlasDataTypeFor(params->c),
            params->ldc,
            params->c,
            RocBlasDataTypeFor(params->c),
            params->ldc,
  ...
  Status operator()(const BatchedGemmParams<T>* params) {
    ...
    return ROCBLAS_CALL(
        rocblas_gemm_batched_ex(
            ...
            &h_a,
            params->bs,
            RocBlasDataTypeFor(*(params->bs)),
            params->ldb,
            params->as,
            RocBlasDataTypeFor(*(params->as)),
            params->lda,
            &h_b,
            params->cs,
            RocBlasDataTypeFor(*(params->cs)),
            params->ldc,
            params->cs,
            RocBlasDataTypeFor(*(params->cs)),
            params->ldc,
