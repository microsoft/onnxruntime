...
GEMM(double, double) {
  return CALL_GEMM(double, double);
}
...
GEMM(half, half) {
  return CALL_GEMM(half, half);
}

GEMM(BFloat16, BFloat16) {
  return CALL_GEMM(BFloat16, BFloat16);
}

GEMM(double, float) {
  return CALL_GEMM(double, float);
}

GEMM(half, float) {
  return CALL_GEMM(half, float);
}

GEMM(BFloat16, float) {
  return CALL_GEMM(BFloat16, float);
}
...
GEMM(double, double) {
  return CALL_GEMM_WITH_AB_SWAPPED(double, double);
}
...
GEMM(half, half) {
  return CALL_GEMM_WITH_AB_SWAPPED(half, half);
}

GEMM(BFloat16, BFloat16) {
  return CALL_GEMM_WITH_AB_SWAPPED(BFloat16, BFloat16);
}

GEMM(double, float) {
  return CALL_GEMM_WITH_AB_SWAPPED(double, float);
}

GEMM(half, float) {
  return CALL_GEMM_WITH_AB_SWAPPED(half, float);
}

GEMM(BFloat16, float) {
  return CALL_GEMM_WITH_AB_SWAPPED(BFloat16, float);
}
