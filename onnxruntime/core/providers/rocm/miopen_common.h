...
inline miopenStatus_t CompactMiopenPoolingForward(miopenHandle_t handle,
...
inline miopenStatus_t CompactMiopenSetNdPoolingDescriptor(miopenPoolingDescriptor_t poolDesc,
