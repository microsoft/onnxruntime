...
struct GridDim {
  static constexpr HIP_LONG maxThreadsPerBlock = 256;  // max threads per block
  static constexpr HIP_LONG maxElementsPerThread = 4;  // max element processed per thread
};
