...
struct SubgraphParams {
  Prov_NodeAttributes attributes;
...
class DnnlFuncKernel {
 public:
  ...
  std::string GetPoolAttributesKey(const Prov_NodeAttributes& attributes,
  ...
  std::string GetConvAttributeKey(const Prov_NodeAttributes& attributes,
                                  const std::string attributes_prefix = "") {
    std::string key;
  ...
  std::string GetLrnAttributeKey(const Prov_NodeAttributes& attributes,
                                 const std::string attributes_prefix = "") {
    std::string key;
