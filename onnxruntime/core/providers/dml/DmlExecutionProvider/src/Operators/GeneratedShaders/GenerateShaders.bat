...
if "%1" == "DEBUG" (
    ...
    fxc.exe ..\Shaders\bluestein_chirp.hlsl -E DFT -T cs_5_0 /DTBUFFER=float /Zi /Od /Fh bluestein_chirp.h
    dxc.exe ..\Shaders\bluestein_chirp.hlsl -E DFT -T cs_6_2 -DTBUFFER=float16_t -enable-16bit-types -Zi -Od -Qembed_debug -Fh bluestein_chirp_fp16.h
) else (
    ...
    fxc.exe ..\Shaders\bluestein_chirp.hlsl -E DFT -T cs_5_0 /DTBUFFER=float /O3 /Qstrip_reflect /Qstrip_debug /Qstrip_rootsignature /Qstrip_priv /Fh bluestein_chirp.h
    dxc.exe ..\Shaders\bluestein_chirp.hlsl -E DFT -T cs_6_2 -DTBUFFER=float16_t -enable-16bit-types -O3 -Qstrip_reflect -Qstrip_debug -Qstrip_rootsignature -Fh bluestein_chirp_fp16.h
)
