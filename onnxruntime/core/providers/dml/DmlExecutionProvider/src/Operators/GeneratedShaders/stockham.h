...
if_nz r0.y
  ...
  if_nz r1.z
    ...
    ieq r1.z, cb0[5].w, l(2)
    if_nz r1.z
      imad r1.z, r0.w, cb0[6].z, cb0[6].w
      ld_structured_indexable(structured_buffer, stride=4)(mixed,mixed,mixed,mixed) r4.y, r1.z, l(0), u2.xxxx
    else 
      mov r4.y, l(0)
    endif 
  else 
...
{
     68,  88,  66,  67, 148, 227, 
    171, 208, 144, 180, 126, 144, 
    199, 220,  66, 178,  44, 241, 
     77, 167,   1,   0,   0,   0, 
    164,  12,   0,   0,   3,   0, 
      0,   0,  44,   0,   0,   0, 
     60,   0,   0,   0,  76,   0, 
