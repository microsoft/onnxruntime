...
public:
        ...
        StockhamParameters& params)
    {
        ...
        params.Window.BufferRegion = Dml::D3D12BufferRegion();
        ...
        )
    {
        ...
        else
        {
            ...
            auto zChirpBufferRegion= kernelContext->AllocateDefaultBuffer(zChirpBufferByteSize);
            auto aFFTBufferRegion = kernelContext->AllocateDefaultBuffer(aIntermediateBufferByteSize);
            auto bBufferRegion = kernelContext->AllocateDefaultBuffer(bIntermediateBufferByteSize);
            auto bFFTBufferRegion = kernelContext->AllocateDefaultBuffer(bIntermediateBufferByteSize);
            ...
            PrepareStockhamFFTParams(
                ...
                aFFTBufferRegion, params.BluesteinZChirpParams.AFFT.Sizes,
                M,
                m_axis,
                1,
    ...
    void BluesteinZChirp(const DFTParameters& dftParams, bool isInverse, ID3D12GraphicsCommandList* commandList)
    {
        ...
        auto inputResource =  bluesteinZChirpParams.AFFTParams.ResourceLoopList.front().BufferRegion.ResourceInUavState();
        auto outputResource = bluesteinZChirpParams.AFFTInverseParams.ResourceLoopList[bluesteinZChirpParams.AFFTInverseParams.OutputIndex].BufferRegion.ResourceInUavState();
        auto zChirpResource = bluesteinZChirpParams.ZChirp.BufferRegion.ResourceInUavState();
        auto aFFTResource = bluesteinZChirpParams.AFFT.BufferRegion.ResourceInUavState();
        auto bResource = bluesteinZChirpParams.B.BufferRegion.ResourceInUavState();
        auto bFFTResource = bluesteinZChirpParams.BFFT.BufferRegion.ResourceInUavState();
        ...
        std::array<Dml::D3D12BufferRegion, 2> bufferRegions = { bluesteinZChirpParams.ZChirp.BufferRegion, bluesteinZChirpParams.B.BufferRegion };
        Dispatch(bufferRegions, constants, commandList);
        ...
        ID3D12GraphicsCommandList* commandList)
    {
        ...
        auto windowResource = dftParams.StockhamParams.Window.BufferRegion.ResourceInUavState();
        ...
        for (unsigned index = 0; index < stockhamParams.NumberOfPasses; index++)
        {
            ...
            auto window = constants.HasWindow ? dftParams.StockhamParams.Window.BufferRegion : out;
            std::array<Dml::D3D12BufferRegion, 3> bufferRegions = { in, out, window };
            Dispatch(bufferRegions, constants, commandList);
        }
    }
        ...
        ID3D12GraphicsCommandList* commandList)
    {
        ...
        {
            // Set resource views
            if (bufferRegions[i].ResourceInUavState()) {
