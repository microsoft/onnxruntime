...
public:
    DmlOperatorElementwiseQLinear(const MLOperatorKernelCreationContext& kernelInfo) : DmlOperator(kernelInfo)
    {
        ...
        if constexpr (std::is_same_v<TOperatorDesc, DML_QUANTIZE_OPERATOR_DESC> || std::is_same_v<TOperatorDesc, DML_DEQUANTIZE_OPERATOR_DESC>)
        {
...
DML_OP_DEFINE_CREATION_FUNCTION(QuantizeLinear10,   DmlOperatorElementwiseQLinear<DML_ELEMENT_WISE_QUANTIZE_LINEAR_OPERATOR_DESC>);
DML_OP_DEFINE_CREATION_FUNCTION(QuantizeLinear13,   DmlOperatorElementwiseQLinear<DML_ELEMENT_WISE_QUANTIZE_LINEAR_OPERATOR_DESC>);
DML_OP_DEFINE_CREATION_FUNCTION(QuantizeLinear19,   DmlOperatorElementwiseQLinear<DML_ELEMENT_WISE_QUANTIZE_LINEAR_OPERATOR_DESC>);
DML_OP_DEFINE_CREATION_FUNCTION(QuantizeLinear21,   DmlOperatorElementwiseQLinear<DML_QUANTIZE_OPERATOR_DESC>);
...
DML_OP_DEFINE_CREATION_FUNCTION(DequantizeLinear10, DmlOperatorElementwiseQLinear<DML_ELEMENT_WISE_DEQUANTIZE_LINEAR_OPERATOR_DESC>);
DML_OP_DEFINE_CREATION_FUNCTION(DequantizeLinear13, DmlOperatorElementwiseQLinear<DML_ELEMENT_WISE_DEQUANTIZE_LINEAR_OPERATOR_DESC>);
DML_OP_DEFINE_CREATION_FUNCTION(DequantizeLinear19, DmlOperatorElementwiseQLinear<DML_ELEMENT_WISE_DEQUANTIZE_LINEAR_OPERATOR_DESC>);
DML_OP_DEFINE_CREATION_FUNCTION(DequantizeLinear21, DmlOperatorElementwiseQLinear<DML_DEQUANTIZE_OPERATOR_DESC>);
