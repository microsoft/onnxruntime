...
class DmlOperatorFastGelu : public DmlOperator
{
public:
    DmlOperatorFastGelu(const MLOperatorKernelCreationContext& kernelCreationContext)
...
DML_OP_DEFINE_CREATION_FUNCTION(FastGelu, DmlOperatorFastGelu);
