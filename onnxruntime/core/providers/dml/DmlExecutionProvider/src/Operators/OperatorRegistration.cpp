...
constexpr static std::array<SupportedTensorDataTypes, 2> supportedTypeListQuantizeLinear = { SupportedTensorDataTypes::Int16 | SupportedTensorDataTypes::UInt16 | SupportedTensorDataTypes::Float32 | SupportedTensorDataTypes::Int32,  SupportedTensorDataTypes::Int16 | SupportedTensorDataTypes::UInt16 | SupportedTensorDataTypes::UInt8 | SupportedTensorDataTypes::Int8 };
constexpr static std::array<SupportedTensorDataTypes, 2> supportedTypeListQuantizeLinear19 = { SupportedTensorDataTypes::Int16 | SupportedTensorDataTypes::UInt16 | SupportedTensorDataTypes::Float16to32 | SupportedTensorDataTypes::Int32,  SupportedTensorDataTypes::Int16 | SupportedTensorDataTypes::UInt16 | SupportedTensorDataTypes::UInt8 | SupportedTensorDataTypes::Int8 };
constexpr static std::array<SupportedTensorDataTypes, 2> supportedTypeListQuantizeLinear21 = { SupportedTensorDataTypes::Int16 | SupportedTensorDataTypes::UInt16 | SupportedTensorDataTypes::Float16to32,  SupportedTensorDataTypes::Int16 | SupportedTensorDataTypes::UInt16 | SupportedTensorDataTypes::UInt4 | SupportedTensorDataTypes::Int4 | SupportedTensorDataTypes::UInt8 | SupportedTensorDataTypes::Int8 };
constexpr static std::array<SupportedTensorDataTypes, 1> supportedTypeListDequantizeLinear = { SupportedTensorDataTypes::Int16 | SupportedTensorDataTypes::UInt16 | SupportedTensorDataTypes::UInt8 | SupportedTensorDataTypes::Int8 | SupportedTensorDataTypes::Int32 };
constexpr static std::array<SupportedTensorDataTypes, 2> supportedTypeListDequantizeLinear19 = { SupportedTensorDataTypes::Int16 | SupportedTensorDataTypes::UInt16 | SupportedTensorDataTypes::UInt8 | SupportedTensorDataTypes::Int8 | SupportedTensorDataTypes::Int32, SupportedTensorDataTypes::Float16to32 };
constexpr static std::array<SupportedTensorDataTypes, 2> supportedTypeListDequantizeLinear21 = { SupportedTensorDataTypes::Int16 | SupportedTensorDataTypes::UInt16 | SupportedTensorDataTypes::UInt4 | SupportedTensorDataTypes::Int4 | SupportedTensorDataTypes::UInt8 | SupportedTensorDataTypes::Int8, SupportedTensorDataTypes::Float16to32 };
