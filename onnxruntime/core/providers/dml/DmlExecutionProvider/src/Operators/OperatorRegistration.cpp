...
DML_OP_EXTERN_CREATION_FUNCTION(RandomNormalLike);
...
constexpr static std::array<SupportedTensorDataTypes, 2> supportedTypeListRandomNormalLike = {SupportedTensorDataTypes::AllScalars, SupportedTensorDataTypes::Float16to32};
...
///                                                                                                                                                                 Support query function
    ...
    {REG_INFO(      7,  RandomNormalLike,                   typeNameListTwo,                supportedTypeListRandomNormalLike,      DmlGraphSupport::NotSupported)},
