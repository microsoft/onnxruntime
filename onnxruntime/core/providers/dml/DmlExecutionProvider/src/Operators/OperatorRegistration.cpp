...
const static SupportedTensorDataTypes supportedTypeListCast[2] = { SupportedTensorDataTypes::AllScalars | SupportedTensorDataTypes::Bool, SupportedTensorDataTypes::AllScalars | SupportedTensorDataTypes::Bool };
