...
onnx::AttributeProto_AttributeType ToProto(MLOperatorAttributeType type)
{
    switch (type)
    {
    case MLOperatorAttributeType::Float:        return MLAttributeTypeTraits<MLOperatorAttributeType::Float>::ProtoType;
    case MLOperatorAttributeType::Int:          return MLAttributeTypeTraits<MLOperatorAttributeType::Int>::ProtoType;
    case MLOperatorAttributeType::FloatArray:   return MLAttributeTypeTraits<MLOperatorAttributeType::FloatArray>::ProtoType;
    case MLOperatorAttributeTypeTensor:         return MLAttributeTypeTraits<MLOperatorAttributeTypeTensor>::ProtoType;
    case MLOperatorAttributeType::IntArray:     return MLAttributeTypeTraits<MLOperatorAttributeType::IntArray>::ProtoType;
    case MLOperatorAttributeType::String:       return MLAttributeTypeTraits<MLOperatorAttributeType::String>::ProtoType;
    case MLOperatorAttributeType::StringArray:  return MLAttributeTypeTraits<MLOperatorAttributeType::StringArray>::ProtoType;
    default:                                    return onnx::AttributeProto_AttributeType_UNDEFINED;
    }
}
...
bool IsPrimitiveAttributeType(MLOperatorAttributeType type)
{
    switch (type)
    {
    case MLOperatorAttributeType::Float:        return MLAttributeTypeTraits<MLOperatorAttributeType::Float>::IsPrimitiveAttributeType;
    case MLOperatorAttributeType::Int:          return MLAttributeTypeTraits<MLOperatorAttributeType::Int>::IsPrimitiveAttributeType;
    case MLOperatorAttributeType::FloatArray:   return MLAttributeTypeTraits<MLOperatorAttributeType::FloatArray>::IsPrimitiveAttributeType;
    case MLOperatorAttributeType::IntArray:     return MLAttributeTypeTraits<MLOperatorAttributeType::IntArray>::IsPrimitiveAttributeType;
    case MLOperatorAttributeType::String:       return MLAttributeTypeTraits<MLOperatorAttributeType::String>::IsPrimitiveAttributeType;
    case MLOperatorAttributeType::StringArray:  return MLAttributeTypeTraits<MLOperatorAttributeType::StringArray>::IsPrimitiveAttributeType;
    default:                                    return false; // Including other types like tensor and graph...
    }
}
...
#define ML_TENSOR_TYPE_CASE(x)                       \
    if (type == onnxruntime::DataTypeImpl::GetType<x>())   \
    {                                                \
...
{
    if (type == onnxruntime::DataTypeImpl::GetType<std::string>())
    {
...
TensorWrapper::TensorWrapper(onnxruntime::Tensor* impl, bool isDataInterface, IWinmlExecutionProvider* provider, bool isInternalOperator) : 
    m_impl(impl), m_isDataInterface(isDataInterface), m_winmlExecutionProvider(provider), m_internalOperator(isInternalOperator)
{
    if (impl)
    {
        if (isDataInterface)
...
bool STDMETHODCALLTYPE TensorWrapper::IsCpuData() const noexcept
{
    ...
    return !strcmp(m_impl->Location().name, onnxruntime::CPU)
            || m_impl->Location().mem_type == ::OrtMemType::OrtMemTypeCPUOutput || m_impl->Location().mem_type == ::OrtMemType::OrtMemTypeCPUInput;
}
...
THROW_HR_IF(E_FAIL, !onnxruntime::utils::UnpackTensor(\
    ...
    reinterpret_cast<Y*>(unpackedTensor.get()), elementCount).IsOK());  \
break; \
}
