...
template <typename T>
inline T FromString(std::string_view value)
{
    // Clang will instantiate this template even if it isn't used,
    // so this static_assert will always fire and break the build.
    static_assert(false, "Not implemented for this type");
...
inline std::unordered_map<std::string_view, DML_TENSOR_DATA_TYPE> DML_TENSOR_DATA_TYPE_MAP = {
...
template <>
inline DML_TENSOR_DATA_TYPE FromString(std::string_view value)
{
    return DML_TENSOR_DATA_TYPE_MAP[value];
}

inline std::unordered_map<std::string_view, DML_TENSOR_TYPE> DML_TENSOR_TYPE_MAP = {
    {"DML_TENSOR_TYPE_INVALID", DML_TENSOR_TYPE_INVALID},
    {"DML_TENSOR_TYPE_BUFFER", DML_TENSOR_TYPE_BUFFER},
};

template <>
inline DML_TENSOR_TYPE FromString(std::string_view value)
{
    return DML_TENSOR_TYPE_MAP[value];
}

inline std::unordered_map<std::string_view, DML_OPERATOR_TYPE> DML_OPERATOR_TYPE_MAP = {
   ...
   { "DML_OPERATOR_ELEMENT_WISE_QUANTIZED_LINEAR_ADD1",  static_cast<DML_OPERATOR_TYPE>(DML_OPERATOR_ELEMENT_WISE_QUANTIZED_LINEAR_ADD1)},
   { "DML_OPERATOR_MATRIX_MULTIPLY_INTEGER_TO_FLOAT",  static_cast<DML_OPERATOR_TYPE>(DML_OPERATOR_MATRIX_MULTIPLY_INTEGER_TO_FLOAT)},
};

template <>
inline DML_OPERATOR_TYPE FromString(std::string_view value)
{
    return DML_OPERATOR_TYPE_MAP[value];
}

inline std::unordered_map<std::string_view, DML_BINDING_TYPE> DML_BINDING_TYPE_MAP = {
...
template <>
inline DML_BINDING_TYPE FromString(std::string_view value)
{
    return DML_BINDING_TYPE_MAP[value];
}

inline std::unordered_map<std::string_view, DML_REDUCE_FUNCTION> DML_REDUCE_FUNCTION_MAP = {
...
template <>
inline DML_REDUCE_FUNCTION FromString(std::string_view value)
{
	return DML_REDUCE_FUNCTION_MAP[value];
}

inline std::unordered_map<std::string_view, DML_MATRIX_TRANSFORM> DML_MATRIX_TRANSFORM_MAP = {
    {"DML_MATRIX_TRANSFORM_NONE", DML_MATRIX_TRANSFORM_NONE},
    {"DML_MATRIX_TRANSFORM_TRANSPOSE", DML_MATRIX_TRANSFORM_TRANSPOSE},
};

template <>
inline DML_MATRIX_TRANSFORM FromString(std::string_view value)
{
    return DML_MATRIX_TRANSFORM_MAP[value];
}

inline std::unordered_map<std::string_view, DML_CONVOLUTION_MODE> DML_CONVOLUTION_MODE_MAP = {
...
template <>
inline DML_CONVOLUTION_MODE FromString(std::string_view value)
{
    return DML_CONVOLUTION_MODE_MAP[value];
}

inline std::unordered_map<std::string_view, DML_CONVOLUTION_DIRECTION> DML_CONVOLUTION_DIRECTION_MAP = {
...
template <>
inline DML_CONVOLUTION_DIRECTION FromString(std::string_view value)
{
    return DML_CONVOLUTION_DIRECTION_MAP[value];
}

inline std::unordered_map<std::string_view, DML_PADDING_MODE> DML_PADDING_MODE_MAP = {
...
template <>
inline DML_PADDING_MODE FromString(std::string_view value)
{
    return DML_PADDING_MODE_MAP[value];
}

inline std::unordered_map<std::string_view, DML_INTERPOLATION_MODE> DML_INTERPOLATION_MODE_MAP = {
...
template <>
inline DML_INTERPOLATION_MODE FromString(std::string_view value)
{
    return DML_INTERPOLATION_MODE_MAP[value];
}

inline std::unordered_map<std::string_view, DML_RECURRENT_NETWORK_DIRECTION> DML_RECURRENT_NETWORK_DIRECTION_MAP = {
...
template <>
inline DML_RECURRENT_NETWORK_DIRECTION FromString(std::string_view value)
{
    return DML_RECURRENT_NETWORK_DIRECTION_MAP[value];
}

inline std::unordered_map<std::string_view, DML_FEATURE> DML_FEATURE_MAP = {
...
template <>
inline DML_FEATURE FromString(std::string_view value)
{
    return DML_FEATURE_MAP[value];
}

inline std::unordered_map<std::string_view, DML_FEATURE_LEVEL> DML_FEATURE_LEVEL_MAP = {
...
template <>
inline DML_FEATURE_LEVEL FromString(std::string_view value)
{
    return DML_FEATURE_LEVEL_MAP[value];
}

inline std::unordered_map<std::string_view, DML_IS_INFINITY_MODE> DML_IS_INFINITY_MODE_MAP = {
...
template <>
inline DML_IS_INFINITY_MODE FromString(std::string_view value)
{
    return DML_IS_INFINITY_MODE_MAP[value];
}

inline std::unordered_map<std::string_view, DML_DEPTH_SPACE_ORDER> DML_DEPTH_SPACE_ORDER_MAP = {
...
template <>
inline DML_DEPTH_SPACE_ORDER FromString(std::string_view value)
{
    return DML_DEPTH_SPACE_ORDER_MAP[value];
}

inline std::unordered_map<std::string_view, DML_AXIS_DIRECTION> DML_AXIS_DIRECTION_MAP = {
    {"DML_AXIS_DIRECTION_INCREASING", DML_AXIS_DIRECTION_INCREASING},
    {"DML_AXIS_DIRECTION_DECREASING", DML_AXIS_DIRECTION_DECREASING},
};

template <>
inline DML_AXIS_DIRECTION FromString(std::string_view value)
{
    return DML_AXIS_DIRECTION_MAP[value];
}

inline std::unordered_map<std::string_view, DML_ROUNDING_MODE> DML_ROUNDING_MODE_MAP = {
...
template <>
inline DML_ROUNDING_MODE FromString(std::string_view value)
{
    return DML_ROUNDING_MODE_MAP[value];
}

inline std::unordered_map<std::string_view, DML_RANDOM_GENERATOR_TYPE> DML_RANDOM_GENERATOR_TYPE_MAP = {
    {"DML_RANDOM_GENERATOR_TYPE_PHILOX_4X32_10", DML_RANDOM_GENERATOR_TYPE_PHILOX_4X32_10},
};

template <>
inline DML_RANDOM_GENERATOR_TYPE FromString(std::string_view value)
{
    return DML_RANDOM_GENERATOR_TYPE_MAP[value];
}

inline std::unordered_map<std::string_view, DML_MULTIHEAD_ATTENTION_MASK_TYPE> DML_MULTIHEAD_ATTENTION_MASK_TYPE_MAP = {
...
template <>
inline DML_MULTIHEAD_ATTENTION_MASK_TYPE FromString(std::string_view value)
{
    return DML_MULTIHEAD_ATTENTION_MASK_TYPE_MAP[value];
}
