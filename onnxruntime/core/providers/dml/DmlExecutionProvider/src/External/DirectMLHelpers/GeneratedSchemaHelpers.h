...
inline std::vector<OperatorField> GetFields(const DML_MULTIHEAD_ATTENTION_OPERATOR_DESC& desc)
{
    return {
        ...
        OperatorField(&DML_MULTIHEAD_ATTENTION_OPERATOR_SCHEMA.Fields[8], ToOperatorFieldType(static_cast<const DML_TENSOR_DESC*>(desc.AttentionBiasTensor))),
...
inline std::vector<OperatorField> GetFields(const DML_MULTIHEAD_ATTENTION1_OPERATOR_DESC& desc)
{
    return {
        ...
        OperatorField(&DML_MULTIHEAD_ATTENTION1_OPERATOR_SCHEMA.Fields[8], ToOperatorFieldType(static_cast<const DML_TENSOR_DESC*>(desc.AttentionBiasTensor))),
