...
inline std::vector<OperatorField> GetFields(const DML_MULTI_HEAD_ATTENTION_OPERATOR_DESC& desc)
{
    return {
        ...
        OperatorField(&DML_MULTI_HEAD_ATTENTION_OPERATOR_SCHEMA.Fields[3], ToOperatorFieldType(static_cast<const DML_TENSOR_DESC*>(desc.StackedQueryKeyTensor))),
        OperatorField(&DML_MULTI_HEAD_ATTENTION_OPERATOR_SCHEMA.Fields[4], ToOperatorFieldType(static_cast<const DML_TENSOR_DESC*>(desc.StackedKeyValueTensor))),
        OperatorField(&DML_MULTI_HEAD_ATTENTION_OPERATOR_SCHEMA.Fields[5], ToOperatorFieldType(static_cast<const DML_TENSOR_DESC*>(desc.StackedQueryKeyValueTensor))),
        OperatorField(&DML_MULTI_HEAD_ATTENTION_OPERATOR_SCHEMA.Fields[6], ToOperatorFieldType(static_cast<const DML_TENSOR_DESC*>(desc.BiasTensor))),
        OperatorField(&DML_MULTI_HEAD_ATTENTION_OPERATOR_SCHEMA.Fields[7], ToOperatorFieldType(static_cast<const DML_TENSOR_DESC*>(desc.MaskTensor))),
        OperatorField(&DML_MULTI_HEAD_ATTENTION_OPERATOR_SCHEMA.Fields[8], ToOperatorFieldType(static_cast<const DML_TENSOR_DESC*>(desc.UnpaddedKeyBoundsTensor))),
        OperatorField(&DML_MULTI_HEAD_ATTENTION_OPERATOR_SCHEMA.Fields[9], ToOperatorFieldType(static_cast<const DML_TENSOR_DESC*>(desc.RelativePositionBiasTensor))),
        OperatorField(&DML_MULTI_HEAD_ATTENTION_OPERATOR_SCHEMA.Fields[10], ToOperatorFieldType(static_cast<const DML_TENSOR_DESC*>(desc.PastKeyTensor))),
        OperatorField(&DML_MULTI_HEAD_ATTENTION_OPERATOR_SCHEMA.Fields[11], ToOperatorFieldType(static_cast<const DML_TENSOR_DESC*>(desc.PastValueTensor))),
        OperatorField(&DML_MULTI_HEAD_ATTENTION_OPERATOR_SCHEMA.Fields[12], ToOperatorFieldType(static_cast<const DML_TENSOR_DESC*>(desc.OutputTensor))),
        OperatorField(&DML_MULTI_HEAD_ATTENTION_OPERATOR_SCHEMA.Fields[13], ToOperatorFieldType(static_cast<const DML_TENSOR_DESC*>(desc.OutputPresentKeyTensor))),
        OperatorField(&DML_MULTI_HEAD_ATTENTION_OPERATOR_SCHEMA.Fields[14], ToOperatorFieldType(static_cast<const DML_TENSOR_DESC*>(desc.OutputPresentValueTensor))),
        OperatorField(&DML_MULTI_HEAD_ATTENTION_OPERATOR_SCHEMA.Fields[15], ToOperatorFieldType(static_cast<FLOAT>(desc.Scale))),
        OperatorField(&DML_MULTI_HEAD_ATTENTION_OPERATOR_SCHEMA.Fields[16], ToOperatorFieldType(static_cast<FLOAT>(desc.MaskFilterValue))),
        OperatorField(&DML_MULTI_HEAD_ATTENTION_OPERATOR_SCHEMA.Fields[17], ToOperatorFieldType(static_cast<UINT>(desc.HeadCount))),
    };
}
...
inline const DML_OPERATOR_SCHEMA& GetSchema(DML_OPERATOR_TYPE operatorType)
{
    ...
    case DML_OPERATOR_MULTI_HEAD_ATTENTION: return DML_MULTI_HEAD_ATTENTION_OPERATOR_SCHEMA;
...
inline AbstractOperatorDesc ConvertOperatorDesc(const DML_OPERATOR_DESC& opDesc)
{
    ...
    case DML_OPERATOR_MULTI_HEAD_ATTENTION:
        return AbstractOperatorDesc(
            &DML_MULTI_HEAD_ATTENTION_OPERATOR_SCHEMA,
            GetFields(*static_cast<const DML_MULTI_HEAD_ATTENTION_OPERATOR_DESC*>(opDesc.Desc)));
