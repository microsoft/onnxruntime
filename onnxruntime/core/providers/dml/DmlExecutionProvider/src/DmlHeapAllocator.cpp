...
void* D3D12HeapAllocator::Alloc(size_t size_in_bytes)
{
    if (size_in_bytes == 0)
    {
        return nullptr;
    ...
    ORT_THROW_HR_IF(E_INVALIDARG, !id.has_value());
    ...
    return TaggedPointer::Pack(*id, offset);
}

void D3D12HeapAllocator::Free(void* ptr)
{
