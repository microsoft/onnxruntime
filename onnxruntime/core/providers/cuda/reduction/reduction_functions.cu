...
INSTANTIATE_UNARY_DIV(int);
INSTANTIATE_UNARY_DIV(long);
...
INSTANTIATE_REDUCE_MATRIX_ROWS(int);
INSTANTIATE_REDUCE_MATRIX_ROWS(long);
...
INSTANTIATE_REDUCE_MATRIX_COLUMNS(int);
INSTANTIATE_REDUCE_MATRIX_COLUMNS(long);
