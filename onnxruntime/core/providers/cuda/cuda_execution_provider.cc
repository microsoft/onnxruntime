...
void CUDAExecutionProvider::ReleasePerThreadStuffs() {
  auto stream_id = GetQueueIDByThreadId(std::this_thread::get_id());
  default_allocator_pool_.ReleaseCudaResource(stream_id);
