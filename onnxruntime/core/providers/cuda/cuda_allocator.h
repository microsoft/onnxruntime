...
class CUDAAllocator : public IDeviceAllocator {
 public:
  CUDAAllocator(int device_id) : info_(CUDA, OrtAllocatorType::OrtDeviceAllocator, OrtDevice(OrtDevice::GPU, OrtDevice::Default, device_id), device_id, OrtMemTypeDefault) {}
