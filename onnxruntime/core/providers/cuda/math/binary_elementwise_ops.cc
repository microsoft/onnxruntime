...
BINARY_OP_VERSIONED_UZILHFD(Add, 13, 13)
BINARY_OP_VERSIONED_UZILHFD(Sub, 13, 13)
BINARY_OP_VERSIONED_UZILHFD(Mul, 13, 13)
BINARY_OP_VERSIONED_UZILHFD(Div, 13, 13)
BINARY_ELEMENTWISE_REGISTER_KERNEL_VERSIONED_TYPED(Add, 13, 13, BFloat16)
BINARY_ELEMENTWISE_REGISTER_KERNEL_VERSIONED_TYPED(Sub, 13, 13, BFloat16)
BINARY_ELEMENTWISE_REGISTER_KERNEL_VERSIONED_TYPED(Div, 13, 13, BFloat16)
