...
// 2. (optional) Define templated tenary element operator in ternary_elementwise_ops_impl.cu
// 3. (optional) Implement specialized tenary element operator
// 4. Add op kernel class definition in ternary_elementwise_ops.h
// 5. Add op kernel registration and compute specialization in ternary_elementwise_ops.cc
...
// so struct TernaryElementwisePreparation cannot be used here
