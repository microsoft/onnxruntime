...
UNARY_ACTIVATION_OP_VERSIONED_HFD(Elu, 6, 21);
...
UNARY_ACTIVATION_OP_VERSIONED_HFD(Selu, 6, 21);
...
UNARY_ACTIVATION_OP_VERSIONED_HFD(ThresholdedRelu, 10, 21);
...
// Opset-22 adds BFloat16 to allowed types for the HardSigmoid / HardSwish / Elu / Selu / ThresholdedRelu operators
UNARY_ACTIVATION_OP_HFD_WITH_BF16(Elu, 22);
UNARY_ACTIVATION_OP_HFD_WITH_BF16(HardSigmoid, 22);
UNARY_ACTIVATION_OP_HFD_WITH_BF16(HardSwish, 22);
UNARY_ACTIVATION_OP_HFD_WITH_BF16(Selu, 22);
UNARY_ACTIVATION_OP_HFD_WITH_BF16(ThresholdedRelu, 22);
