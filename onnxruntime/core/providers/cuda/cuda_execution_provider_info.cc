...
constexpr const char* kFuseBias = "fuse_bias";
...
CUDAExecutionProviderInfo CUDAExecutionProviderInfo::FromProviderOptions(const ProviderOptions& options) {
  ...
  ORT_THROW_IF_ERROR(
      ProviderOptionsParser{}
          ...
          .AddAssignmentToReference(cuda::provider_option_names::kFuseBias, info.fuse_bias)
          .AddValueParser(
...
ProviderOptions CUDAExecutionProviderInfo::ToProviderOptions(const CUDAExecutionProviderInfo& info) {
  const ProviderOptions options{
      ...
      {cuda::provider_option_names::kFuseBias, MakeStringWithClassicLocale(info.fuse_bias)},
  };
