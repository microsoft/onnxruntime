...
#define CUSPARSELT_CALL(expr) (CudaCall<cusparseStatus_t, false>((expr), #expr, "CUSPARSE_LT", CUSPARSE_STATUS_SUCCESS))
#endif
...
#ifdef USE_CUSPARSELT
#define CUSPARSELT_CALL_THROW(expr) (CudaCall<cusparseStatus_t, true>((expr), #expr, "CUSPARSE_LT", CUSPARSE_STATUS_SUCCESS))
#endif
