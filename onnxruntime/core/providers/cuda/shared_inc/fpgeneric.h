...
// cublasStatus_t customMatmulRun(cublasLtHandle_t ltHandle, // to get the capabilities (required a GPU)
...
inline cublasStatus_t cublasLtGemmHelper(cublasLtHandle_t handle,
    ...
    cublasLtMatmulAlgoGetHeuristic(handle, operationDesc, Adesc, Bdesc, Cdesc, Cdesc, preference, 2, &heuristicResult, &returnedResults);
