...
Status SpaceToDepth::ComputeInternal(OpKernelContext* context) const {
  ...
  ORT_RETURN_IF_ERROR(SpaceDepthOpCudaImpl(GetDeviceProp(), Stream(context), CublasHandle(), input, output, permutation, batch,
...
Status DepthToSpace::ComputeInternal(OpKernelContext* context) const {
  ...
  ORT_RETURN_IF_ERROR(SpaceDepthOpCudaImpl(GetDeviceProp(), Stream(context), CublasHandle(), input, output,
                                           permutation,
                                           batch,
