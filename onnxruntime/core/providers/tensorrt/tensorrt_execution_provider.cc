...
TensorrtExecutionProvider::TensorrtExecutionProvider(const TensorrtExecutionProviderInfo& info)
  ...
  std::cout << "TensorrtExecutionProvider infor: device_id: " << info.device_id //slx
  << ", has_user_compute_stream: " << info.has_user_compute_stream  
  << ", user_compute_stream: " << info.user_compute_stream  
  << ", has_trt_options: " << info.has_trt_options 
  << ", max_workspace_size: " << info.max_workspace_size 
  << ", fp16_enable: " << info.fp16_enable  
  << ", int8_enable: " << info.int8_enable  
  << ", int8_calibration_table_name: " << info.int8_calibration_table_name 
  << ", int8_use_native_calibration_table: " << info.int8_use_native_calibration_table
  << ", force_sequential_engine_build: " << info.force_sequential_engine_build << std::endl;  
