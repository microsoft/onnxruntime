...
constexpr const char* kSideloadEngine = "trt_sideload_engine";
}  // namespace provider_option_names
}  // namespace tensorrt 
...
TensorrtExecutionProviderInfo TensorrtExecutionProviderInfo::FromProviderOptions(const ProviderOptions& options) {
  ...
  ORT_THROW_IF_ERROR(
      ProviderOptionsParser{}
          ...
          .AddAssignmentToReference(tensorrt::provider_option_names::kSideloadEngine, info.sideload_engine)
...
ProviderOptions TensorrtExecutionProviderInfo::ToProviderOptions(const TensorrtExecutionProviderInfo& info) {
  ...
  const ProviderOptions options{
      ...
      {tensorrt::provider_option_names::kSideloadEngine, MakeStringWithClassicLocale(info.sideload_engine)},
  };
  return options;
}
