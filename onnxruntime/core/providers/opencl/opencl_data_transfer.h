...
class OpenCLDataTransfer : public IDataTransfer {
 ...
 public:
  ...
  Status CopyTensor3DToImage2D(const Tensor& src, const Image2D& dst, const Image2DDesc& desc) const;
  ...
  Status CopyImage2DToTensor3D(const Image2D& src, const Image2DDesc& desc, Tensor& dst) const;
  ...
  Status CopyBuffer3DToImage2D(const Buffer& src, const TensorShape shape, const Image2D& dst, const Image2DDesc& desc) const;
  ...
  Status CopyImage2DToBuffer3D(const Image2D& src, const Image2DDesc& desc, const Buffer& dst, const TensorShape shape) const;
