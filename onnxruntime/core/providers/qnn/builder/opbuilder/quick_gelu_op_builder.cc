...
Ort::Status QuickGeluOpBuilder::ProcessAttributesAndOutputs(QnnModelWrapper& qnn_model_wrapper,
                                                            const OrtNodeUnit& node_unit,
                                                            std::vector<std::string>&& input_names,
                                                            const Ort::Logger& logger,
  ...
  if (skip_alpha_mul) {
    ...
    RETURN_IF_NOT(qnn_model_wrapper.AddTensorWrapper(std::move(alpha_mul_output_tensor_wrapper)),
  ...
  QnnTensorWrapper sigmoid_output_tensor_wrapper(sigmoid_output_name,
                                                 ...
                                                 QnnQuantParamsWrapper(),
                                                 std::vector<uint32_t>(input_info.shape));
  RETURN_IF_NOT(qnn_model_wrapper.AddTensorWrapper(std::move(sigmoid_output_tensor_wrapper)),
