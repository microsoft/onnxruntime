...
inline void InitializeQuantizeParam(Qnn_QuantizeParams_t& quantize_param, bool is_quantized_node, float scale = 0.0f, int32_t offset = 0) {
  quantize_param.encodingDefinition = is_quantized_node ? QNN_DEFINITION_DEFINED : QNN_DEFINITION_UNDEFINED;
  quantize_param.quantizationEncoding = is_quantized_node ? QNN_QUANTIZATION_ENCODING_SCALE_OFFSET : QNN_QUANTIZATION_ENCODING_UNDEFINED;
