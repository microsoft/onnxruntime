...
struct QnnEpFactorySimulation : public OrtEpFactory, public ApiPtrs {
 public:
  QnnEpFactorySimulation(const char* ep_name, ApiPtrs ort_api_in);
 ...
 private:
  ...
  const std::string ep_version_{"999.1.0"};  // EP version
