...
REGISTER_REDUCE_ELEMENTWISE_VERSIONED_KERNEL(ReduceMean, 18, 19);
REGISTER_REDUCE_ELEMENTWISE_KERNEL(ReduceMean, 20);
...
REGISTER_REDUCE_ELEMENTWISE_VERSIONED_KERNEL(ReduceMin, 18, 19);
