...
struct ProviderHost {
  ...
  virtual void GraphViewer__ToProto(const GraphViewer* p, ONNX_NAMESPACE::GraphProto& graph_proto, bool include_initializers, bool include_outer_scope_args, int execution_order) noexcept = 0;
