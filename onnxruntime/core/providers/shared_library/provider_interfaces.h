...
#ifdef USE_AMDGPU
  virtual std::unique_ptr<IAllocator> CreateAMDGPUAllocator(int16_t device_id, const char* name) = 0;
  virtual std::unique_ptr<IAllocator> CreateAMDGPUPinnedAllocator(int16_t device_id, const char* name) = 0;
#endif
