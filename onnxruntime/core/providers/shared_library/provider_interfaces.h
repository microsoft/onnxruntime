...
struct ProviderHost {
  ...
  virtual std::unordered_set<std::string>& IndexedSubGraph_MetaDef__outer_scope_node_arg_names(IndexedSubGraph_MetaDef* p) = 0;
  ...
  virtual Node* Graph__GetNode(Graph* p, NodeIndex node_index) = 0;
  ...
  virtual int Graph__NumberOfNodes(const Graph* p) = 0;
