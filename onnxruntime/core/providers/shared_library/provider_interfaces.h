...
struct ProviderHost {
  ...
  virtual void Graph__AddOuterScopeNodeArg(Graph* p, const std::string& name) = 0;//slx
  virtual bool Graph__IsOuterScopeValue(const Graph* p, const std::string& name) = 0;//slx
  ...
  virtual const std::string& Graph__Name(const Graph* p) noexcept = 0;//slx
  virtual const Graph* Graph__ParentGraph(const Graph* p) = 0;//slx
  virtual bool Graph__IsSubgraph(const Graph* p) = 0;//slx
  ...
  virtual const Graph& GraphViewer__GetGraph(const GraphViewer* p) = 0;//slx
