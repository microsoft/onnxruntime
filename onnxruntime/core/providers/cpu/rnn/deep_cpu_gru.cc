...
void UniDirectionalGru<T>::Compute(const gsl::span<const T>& inputs_arg,
  ...
  span_T_iter batched_bias_WRz_local_end = batched_bias_WRz_.end();
  span_T_iter batched_bias_WRr_local_end = batched_bias_WRr_.end();
  span_T_iter batched_bias_Wh_local_end = batched_bias_Wh_.end();
  span_T_iter batched_bias_Rh_local_end = batched_bias_Rh_.end();
  span_T_iter batched_bias_WRh_local_end = batched_bias_WRh_.end();

  size_t out_added_offset;

  span_T_iter prev_Ht = batched_hidden0_.begin();  // Ht-1
  span_T_iter prev_Ht_end = batched_hidden0_.end();
  span_T_iter cur_h_local = cur_h_.begin();
  span_T_iter cur_h_local_end = cur_h_.end();

  span_T_iter batched_bias_WRz_local{};
  span_T_iter batched_bias_WRr_local{};
  span_T_iter batched_bias_WRh_local{};
  span_T_iter batched_bias_Wh_local{};
  span_T_iter batched_bias_Rh_local{};
