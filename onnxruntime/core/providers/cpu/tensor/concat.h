...
class ConcatBase {
 protected:
  ...
  // the core method that will be invoked by the 'Concat' and 'ConcatFromSequence' kernels
  Status ValidateInputsAndComputeOutput(OpKernelContext* ctx, const std::vector<const Tensor*>& input_tensors) const;
