...
ORT_SPECIFY_OP_KERNEL_ARG_SUPPORTED_TYPES(kOnnxDomain, IsInf, Input, 0, float, double);
}  // namespace op_kernel_type_control

class IsInf final : public OpKernel {
 public:
  using EnabledTypes = ORT_OP_KERNEL_ARG_ENABLED_TYPE_LIST(kOnnxDomain, IsInf, Input, 0);
