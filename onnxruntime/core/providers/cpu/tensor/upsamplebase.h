...
class UpsampleBase {
 protected:
  ...
  Status Precompute(OpKernelContext* context, size_t input_count, std::vector<float>& roi_array, std::vector<float>& scales_array, TensorShapeVector& output_dims) const {
