...
std::shared_ptr<KernelRegistry> WasmExecutionProvider::GetKernelRegistry() const {
...
std::unique_ptr<IDataTransfer> WasmExecutionProvider::GetDataTransfer() const {
  return nullptr;
}
}  // namespace onnxruntime
