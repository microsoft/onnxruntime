...
#define REG_KERNEL_NONTEMPL(OP_TYPE, START_VERSION, END_VERSION, KERNEL_CLASS, ...) \
  ONNX_CPU_OPERATOR_VERSIONED_KERNEL(                                               \
      OP_TYPE,                                                                      \
      START_VERSION,                                                                \
      END_VERSION,                                                                  \
...
REG_KERNEL_NONTEMPL(Clip, 12, 13, Clip, float, double, int8_t, uint8_t, int64_t, uint64_t);
