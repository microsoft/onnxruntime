...
// Expects the input to be atleast 2-D and 0 <= dim1, dim2 < rank.
// input_shape[dim1] == input_shape[dim2] and dim1 cannot be same as dim2.
// The rank of the output is 1 less than the rank of the input and the reduced dim is the higer of dim1 and dim2.

// Eg. input_shape = [2, 3, 5, 3] and dim1 = 1 and dim2 = 3
// The output_shape will be [2, 3, 5] and dim1 will contain the diagonal elements in the original tensor along the specified dimensions
template <typename T>
