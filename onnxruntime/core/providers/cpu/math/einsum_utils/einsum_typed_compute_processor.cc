...
std::unique_ptr<Tensor> EinsumTypedComputeProcessor<T>::PairwiseOperandProcess(const Tensor& left,
  ...
  InlinedVectorShapeCap<size_t> left_permutation;
  ...
  InlinedVectorShapeCap<size_t> right_permutation;
  ...
  InlinedVectorShapeCap<size_t> output_permutation;
