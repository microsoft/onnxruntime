...
REGISTER_VERSIONED_UNARY_ELEMENTWISE_KERNEL(Celu, 12, 27);
REGISTER_UNARY_ELEMENTWISE_TYPED_KERNEL(Celu, 28, float);
REGISTER_UNARY_ELEMENTWISE_TYPED_KERNEL(Celu, 28, double);
REGISTER_UNARY_ELEMENTWISE_TYPED_KERNEL(Celu, 28, MLFloat16);
REGISTER_UNARY_ELEMENTWISE_TYPED_KERNEL(Celu, 28, BFloat16);
