...
#define REGISTER_UNARY_ELEMENTWISE_KERNEL_REDUCTION(x, sinceVersion)                            \
...
REGISTER_UNARY_ELEMENTWISE_KERNEL_REDUCTION(ReduceL1, 18);
...
REGISTER_UNARY_ELEMENTWISE_KERNEL_REDUCTION(ReduceL2, 18);
...
REGISTER_UNARY_ELEMENTWISE_KERNEL_REDUCTION(ReduceLogSum, 18);
...
REGISTER_UNARY_ELEMENTWISE_KERNEL_REDUCTION(ReduceLogSumExp, 18);
...
REGISTER_UNARY_ELEMENTWISE_KERNEL_REDUCTION(ReduceMax, 18);
...
REGISTER_UNARY_ELEMENTWISE_KERNEL_REDUCTION(ReduceMean, 18);
...
REGISTER_UNARY_ELEMENTWISE_KERNEL_REDUCTION(ReduceMin, 18);
...
REGISTER_UNARY_ELEMENTWISE_KERNEL_REDUCTION(ReduceProd, 18);
...
REGISTER_UNARY_ELEMENTWISE_KERNEL_REDUCTION(ReduceSum, 13);
...
REGISTER_UNARY_ELEMENTWISE_KERNEL_REDUCTION(ReduceSumSquare, 18);
...
REGISTER_UNARY_ELEMENTWISE_KERNEL_REDUCTION(ArgMax, 13);
...
REGISTER_UNARY_ELEMENTWISE_KERNEL_REDUCTION(ArgMin, 13);
...
void NoTransposePrepareForReduce(const TensorShape& new_input_shape,
  ...
  if (reduced_axes_size == 0) {
    ...
    TensorShapeVector projected_indices(reduced_axes_size);
