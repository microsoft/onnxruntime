...
#include "core/providers/amdgpu/ort_trt_int8_cal_table.fbs.h"
 ...
 *   ...
 *
 * Taken from the tensorRT EP to allow AMDGPU EP to reuse calibration tables for existing models
 *
 */
