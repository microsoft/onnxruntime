...
class BaseOpBuilder : public IOpBuilder {
 ...
 public:
  bool IsOpSupported(const InitializedTensorSet& initializers, const Node& node) const override;

 protected:
  virtual bool IsOpSupportedImpl(const InitializedTensorSet& /* initializers */, const Node& /* node */) const {
    return true;
  }
