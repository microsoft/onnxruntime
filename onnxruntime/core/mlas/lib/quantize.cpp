    ...
    )
{
    ...
    const __m128 MinimumValueVector = _mm_set1_ps(float(std::numeric_limits<OutputType>::min() - ZeroPoint));
    ...
    )
{
    ...
    const float MinimumValue = float(std::numeric_limits<OutputType>::min() - ZeroPoint);
...
template
void MLASCALL
MlasRequantizeOutput<int8_t>(const int32_t* Input,
                             size_t InputLeadingDimension,
                             int8_t* Output,
                             size_t OutputLeadingDimension,
                             const int32_t* Bias,
...
MlasRequantizeOutput<uint8_t>(const int32_t* Input,
                             size_t InputLeadingDimension,
                             uint8_t* Output,
                             size_t OutputLeadingDimension,
                             const int32_t* Bias,
