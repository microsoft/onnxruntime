...
template <class DataType, bool IsLow>
MLAS_FORCEINLINE static __m128i
MlasExtendToS16(__m128i Int8Vector, __m128i ZeroVector);

template <>
MLAS_FORCEINLINE __m128i
MlasExtendToS16<uint8_t, /* bool IsLow = */ true>(__m128i Int8Vector, __m128i ZeroVector)
{
...
template <>
MLAS_FORCEINLINE __m128i
MlasExtendToS16<uint8_t, /* bool IsLow = */ false>(__m128i Int8Vector, __m128i ZeroVector)
{
...
template <>
MLAS_FORCEINLINE __m128i
MlasExtendToS16<int8_t, /* bool IsLow = */ true>(__m128i Int8Vector, __m128i ZeroVector)
{
    MLAS_UNREFERENCED_PARAMETER(ZeroVector);
...
template <>
MLAS_FORCEINLINE __m128i
MlasExtendToS16<int8_t, /* bool IsLow = */ false>(__m128i Int8Vector, __m128i ZeroVector)
{
    MLAS_UNREFERENCED_PARAMETER(ZeroVector);
...
template <class DataType, bool IsLow>
MLAS_FORCEINLINE static __m128i
MlasExtendToS16Debias(__m128i Int8Vector, __m128i ZeroVector, __m128i VectorBias)
{
...
MLAS_FORCEINLINE
static __m128i
MlasQLinearMulVectorS16(__m128i va_s16x8,
                        __m128i vb_s16x8,
                        __m128 VectorScaleRatio,
                        __m128 VectorZeroPointC)
{
    ...
    r_lo = __lsx_vftint_w_s(
        __lsx_vfmadd_s(__lsx_vffint_s_w(r_lo), VectorScaleRatio, VectorZeroPointC));
    r_hi = __lsx_vftint_w_s(
        __lsx_vfmadd_s(__lsx_vffint_s_w(r_hi), VectorScaleRatio, VectorZeroPointC));
...
template <typename DataType, bool IsScalarB>
static void
MlasQLinearMulKernel(const DataType* InputA,
                     float ScaleA,
                     int32_t ZeroPointA,
                     const DataType* InputB,
                     float ScaleB,
                     ...
                     size_t N)
{
    ...
    while (N > 0) {
        ...
        InputA += 16;
        const auto va_lo_s16x8 =
            MlasExtendToS16Debias<DataType, true>(va_i8x16, ZeroVector, VectorZeroPointA);
        const auto va_hi_s16x8 =
            MlasExtendToS16Debias<DataType, false>(va_i8x16, ZeroVector, VectorZeroPointA);

        if (!IsScalarB) {
            const auto vb_i8x16 = __lsx_vld((const MLAS_INT32X4*)InputB, 0);
            InputB += 16;
            vb_lo_s16x8 =
                MlasExtendToS16Debias<DataType, true>(vb_i8x16, ZeroVector, VectorZeroPointB);
            vb_hi_s16x8 =
                MlasExtendToS16Debias<DataType, false>(vb_i8x16, ZeroVector, VectorZeroPointB);
        }

        const auto vc_lo_s16x8 =
            MlasQLinearMulVectorS16(va_lo_s16x8, vb_lo_s16x8, VectorScaleRatio, VectorZeroPointC);
        const auto vc_hi_s16x8 =
            MlasQLinearMulVectorS16(va_hi_s16x8, vb_hi_s16x8, VectorScaleRatio, VectorZeroPointC);
        auto vc = MlasPackS16_128<DataType>(vc_lo_s16x8, vc_hi_s16x8);
