...
--*/
        ...
        mov     v29.16b,v28.16b
        mov     v31.16b,v30.16b
        ldr     w18, [x8, #ConvSymPostProcessParams_ZeroPoint]
...
BlockloopPrologue
        ...
        blo     InChannel8     // less than 16 deep, no unroll
...
Blockloop
        ...
        eor     v6.8b, v6.8b, v2.8b
        eor     v1.8b, v1.8b, v2.8b
        eor     v7.8b, v7.8b, v2.8b
