...
ExitKernel:
        ...
        movaps  xmm12,XMMWORD PTR ConvSymDepthwiseKernelFrame.SavedXmm12[rsp]
        movaps  xmm13,XMMWORD PTR ConvSymDepthwiseKernelFrame.SavedXmm13[rsp]
        movaps  xmm14,XMMWORD PTR ConvSymDepthwiseKernelFrame.SavedXmm14[rsp]
        movaps  xmm15,XMMWORD PTR ConvSymDepthwiseKernelFrame.SavedXmm15[rsp]
