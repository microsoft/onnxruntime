 ...
 */
struct MLAS_QNBIT_GEMM_COMPUTE_TYPE {
 ...
 *          MLAS_QNBIT_GEMM_COMPUTE_TYPE::QuantBData in `DataParams` should point to a buffer packed with
...
MlasQNBitGemmBatch(
    ...
    const MLAS_QNBIT_GEMM_COMPUTE_TYPE* DataParams,
    void* Workspace,
