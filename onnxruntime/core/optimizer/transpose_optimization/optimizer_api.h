...
/// </summary>
class ValueInfoRef : virtual public onnxruntime::interface::ValueInfoViewRef {
 public:
  /// <summary>
...
/// </summary>
class NodeRef : virtual public onnxruntime::interface::NodeViewRef {
 public:
  /// <summary>
...
/// </summary>
class GraphRef : virtual public onnxruntime::interface::GraphViewRef {
 public:
  ...
  virtual std::unique_ptr<onnxruntime::interface::TensorRef> GetLocalConstant(std::string_view name) const = 0;
