...
std::optional<SliceInfo> UpStreamGatherGraphTransformer::IsSupportedGatherND(
    Graph& /*graph*/, Node& node, const logging::Logger& logger) const {
...
std::optional<SliceInfo> UpStreamGatherGraphTransformer::IsSupportedGather(Graph& /*graph*/, Node& node,
                                                                           const logging::Logger& logger) const {
