...
static std::vector<NodeArg*> MergeQkvWeightsForMatMulNBits(
  ...
  NodeArg& qkv_weight_arg = graph_utils::AddInitializerWithExternalData(graph, qkv_weight_initializer);
  NodeArg& qkv_scale_arg = graph_utils::AddInitializerWithExternalData(graph, qkv_scale_initializer);
  ...
  if (has_zero_points) {
    ...
    NodeArg& qkv_zp_arg = graph_utils::AddInitializerWithExternalData(graph, qkv_zp_initializer);
