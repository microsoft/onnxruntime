...
template <>
struct TypeInfoValueTraits<onnxruntime::fbs::TensorTypeAndShape> {
  static const TypeInfoValue enum_value = TypeInfoValue::tensor_type;
};

template <>
struct TypeInfoValueTraits<onnxruntime::fbs::SequenceType> {
  static const TypeInfoValue enum_value = TypeInfoValue::sequence_type;
};

template <>
struct TypeInfoValueTraits<onnxruntime::fbs::MapType> {
...
EdgeEnd FLATBUFFERS_FINAL_CLASS {
 private:
...
template <>
inline const onnxruntime::fbs::TensorTypeAndShape* TypeInfo::value_as<onnxruntime::fbs::TensorTypeAndShape>() const {
  return value_as_tensor_type();
}

template <>
inline const onnxruntime::fbs::SequenceType* TypeInfo::value_as<onnxruntime::fbs::SequenceType>() const {
  return value_as_sequence_type();
}

template <>
inline const onnxruntime::fbs::MapType* TypeInfo::value_as<onnxruntime::fbs::MapType>() const {
