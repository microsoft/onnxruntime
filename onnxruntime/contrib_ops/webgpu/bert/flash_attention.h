...
class FlashAttentionDecodeQKTVProgram final : public Program<FlashAttentionDecodeQKTVProgram> {
 public:
  FlashAttentionDecodeQKTVProgram(const std::string& kernel_name,
...
class FlashAttentionDecodeReduceProgram final : public Program<FlashAttentionDecodeReduceProgram> {
 public:
  FlashAttentionDecodeReduceProgram(const std::string& kernel_name, uint32_t tile_size)
