...
class ONNX_OPERATOR_TYPED_KERNEL_CLASS_NAME(kRocmExecutionProvider, kOnnxDomain, 1, MLFloat16, Crop);
  // [gfx900 excluded] class ONNX_OPERATOR_TYPED_KERNEL_CLASS_NAME(kRocmExecutionProvider, kMSDomain, 1, float, MultiHeadAttention);
  // [gfx900 excluded] class ONNX_OPERATOR_TYPED_KERNEL_CLASS_NAME(kRocmExecutionProvider, kMSDomain, 1, MLFloat16, MultiHeadAttention);
  // [gfx900 excluded] class ONNX_OPERATOR_TYPED_KERNEL_CLASS_NAME(kRocmExecutionProvider, kMSDomain, 1, MLFloat16, GroupQueryAttention);
...
class ONNX_OPERATOR_KERNEL_CLASS_NAME(kRocmExecutionProvider, kMSDomain, 1, GroupNorm);
  // [gfx900 excluded] class ONNX_OPERATOR_TYPED_KERNEL_CLASS_NAME(kRocmExecutionProvider, kMSDomain, 1, MLFloat16, NhwcConv);
  // [gfx900 excluded] class ONNX_OPERATOR_TYPED_KERNEL_CLASS_NAME(kRocmExecutionProvider, kMSDomain, 1, float, NhwcConv);
...
class ONNX_OPERATOR_THREE_TYPED_KERNEL_CLASS_NAME(kRocmExecutionProvider, kMSDomain, 1, uint8_t, float, int32_t, GatherBlockQuantized);
class ONNX_OPERATOR_THREE_TYPED_KERNEL_CLASS_NAME(kRocmExecutionProvider, kMSDomain, 1, uint8_t, float, int64_t, GatherBlockQuantized);
class ONNX_OPERATOR_THREE_TYPED_KERNEL_CLASS_NAME(kRocmExecutionProvider, kMSDomain, 1, uint8_t, MLFloat16, int32_t, GatherBlockQuantized);
class ONNX_OPERATOR_THREE_TYPED_KERNEL_CLASS_NAME(kRocmExecutionProvider, kMSDomain, 1, uint8_t, MLFloat16, int64_t, GatherBlockQuantized);
class ONNX_OPERATOR_THREE_TYPED_KERNEL_CLASS_NAME(kRocmExecutionProvider, kMSDomain, 1, UInt4x2, float, int32_t, GatherBlockQuantized);
class ONNX_OPERATOR_THREE_TYPED_KERNEL_CLASS_NAME(kRocmExecutionProvider, kMSDomain, 1, UInt4x2, float, int64_t, GatherBlockQuantized);
class ONNX_OPERATOR_THREE_TYPED_KERNEL_CLASS_NAME(kRocmExecutionProvider, kMSDomain, 1, UInt4x2, MLFloat16, int32_t, GatherBlockQuantized);
class ONNX_OPERATOR_THREE_TYPED_KERNEL_CLASS_NAME(kRocmExecutionProvider, kMSDomain, 1, UInt4x2, MLFloat16, int64_t, GatherBlockQuantized);
class ONNX_OPERATOR_THREE_TYPED_KERNEL_CLASS_NAME(kRocmExecutionProvider, kMSDomain, 1, Int4x2, float, int32_t, GatherBlockQuantized);
class ONNX_OPERATOR_THREE_TYPED_KERNEL_CLASS_NAME(kRocmExecutionProvider, kMSDomain, 1, Int4x2, float, int64_t, GatherBlockQuantized);
class ONNX_OPERATOR_THREE_TYPED_KERNEL_CLASS_NAME(kRocmExecutionProvider, kMSDomain, 1, Int4x2, MLFloat16, int32_t, GatherBlockQuantized);
class ONNX_OPERATOR_THREE_TYPED_KERNEL_CLASS_NAME(kRocmExecutionProvider, kMSDomain, 1, Int4x2, MLFloat16, int64_t, GatherBlockQuantized);
...
class ONNX_OPERATOR_TYPED_KERNEL_CLASS_NAME(kRocmExecutionProvider, kMSDomain, 1, MLFloat16_int8_t, QAttention);
  // [gfx900 excluded] class ONNX_OPERATOR_TYPED_KERNEL_CLASS_NAME(kRocmExecutionProvider, kMSDomain, 1, float, FusedConv);
  // [gfx900 excluded] class ONNX_OPERATOR_TYPED_KERNEL_CLASS_NAME(kRocmExecutionProvider, kMSDomain, 1, MLFloat16, FusedConv);
...
// class ONNX_OPERATOR_TYPED_KERNEL_CLASS_NAME(kRocmExecutionProvider, kMSDomain, 1, MLFloat16, DecoderMaskedSelfAttention);
  // [gfx900 excluded] class ONNX_OPERATOR_TYPED_KERNEL_CLASS_NAME(kRocmExecutionProvider, kMSDomain, 1, float, DecoderMaskedMultiHeadAttention);
  // [gfx900 excluded] class ONNX_OPERATOR_TYPED_KERNEL_CLASS_NAME(kRocmExecutionProvider, kMSDomain, 1, MLFloat16, DecoderMaskedMultiHeadAttention);
...
class ONNX_OPERATOR_TYPED_KERNEL_CLASS_NAME(kRocmExecutionProvider, kMSDomain, 1, BFloat16, GemmFastGelu);
  // [gfx900 excluded] class ONNX_OPERATOR_KERNEL_CLASS_NAME(kRocmExecutionProvider, kMSDomain, 1, GemmFloat8);
...
Status RegisterRocmContribKernels(KernelRegistry& kernel_registry) {
  ...
  // [gfx900 excluded] BuildKernelCreateInfo<ONNX_OPERATOR_TYPED_KERNEL_CLASS_NAME(kRocmExecutionProvider, kMSDomain, 1, float, MultiHeadAttention)>,
  // [gfx900 excluded] BuildKernelCreateInfo<ONNX_OPERATOR_TYPED_KERNEL_CLASS_NAME(kRocmExecutionProvider, kMSDomain, 1, MLFloat16, MultiHeadAttention)>,
  // [gfx900 excluded] BuildKernelCreateInfo<ONNX_OPERATOR_TYPED_KERNEL_CLASS_NAME(kRocmExecutionProvider, kMSDomain, 1, MLFloat16, GroupQueryAttention)>,
  ...
  // [gfx900 excluded] BuildKernelCreateInfo<ONNX_OPERATOR_TYPED_KERNEL_CLASS_NAME(kRocmExecutionProvider, kMSDomain, 1, MLFloat16, NhwcConv)>,
  // [gfx900 excluded] BuildKernelCreateInfo<ONNX_OPERATOR_TYPED_KERNEL_CLASS_NAME(kRocmExecutionProvider, kMSDomain, 1, float, NhwcConv)>,
    ...
    BuildKernelCreateInfo<ONNX_OPERATOR_THREE_TYPED_KERNEL_CLASS_NAME(kRocmExecutionProvider, kMSDomain, 1, uint8_t, float, int32_t, GatherBlockQuantized)>,
    BuildKernelCreateInfo<ONNX_OPERATOR_THREE_TYPED_KERNEL_CLASS_NAME(kRocmExecutionProvider, kMSDomain, 1, uint8_t, float, int64_t, GatherBlockQuantized)>,
    BuildKernelCreateInfo<ONNX_OPERATOR_THREE_TYPED_KERNEL_CLASS_NAME(kRocmExecutionProvider, kMSDomain, 1, uint8_t, MLFloat16, int32_t, GatherBlockQuantized)>,
    BuildKernelCreateInfo<ONNX_OPERATOR_THREE_TYPED_KERNEL_CLASS_NAME(kRocmExecutionProvider, kMSDomain, 1, uint8_t, MLFloat16, int64_t, GatherBlockQuantized)>,
    BuildKernelCreateInfo<ONNX_OPERATOR_THREE_TYPED_KERNEL_CLASS_NAME(kRocmExecutionProvider, kMSDomain, 1, UInt4x2, float, int32_t, GatherBlockQuantized)>,
    BuildKernelCreateInfo<ONNX_OPERATOR_THREE_TYPED_KERNEL_CLASS_NAME(kRocmExecutionProvider, kMSDomain, 1, UInt4x2, float, int64_t, GatherBlockQuantized)>,
    BuildKernelCreateInfo<ONNX_OPERATOR_THREE_TYPED_KERNEL_CLASS_NAME(kRocmExecutionProvider, kMSDomain, 1, UInt4x2, MLFloat16, int32_t, GatherBlockQuantized)>,
    BuildKernelCreateInfo<ONNX_OPERATOR_THREE_TYPED_KERNEL_CLASS_NAME(kRocmExecutionProvider, kMSDomain, 1, UInt4x2, MLFloat16, int64_t, GatherBlockQuantized)>,
    BuildKernelCreateInfo<ONNX_OPERATOR_THREE_TYPED_KERNEL_CLASS_NAME(kRocmExecutionProvider, kMSDomain, 1, Int4x2, float, int32_t, GatherBlockQuantized)>,
    BuildKernelCreateInfo<ONNX_OPERATOR_THREE_TYPED_KERNEL_CLASS_NAME(kRocmExecutionProvider, kMSDomain, 1, Int4x2, float, int64_t, GatherBlockQuantized)>,
    BuildKernelCreateInfo<ONNX_OPERATOR_THREE_TYPED_KERNEL_CLASS_NAME(kRocmExecutionProvider, kMSDomain, 1, Int4x2, MLFloat16, int32_t, GatherBlockQuantized)>,
    BuildKernelCreateInfo<ONNX_OPERATOR_THREE_TYPED_KERNEL_CLASS_NAME(kRocmExecutionProvider, kMSDomain, 1, Int4x2, MLFloat16, int64_t, GatherBlockQuantized)>,
  ...
  // [gfx900 excluded] BuildKernelCreateInfo<ONNX_OPERATOR_TYPED_KERNEL_CLASS_NAME(kRocmExecutionProvider, kMSDomain, 1, MLFloat16, FusedConv)>,
  // [gfx900 excluded] BuildKernelCreateInfo<ONNX_OPERATOR_TYPED_KERNEL_CLASS_NAME(kRocmExecutionProvider, kMSDomain, 1, float, FusedConv)>,
  ...
  // [gfx900 excluded] BuildKernelCreateInfo<ONNX_OPERATOR_TYPED_KERNEL_CLASS_NAME(kRocmExecutionProvider, kMSDomain, 1, float, DecoderMaskedMultiHeadAttention)>,
  // [gfx900 excluded] BuildKernelCreateInfo<ONNX_OPERATOR_TYPED_KERNEL_CLASS_NAME(kRocmExecutionProvider, kMSDomain, 1, MLFloat16, DecoderMaskedMultiHeadAttention)>,
  ...
  // [gfx900 excluded] BuildKernelCreateInfo<ONNX_OPERATOR_KERNEL_CLASS_NAME(kRocmExecutionProvider, kMSDomain, 1, GemmFloat8)>,
