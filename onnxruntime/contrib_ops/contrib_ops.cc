...
should be equal to the number of columns of input 'b'.)DOC")
      ...
      .Input(1, "a_scale", "N-dimensional quantized matrix A", "tensor(float)")
      .Input(2, "a_zero_point", "N-dimensional quantized matrix A", "T1")
      .Input(3, "b", "N-dimensional quantized matrix B", "T2")
      .Input(4, "b_scale", "N-dimensional quantized matrix A", "tensor(float)")
      .Input(5, "b_zero_point", "N-dimensional quantized matrix A", "T2")
      .Input(6, "y_scale", "N-dimensional quantized matrix A", "tensor(float)")
      .Input(7, "y_zero_point", "N-dimensional quantized matrix A", "T3")
