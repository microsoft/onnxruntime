 ...
 public:
  ...
  Status Compute(OpKernelContext* context) const override {
    ...
    if (nullptr == pred_tokens) {
      ...
      memcpy(out_tokens_data, cur_tokens_data, gsl::narrow_cast<size_t>(cur_tokens_len * sizeof(int64_t)));
    } else {
      ...
      auto* out_tokens_data = static_cast<int64_t*>(out_tokens->MutableDataRaw());
      memcpy(out_tokens_data, cur_tokens_data, gsl::narrow_cast<size_t>(cur_tokens_len * sizeof(int64_t)));
      memcpy(out_tokens_data + cur_tokens_len, pred_tokens_data, gsl::narrow_cast<size_t>((pred_bifur_idx + 1) * sizeof(int64_t)));
    }
