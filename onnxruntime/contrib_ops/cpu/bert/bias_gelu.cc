    ...
    if (use_approximation) {
      ...
      concurrency::ThreadPool::TryBatchParallelFor(
          ...
          [&](ptrdiff_t task_idx) {
            ...
            MlasComputeTanh(p_output, p_output, static_cast<size_t>(count));
...
void BiasGelu<T, use_approximation>::AddBiasGelu(
  ...
  if (use_approximation) {
    ...
    MlasComputeTanh(output, output, static_cast<size_t>(count));
    ...
    MlasComputeErf(output, output, static_cast<size_t>(count));
