...
private:
  Status GatherNumber(const Prepare& p, onnxruntime::concurrency::ThreadPool* ttp) const;
  Status GatherString(const Prepare& p, onnxruntime::concurrency::ThreadPool* ttp) const;
};
