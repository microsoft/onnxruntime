...
################################################################################
def generate_sm90_mixed_gemm_operations(enable_bf16=False, enable_fp8=False):
    arch = 90
    ...
    quant_ops = [LlmQuantOp.finegrained_scale_only, LlmQuantOp.finegrained_scale_and_zeros]
