...
{
using SizeType32 = ort_llm::runtime::SizeType32;
...
struct Params
{
    ...
    void* output;
    SizeType32 m, n, k;
    ort_llm::common::QuantMode quantMode;
    ...
    Params(void const* _act, void const* _weight, float _alpha, void* _output, SizeType32 _m, SizeType32 _n,
        SizeType32 _k, ort_llm::common::QuantMode _quant_mode, nvinfer1::DataType _inputType,
