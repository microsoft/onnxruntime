...
void cudaRandomUniform(T* buffer, const size_t size)
{
    ...
    //cuda_random_uniform_kernel<T><<<256, 256, 0, cudaStreamPerThread>>>(buffer, size, seq_offset);
    cuda_random_uniform_kernel<T><<<256, 256, 0, cudaStreamLegacy>>>(buffer, size, seq_offset);
    seq_offset += 256 * 256;
}
...
void invokeInPlaceTranspose(T* data, T* workspace, const size_t dim0, const size_t dim1)
{
    ...
    transpose<<<256, 256, 0, cudaStreamLegacy>>>(data, workspace, dim0, dim1);
}
    ...
    T* data, T* workspace, const size_t dim0, const size_t dim1, const size_t dim2, const size_t dim3)
{
    ...
    transpose0213<<<256, 256, 0, cudaStreamLegacy>>>(data, workspace, dim0, dim1, dim2, dim3);
}
...
void invokeInPlaceTranspose102(T* data, T* workspace, const size_t dim0, const size_t dim1, const size_t dim2)
{
    ...
    transpose102<<<256, 256, 0, cudaStreamLegacy>>>(data, workspace, dim0, dim1, dim2);
}
