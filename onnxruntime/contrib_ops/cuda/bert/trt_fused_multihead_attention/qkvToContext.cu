...
void FusedMHARunnerFP16::run(const void* qkvPtr, const void* maskPtr, void* output, void* workspace, cudaStream_t stream)
{
    pimpl->run(qkvPtr, maskPtr, output, workspace, stream);
}
