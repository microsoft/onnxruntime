...
class Kernel:
    ...
    def template(self) -> str:
        if self.direction == "fwd":
            ...
            return KERNEL_IMPL_TEMPLATE_FWD_SPLIT.format(DTYPE=DTYPE_MAP[self.dtype], HEAD_DIM=self.head_dim)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        "--output_dir",
        required=False,
        help="Where to generate the kernels. Default to the current directory",
    )
