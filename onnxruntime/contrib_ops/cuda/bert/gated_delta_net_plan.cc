...
bool Descriptor::operator==(const Descriptor& o) const noexcept {
  return total_tokens == o.total_tokens && batch == o.batch && num_heads_q == o.num_heads_q &&
         ...
         chunk_size == o.chunk_size && state_update_capacity == o.state_update_capacity &&
         state_update_active == o.state_update_active &&
...
size_t DescriptorHash::operator()(const Descriptor& d) const noexcept {
  ...
  mix(static_cast<uint64_t>(d.state_update_capacity));
  mix(static_cast<uint64_t>(d.state_update_active));
