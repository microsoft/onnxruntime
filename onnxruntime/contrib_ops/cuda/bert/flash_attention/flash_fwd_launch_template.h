  ...
  BOOL_SWITCH(is_even_MN, IsEvenMNConst, [&] {
    BOOL_SWITCH(is_even_K, IsEvenKConst, [&] {
      BOOL_SWITCH(params.window_size_left >= 0 || params.window_size_right >= 0, Is_local, [&] {
        ...
        auto kernel = &flash_fwd_kernel<Kernel_traits, Is_causal && !Is_local, Is_local,
            IsEvenMNConst && IsEvenKConst && !Is_local && Kernel_traits::kHeadDim <= 128, IsEvenKConst, false>;
        ...
        BOOL_SWITCH(params.window_size_left >= 0 || params.window_size_right >= 0, Is_local, [&] {
          BOOL_SWITCH(params.num_splits > 1, Split, [&] {
            BOOL_SWITCH(params.knew_ptr != nullptr, Append_KV, [&] {
              ...
              auto kernel = &flash_fwd_splitkv_kernel < Kernel_traits, Is_causal && !Is_local, Is_local,
...
void run_mha_fwd_hdim256(Flash_fwd_params& params, cudaStream_t stream) {
  ...
  int max_smem_per_sm = params.dprops->sharedMemPerMultiprocessor;
  int max_smem_per_block = params.dprops->sharedMemPerBlockOptin;
