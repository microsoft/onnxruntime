...
struct Flash_fwd_kernel_traits : public Base {
  ...
  using GmemLayoutAtom =
      cute::Layout<cute::Shape<cute::Int<kNThreads / kGmemThreadsPerRow>, cute::Int<kGmemThreadsPerRow>>,
  ...
  using GmemTiledCopyQKV =
      decltype(make_tiled_copy(Copy_Atom<Gmem_copy_struct, elem_type>{}, GmemLayoutAtom{},
  ...
  using GmemLayoutAtomP =
      cute::Layout<cute::Shape<cute::Int<kNThreads / kGmemThreadsPerRowP>, cute::Int<kGmemThreadsPerRowP>>,
                   cute::Stride<cute::Int<kGmemThreadsPerRowP>, _1>>;

  using GmemTiledCopyP =
      decltype(make_tiled_copy(Copy_Atom<DefaultCopy, elem_type>{}, GmemLayoutAtomP{},
                               cute::Layout<cute::Shape<_1, _8>>{}));  // Val layout, 8 vals per store
  ...
  using GmemTiledCopyRotcossin =
      decltype(make_tiled_copy(Copy_Atom<UniversalCopy<uint64_t>, Element>{}, GmemLayoutAtomRotcossin{},
                               Layout<Shape<_1, _4>>{}));  // Val layout, 4 vals per load
  using GmemTiledCopyRotcossinCont =
      decltype(make_tiled_copy(Copy_Atom<DefaultCopy, Element>{}, GmemLayoutAtomRotcossin{},
...
template <int kHeadDim_, int kBlockM_, int kBlockN_, int kNWarps_, int AtomLayoutMSdP_ = 1, int AtomLayoutNdKV = 2,
          int AtomLayoutMdQ = 2, bool Is_V_in_regs_ = false, bool No_double_buffer_ = false,
...
struct Flash_bwd_kernel_traits : public Base {
  ...
  using TiledMmadQ = TiledMMA<
      ...
      cute::Layout<cute::Shape<cute::Int<AtomLayoutMdQ>, cute::Int<kNWarps / AtomLayoutMdQ>, _1>>,  // 2x4x1 or 4x2x1
                                                                                                    // thread group
      Tile<Int<16 * AtomLayoutMdQ>, Int<16 * kNWarps / AtomLayoutMdQ>, _16>>;

  using SmemLayoutAtomQdO = decltype(composition(
      Swizzle<kSwizzle, 3, 3>{},
      cute::Layout<cute::Shape<_8, cute::Int<kBlockKSmem>>, cute::Stride<cute::Int<kBlockKSmem>, _1>>{}));
  using SmemLayoutQdO =
      decltype(tile_to_shape(SmemLayoutAtomQdO{}, cute::make_shape(cute::Int<kBlockM>{}, cute::Int<kHeadDim>{})));

  using SmemLayoutAtomKV = decltype(composition(
      Swizzle<kSwizzle, 3, 3>{}, cute::Layout<cute::Shape<cute::Int<kBlockM / kNWarps>, cute::Int<kBlockKSmem>>,
                                              cute::Stride<cute::Int<kBlockKSmem>, _1>>{}));
  using SmemLayoutKV = decltype(tile_to_shape(
      // SmemLayoutAtomQdO{},
      SmemLayoutAtomKV{}, cute::make_shape(cute::Int<kBlockN>{}, cute::Int<kHeadDim>{})));

  using SmemLayoutAtomKtransposedNoSwizzle =
      Layout<Shape<Int<kBlockKSmem>, Int<kBlockN>>, Stride<_1, Int<kBlockKSmem>>>;
  using SmemLayoutAtomKtransposed =
      decltype(composition(Swizzle<kSwizzle, 3, 3>{}, SmemLayoutAtomKtransposedNoSwizzle{}));
  ...
  using SmemLayoutAtomPdS = decltype(composition(
      ...
      cute::Layout<cute::Shape<cute::Int<kBlockM>, cute::Int<kPBlockN>>, cute::Stride<cute::Int<kPBlockN>, _1>>{}));
  using SmemLayoutPdS =
      decltype(tile_to_shape(SmemLayoutAtomPdS{}, cute::make_shape(cute::Int<kBlockM>{}, cute::Int<kBlockN>{})));
  ...
  using SmemLayoutAtomPdStransposed =
      decltype(composition(Swizzle<kSwizzlePdS, 3, 3>{}, SmemLayoutAtomPdStransposedNoSwizzle{}));
  ...
  using SmemLayoutAtomQdOtransposed =
      decltype(composition(Swizzle<kSwizzle, 3, 3>{}, SmemLayoutAtomQdOtransposedNoSwizzle{}));
  ...
  static constexpr int kSmemQdOCount =
      cute::size(SmemLayoutQdO{}) * (No_double_buffer ? 2 : 3);  // Double buffer for sQ
  static constexpr int kSmemKVCount = cute::size(SmemLayoutKV{}) * 2;
  ...
  static constexpr int kSmemSize1colblock =
      kSmemQdOSize + (!Is_V_in_regs ? kSmemKVSize + kSmemdSSize + kSmemPSize
