...
void LaunchAddBiasTranspose(
  ...
  if (enable_half4 && 0 == (qk_head_size % 4) && 0 == (v_head_size % 4) && !do_rotary) {
  ...
  } else if (0 == (qk_head_size & 1) && 0 == (v_head_size % 1) && !do_rotary) {
...
void LaunchAddBiasTranspose(
  ...
  total_matrix_count = std::max(num_matrices, total_matrix_count);
  if (0 == (qk_head_size % 4) && 0 == (v_head_size % 4) && !do_rotary) {
    const int H = qk_head_size / 4;
