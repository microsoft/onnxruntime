...
// currently only for float16
template void mmha_quant_kv_launch_kernel<uint16_t, 32>(const DecoderMaskedMultiHeadAttentionQuantKVParams& params, cudaStream_t stream);
