...
class QMoE final : public CudaKernel, public MoEBase {
 ...
 private:
  ...
  void TryBuildDsv4DeepGemmWeights(int fc, cudaStream_t stream, AllocatorPtr alloc);
  ...
  IAllocatorUniquePtr<void> dsv4_deep_gemm_fc1_staged_weights_;
  IAllocatorUniquePtr<void> dsv4_deep_gemm_fc2_staged_weights_;
  IAllocatorUniquePtr<void> dsv4_deep_gemm_fc1_staged_block_scales_;
