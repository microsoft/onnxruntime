...
class MoeGemmRunner {
 public:
  ...
  std::vector<CutlassGemmConfig> getConfigs() const;
  static std::vector<CutlassGemmConfig> getConfigs(int sm);
  static std::vector<CutlassGemmConfig> getHopperConfigs(int sm);
  static std::vector<CutlassGemmConfig> getAmpereConfigs(int sm);
