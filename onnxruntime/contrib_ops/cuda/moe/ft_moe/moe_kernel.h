...
class CutlassMoeFCRunner {
 public:
  CutlassMoeFCRunner(int sm_version, ActivationType activation_type, bool has_fc3, bool normalize_routing_weights, bool use_sparse_mixer, bool swiglu_interleaved = true, float swiglu_alpha = 1.702f);
