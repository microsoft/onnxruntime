...
// TODO: Remove the following line if you use CUDA < 11
#define CUDA11_MODE 1

#define GRID_COUNT(total, block) static_cast<int>((total + block - 1) / block)
...
{
#if defined(_MSC_VER)
  return static_cast<int8_t>(x); //TODO: use asm
