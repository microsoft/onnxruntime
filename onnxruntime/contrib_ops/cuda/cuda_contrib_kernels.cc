...
class CUDA_MS_OP_TYPED_CLASS_NAME(1, float, ArflowMoE);
class CUDA_MS_OP_TYPED_CLASS_NAME(1, MLFloat16, ArflowMoE);
...
Status RegisterCudaContribKernels(KernelRegistry& kernel_registry) {
  static const BuildKernelCreateInfoFn function_table[] = {
    ...
    BuildKernelCreateInfo<CUDA_MS_OP_TYPED_CLASS_NAME(1, float, ArflowMoE)>,
    BuildKernelCreateInfo<CUDA_MS_OP_TYPED_CLASS_NAME(1, MLFloat16, ArflowMoE)>,
