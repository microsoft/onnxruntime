...
class CUDA_MS_OP_TYPED_CLASS_NAME(1, float, SparseRowSelect);
class CUDA_MS_OP_TYPED_CLASS_NAME(1, MLFloat16, SparseRowSelect);
class CUDA_MS_OP_TYPED_CLASS_NAME(1, BFloat16, SparseRowSelect);
...
Status RegisterCudaContribKernels(KernelRegistry& kernel_registry) {
  static const BuildKernelCreateInfoFn function_table[] = {
      ...
      BuildKernelCreateInfo<CUDA_MS_OP_TYPED_CLASS_NAME(1, float, SparseRowSelect)>,
      BuildKernelCreateInfo<CUDA_MS_OP_TYPED_CLASS_NAME(1, MLFloat16, SparseRowSelect)>,
      BuildKernelCreateInfo<CUDA_MS_OP_TYPED_CLASS_NAME(1, BFloat16, SparseRowSelect)>,
