...
class CUDA_MS_OP_TYPED_CLASS_NAME(1, float, VarlenEngramGate);
class CUDA_MS_OP_TYPED_CLASS_NAME(1, MLFloat16, VarlenEngramGate);
class CUDA_MS_OP_TYPED_CLASS_NAME(1, BFloat16, VarlenEngramGate);
...
Status RegisterCudaContribKernels(KernelRegistry& kernel_registry) {
  static const BuildKernelCreateInfoFn function_table[] = {
      ...
      BuildKernelCreateInfo<CUDA_MS_OP_TYPED_CLASS_NAME(1, float, VarlenEngramGate)>,
      BuildKernelCreateInfo<CUDA_MS_OP_TYPED_CLASS_NAME(1, MLFloat16, VarlenEngramGate)>,
      BuildKernelCreateInfo<CUDA_MS_OP_TYPED_CLASS_NAME(1, BFloat16, VarlenEngramGate)>,
