...
class CudaTensorConsoleDumper : public onnxruntime::contrib::IConsoleDumper {
 public:
  ...
  void Print(const char* name, const int32_t* tensor, gsl::span<const int64_t>& dims) const;
  ...
  void Print(const char* name, const int64_t* tensor, gsl::span<const int64_t>& dims) const;
  ...
  void Print(const char* name, const float* tensor, gsl::span<const int64_t>& dims) const;
  ...
  void Print(const char* name, const MLFloat16* tensor, gsl::span<const int64_t>& dims) const;
