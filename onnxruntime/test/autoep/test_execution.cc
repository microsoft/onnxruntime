  ...
  // Create a session and expect an error.
  {
    ...
    try {
      ...
      std::string_view expected_msg_prefix =
          "EPContext node generated by 'example_ep' was not assigned "
          "to any execution provider in the session. Please add a compatible execution provider to the session.";
