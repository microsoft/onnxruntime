...
graph = helper.make_graph(
    [div, shape_left, shape_right, gather0, gather1, gather2, gather3, mul, unsq0, unsq1, unsq2, concat, unsqueeze1, unsqueeze2, squeeze1, squeeze2, reshape],
    "Div_Shape_Gather_Concat_Reshape",
    [input_tensor],
    [output_tensor],
    initializer=[B, g0_idx, g1_idx, g2_idx, g3_idx, axes_unsq0, axes_unsq1, axes_unsq2, axes_u1, axes_u2, axes_s1, axes_s2],
)
