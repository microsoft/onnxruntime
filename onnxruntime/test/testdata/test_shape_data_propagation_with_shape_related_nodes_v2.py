...
input_tensor = helper.make_tensor_value_info(
    'input', TensorProto.FLOAT, ['batch', 3, 'width', 'height']
)
output_tensor = helper.make_tensor_value_info(
    'output', TensorProto.FLOAT, ['batch', 3, 'width*height']
)
...
reshape = helper.make_node('Reshape', ['div_out', 'concat_out'], ['output'])

# === Graph ===
graph = helper.make_graph(
    [div, shape_left, shape_right,
     gather0, gather1, gather2, gather3,
     mul, unsq0, unsq1, unsq2,
     concat, reshape],
    'Div_Shape_Gather_Concat_Reshape',
    [input_tensor],
    [output_tensor],
    initializer=[
        B, g0_idx, g1_idx, g2_idx, g3_idx,
        axes_unsq0, axes_unsq1, axes_unsq2
    ]
)
...
onnx.save(model, 'test_shape_data_propagation_with_shape_related_nodes_v2.onnx')

print("✅ Model saved as test_shape_data_propagation_with_shape_related_nodes_v2.onnx")
