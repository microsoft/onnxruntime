...
Y = helper.make_tensor_value_info(
    "output", TensorProto.FLOAT, ["batch", "dynamic_prediction_count", 128]
)
...
matmul1 = helper.make_node(
    "MatMul", ["input", matmul1_initializer.name], ["matmul1"], name="matmul_1"
)
...
graph_def = helper.make_graph(
    nodes, "test-model", [X, unsqueezed_masked_lm_positions], [Y], initializers
)
