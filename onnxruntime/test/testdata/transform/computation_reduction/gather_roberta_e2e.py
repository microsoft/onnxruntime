...
nodes = [
    helper.make_node("Dropout", ["input", "scalar_float_0.1", "scalar_bool_true"], ["d1_out", "d1_mask"], "d1"),
    ...
    helper.make_node("Dropout", ["softmax1_out", "scalar_float_0.1", "scalar_bool_true"], ["d2_out", "d2_mask"], "d2"),
    ...
    helper.make_node("Dropout", ["a5_out", "scalar_float_0.1", "scalar_bool_true"], ["d4_out", 'd4_mask"'], "d4"),
    ...
    helper.make_node("Dropout", ["a7_out", "scalar_float_0.1", "scalar_bool_true"], ["d5_out", "d5_mask"], "d5"),
    ...
    helper.make_node(
        "Dropout", ["final_gather_out", "scalar_float_0.1", "scalar_bool_true"], ["final_output", "d6_mask"], "d6"
    ),
]
