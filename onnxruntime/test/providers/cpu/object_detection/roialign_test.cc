...
TEST(RoiAlignTest, AvgModeNegativeInvalidNumRoiDims) {
  ...
  test.Run(OpTester::ExpectResult::kExpectFailure, "[ShapeError] Input 1 expected to have rank 2 but has rank 3");
}
...
TEST(RoiAlignTest, MismatchNumRois) {
  ...
  test.Run(OpTester::ExpectResult::kExpectFailure, "[ShapeError] Dimension mismatch in unification between 4 and 5");
}
}  // namespace test
}  // namespace onnxruntime
