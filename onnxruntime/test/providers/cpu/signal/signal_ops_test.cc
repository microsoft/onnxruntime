...
static void TestNaiveDFTFloat(bool is_onesided) {
  OpTester test("DFT", 17);

  std::vector<int64_t> shape = {1, 5, 1};
...
TEST(SignalOpsTest, DFTFloat_Radix2) {
...
TEST(SignalOpsTest, HammingWindowFloat) {
  OpTester test("HammingWindow", 17);
...
TEST(SignalOpsTest, BlackmanWindowFloat) {
  OpTester test("BlackmanWindow", 17);
...
TEST(SignalOpsTest, MelWeightMatrixFloat) {
  OpTester test("MelWeightMatrix", 17);
