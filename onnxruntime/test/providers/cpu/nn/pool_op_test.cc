...
TEST(PoolTest, MaxPool2D_uint8) {
  ...
  std::vector<uint8_t> output = {
      13, 14, 15, 15, 15, 18, 19, 20, 20, 20, 23, 24, 25, 25, 25, 23, 24, 25, 25, 25, 23, 24, 25, 25, 25};
...
TEST(PoolTest, MaxPool_DefaultDilations) {
  ...
  std::vector<float> x_vals = {0.f, 1.f, 2.f, 3.f, 4.f, 5.f, 6.f, 7.f, 8.f};

  std::vector<int64_t> expected_dims = {1, 3, 2};
  std::vector<float> expected_vals = {1.f, 2.f, 4.f, 5.f, 7.f, 8.f};
...
TEST(PoolTest, MaxPool_DefaultDilations_int8) {
  ...
  std::vector<int64_t> x_dims = {1, 3, 3};
  std::vector<int8_t> x_vals = {0, 1, 2, 3, 4, 5, 6, 7, 8};

  std::vector<int64_t> expected_dims = {1, 3, 2};
  std::vector<int8_t> expected_vals = {1, 2, 4, 5, 7, 8};
...
TEST(PoolTest, MaxPool_DefaultDilations_uint8) {
  ...
  std::vector<int64_t> x_dims = {1, 3, 3};
  std::vector<uint8_t> x_vals = {0, 1, 2, 3, 4, 5, 6, 7, 8};

  std::vector<int64_t> expected_dims = {1, 3, 2};
  std::vector<uint8_t> expected_vals = {1, 2, 4, 5, 7, 8};
...
TEST(PoolTest, MaxPool_10_Dilation_2d) {
  ...
  std::vector<float> x_vals = {
      1, 3, 2, 4, -1, 5, 7, 6, 8, -2, 9, 11, 10, 12, -3, 13, 15, 14, 16, -4};
...
TEST(PoolTest, MaxPool_10_DilationPadding_2d) {
  ...
  std::vector<float> expected_vals = {
      7, 6, 8, 6, 8, 11, 10, 12, 10, 12, 15, 14, 16, 14, 16, 11, 10, 12, 10, 12};
...
TEST(PoolTest, MaxPool_10_DilationPadding_3d) {
  ...
  std::vector<float> x_vals = {
      1, 3, 2, 4, -1, 5, 7, 6, 8, -2, 9, 11, 10, 12, -3, 13, 15, 14, 16, -4, 1, 3, 2, 4, -1, 5, 7, 6, 8, -2, 9, 11, 10, 12, -3, 13, 15, 14, 16, -4};
  std::vector<int64_t> x_dims = {1, 1, 2, 4, 5};
  std::vector<int64_t> expected_dims = {1, 1, 2, 4, 5};
  std::vector<float> expected_vals = {
      7, 6, 8, 6, 8, 11, 10, 12, 10, 12, 15, 14, 16, 14, 16, 11, 10, 12, 10, 12, 7, 6, 8, 6, 8, 11, 10, 12, 10, 12, 15, 14, 16, 14, 16, 11, 10, 12, 10, 12};
...
TEST(PoolTest, AveragePool_IncludePadPixel) {
  ...
  std::vector<float> x_vals = {0.3337f, 0.8794f, 0.3375f, 0.6666f, 0.4426f, 0.6474f, 0.7675f, 0.8823f, 0.8852f};

  std::vector<int64_t> x_dims = {1, 1, 3, 3};
  std::vector<int64_t> expected_dims = {1, 1, 4, 4};
  std::vector<float> expected_vals = {0.0834f, 0.3033f, 0.3042f, 0.0844f, 0.2501f, 0.5806f, 0.5767f, 0.2462f, 0.3585f, 0.6897f, 0.7144f, 0.3832f, 0.1919f, 0.4124f, 0.4419f, 0.2213f};
...
TEST(PoolTest, AveragePool_DefaultStrides) {
  ...
  std::vector<int64_t> x_dims = {1, 3, 3};
  std::vector<int64_t> expected_dims = {1, 3, 2};
  std::vector<float> expected_vals = {0.5f, 1.5f, 3.5f, 4.5f, 6.5f, 7.5f};
...
TEST(PoolTest, GlobalLpPool) {
  ...
  std::vector<int64_t> x_dims = {1, 3, 9, 9};
  std::vector<int64_t> expected_dims = {1, 3, 1, 1};
  std::vector<float> expected_vals = {2.7576668262481689453125, 2.6182243824005126953125, 2.682276248931884765625};
