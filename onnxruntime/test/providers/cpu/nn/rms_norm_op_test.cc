...
TEST(RMSNormalizationOpTest, RMSNorm) {
  ...
  test.AddInput<float>("scale", scale_dims, {1.F, 1.F, 1.F}, true);
...
TEST(RMSNormalizationOpTest, RMSNorm_float16) {
  ...
  vector<int64_t> scale_dims = {3};
  test.AddInput<MLFloat16>("scale", scale_dims, ToFloat16({1.F, 1.F, 1.F}), true);
...
TEST(RMSNormalizationOpTest, RMSNorm_Scale) {
  ...
  test.AddInput<float>("scale", scale_dims, {-0.6953f, 5.1824f}, true);
...
TEST(RMSNormalizationOpTest, RMSNorm_Scale_Float16) {
  ...
  vector<int64_t> scale_dims = {2};
  test.AddInput<MLFloat16>("scale", scale_dims, ToFloat16({-0.6953f, 5.1824f}), true);
