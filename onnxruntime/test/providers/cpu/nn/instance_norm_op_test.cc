...
TEST(InstanceNormalizationOpTest, InstanceNorm) {
  ...
  vector<float> input = {3.1513367F, 9.283596F, 1.4546119F, 5.4617004F, 8.519701F, 1.2382338F, 1.7930176F, 5.1099434F, 7.9195533F, 7.638727F, 8.065445F, 3.8082376F,
  ...
  vector<float> expected_output = {-0.56495477F, 1.48930046F, -1.13334329F, 0.20899761F, 1.46688162F, -0.98600774F, -0.79911913F, 0.31824524F, 0.57370438F, 0.42193634F, 0.6525492F, -1.64818992F,
...
TEST(InstanceNormalizationOpTest, InstanceNorm_2) {
  ...
  vector<float> input = {2.676342F, 4.1100464F, 4.570907F, 5.8493505F, 4.772751F, 7.1669755F, 2.8400702F, 8.903057F, 1.2464883F, 7.034208F, 4.755743F, 6.0282083F, 2.2634823F, 2.7829134F, 8.206701F, 9.7143545F, 3.8208177F, 7.2309036F, 8.887503F, 9.05146F, 1.7653979F, 1.351493F, 2.5284739F, 8.903282F, 1.8851215F, 4.7899685F, 9.621006F, 5.7984877F, 7.226894F, 3.8396406F, 7.1785083F, 8.511631F, 1.1645945F, 7.751299F, 9.89975F, 7.733491F};
  ...
  vector<float> expected_output = {-3.1855264F, 1.3537457F, 2.8128836F, 6.860582F, 3.451944F, 11.032334F, -4.252796F, 13.116836F, -8.8181925F, 7.7628374F, 1.2353455F, 4.880785F, 0.6543751F, 0.83380324F, 2.7073524F, 3.2281437F, 1.1923285F, 2.3702807F, 8.316614F, 8.533577F, -1.1079268F, -1.6556396F, -0.098163605F, 8.337496F, -8.482306F, 0.1348517F, 14.466003F, 3.1265988F, 7.3639297F, -2.684272F, 1.88028F, 2.353724F, -0.25549555F, 2.0837004F, 2.8466992F, 2.0773761F};
  test.AddOutput<float>("Y", input_dims, expected_output);
#if defined(OPENVINO_CONFIG_MYRIAD)  // Disabling this test on MYRIADX temporarily due to a bug
  test.Run(OpTester::ExpectResult::kExpectSuccess, "", {kOpenVINOExecutionProvider});
#else
