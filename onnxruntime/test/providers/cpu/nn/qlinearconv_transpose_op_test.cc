...
struct QLinearConvTransposeOpAttributes {
...
void TestConvTransposeOp(const QLinearConvTransposeOpAttributes& attributes,
  ...
  OpTester test("QLinearConvTranspose", 1, onnxruntime::kMSDomain);
  ...
  FindMinMax(inputs[0], &lhs_min, &lhs_max);
  FindMinMax(inputs[1], &rhs_min, &rhs_max);
  FindMinMax(expected_output, &result_min, &result_max);
  ...
  vector<uint8_t> x_quantized(inputs[0].size()), w_quantized(inputs[1].size()), result_quantized(expected_output.size());
  Quantize(lhs_scale, lhs_zero_point, inputs[0], &x_quantized);
  Quantize(rhs_scale, rhs_zero_point, inputs[1], &w_quantized);
  Quantize(result_scale, result_zero_point, expected_output, &result_quantized);
  ...
  test.AddInput<uint8_t>("x", input_shapes[0], x_quantized);
  test.AddInput<float>("x_scale", {}, {lhs_scale});
  test.AddInput<uint8_t>("x_zero_point", {}, {lhs_zero_point});

  test.AddInput<uint8_t>("w", input_shapes[1], w_quantized);
  ...
  test.AddOutput<uint8_t>("y", expected_output_shape, result_quantized);
  test.Run(expect_result, err_str);
}
}  // namespace

TEST(QLinearConvTransposeTest, QLinearConvTranspose_1) {
  QLinearConvTransposeOpAttributes attrs = {
...
TEST(QLinearConvTransposeTest, QLinearConvTranspose_Bias_1) {
  QLinearConvTransposeOpAttributes attrs = {
      vector<int64_t>{3, 3},        // kernel_shape
...
/*
TEST(QLinearConvTransposeTest, QLinearConvTranspose_Bias_2) {
  QLinearConvTransposeOpAttributes attrs = {
...
TEST(QLinearConvTransposeTest, QLinearConvTranspose_Output_Shape) {
  QLinearConvTransposeOpAttributes attrs = {
      vector<int64_t>{3, 3},        // kernel_shape
      {},                           // output_padding
...
TEST(QLinearConvTransposeTest, QLinearConvTranspose_Output_Shape2) {
  QLinearConvTransposeOpAttributes attrs = {
...
TEST(QLinearConvTransposeTest, QLinearConvTranspose_Output_Shape_Batch) {
  QLinearConvTransposeOpAttributes attrs = {
      vector<int64_t>{1, 5},         // kernel_shape
      {},                            // output_padding
...
TEST(QLinearConvTransposeTest, QLinearConvTranspose_Invalid_Kernel_Shape) {
  QLinearConvTransposeOpAttributes attrs = {
...
TEST(QLinearConvTransposeTest, QLinearConvTranspose_onnx) {
  QLinearConvTransposeOpAttributes attrs = {
      vector<int64_t>{3, 3},        // kernel_shape
      {},                           // output_padding
      {},                           // output_shape
...
TEST(QLinearConvTransposeTest, QLinearConvTranspose_onnx2) {
  QLinearConvTransposeOpAttributes attrs = {
      vector<int64_t>{2, 2},        // kernel_shape
      {},                           // output_padding
      {},                           // output_shape
...
TEST(QLinearConvTransposeTest, QLinearConvTranspose_onnx_group) {
  QLinearConvTransposeOpAttributes attrs = {
