...
TEST(MLOpTest, SVMClassifierMulticlassSVC) {
  ...
  std::vector<float> scores = {
      -0.956958294f, 0.799815655f, 0.799815655f, 0.988598406f, 0.988598406f, 0, -0.159782529f, 0.407864451f, 0.407864451f, 0.347750872f, 0.347750872f, 0, 0.527958274f, -0.999705434f, 0.326051623f, -0.999675810f, 0.0666372105f, 1.00000000f, 0.527958274f, 0.325695992f, 0.326051623f, 0.0663511604f, 0.0666372105f, 0.000268258271f, 0.527958274f, 0.325695992f, 0.326051623f, 0.0663511604f, 0.0666372105f, 0.000268258271f, 0.527958274f, 0.326051623f, 0.326051623f, 0.0666372105f, 0.0666372105f, 0, 0.527958274f, 0.325695992f, 0.326051623f, 0.0663511604f, 0.0666372105f, 0.000268258271f, 0.527958274f, 0.326051623f, -0.999705434f, 0.0666372105f, -0.999675810f, -1.00000000f};
...
TEST(MLOpTest, SVMClassifierSVCProbabilities) {
  ...
  std::vector<float> prob_predictions = {
      0.13766955f, 0.21030431f, 0.32596754f, 0.3260586f, 0.45939931f, 0.26975416f, 0.13539588f, 0.13545066f, 0.71045899f, 0.07858939f, 0.05400437f, 0.15694726f, 0.58274772f, 0.10203105f, 0.15755227f, 0.15766896f, 0.58274772f, 0.10203105f, 0.15755227f, 0.15766896f};
...
TEST(MLOpTest, SVMClassifierSVC) {
  ...
  std::vector<float> scores_predictions = {
      0.95695829391479492f, -0.95695829391479492f, 0.1597825288772583f, -0.1597825288772583f, 0.797798752784729f, -0.797798752784729f, -0.52760261297225952f, 0.52760261297225952f, -0.52760261297225952f, 0.52760261297225952f};
...
TEST(MLOpTest, SVMClassifierSVCDouble) {
  ...
  std::vector<double> X = {1.f, 0.0f, 0.4f, 3.0f, 44.0f, -3.f, 12.0f, 12.9f, -312.f, 23.0f, 11.3f, -222.f, 23.0f, 11.3f, -222.f};
  std::vector<float> scores_predictions = {
      0.95695829391479492f, -0.95695829391479492f, 0.1597825288772583f, -0.1597825288772583f, 0.797798752784729f, -0.797798752784729f, -0.52760261297225952f, 0.52760261297225952f, -0.52760261297225952f, 0.52760261297225952f};
  std::vector<int64_t> class_predictions = {1, 1, 1, 0, 0};
...
TEST(MLOpTest, SVMClassifierLinear) {
  ...
  std::vector<float> coefficients = {0.766398549079895f, 0.0871576070785522f, 0.110420741140842f, -0.963976919651031f};
  std::vector<float> support_vectors = {4.80000019073486f, 3.40000009536743f, 1.89999997615814f, 5.f, 3.f, 1.60000002384186f, 4.5f, 2.29999995231628f, 1.29999995231628f, 5.09999990463257f, 2.5f, 3.f};
  ...
  std::vector<float> X = {5.1f, 3.5f, 1.4f, 4.9f, 3.f, 1.4f, 4.7f, 3.2f, 1.3f, 4.6f, 3.1f, 1.5f, 5.f, 3.6f, 1.4f};
  std::vector<float> scores_predictions = {-1.5556798f, 1.5556798f, -1.2610321f, 1.2610321f, -1.5795376f, 1.5795376f, -1.3083477f, 1.3083477f, -1.6572928f, 1.6572928f};
