...
static std::vector<float> x_vals_3dims = {
    1.0856307f, 0.99734545f, 0.2829785f, 1.5062947f, 0.5786002f, 1.6514366f, 2.4266791f, 0.42891264f, 1.2659363f, 0.8667404f, 0.6788862f, 0.09470897f, 1.4913896f, 0.638902f, 0.44398195f, 0.43435127f, 2.20593f, 2.1867862f, 1.004054f, 0.3861864f,
...
TEST(SoftmaxOperator, ThreeDimsAxis0) {
  ...
  std::vector<float> expected_vals = {
      0.01424391f, 0.013040296f, 0.0063832495f, 0.021693084f, 0.0085788425f, 0.02508162f, 0.054455176f, 0.007386185f, 0.017058268f, 0.011443698f, 0.009483798f, 0.0052878284f, 0.021372143f, 0.009112078f, 0.0074983323f, 0.0074264654f, 0.04366858f, 0.04284054f, 0.01312807f, 0.007077248f,
...
TEST(SoftmaxOperator, ThreeDimsAxis1) {
  ...
  std::vector<float> expected_vals = {
      0.04113652f, 0.037660476f, 0.018434875f, 0.0626498f, 0.024775764f, 0.072435915f, 0.15726697f, 0.021331362f, 0.049264412f, 0.03304949f, 0.027389284f, 0.015271291f, 0.061722923f, 0.026315752f, 0.021655245f, 0.021447688f, 0.1261152f, 0.12372383f, 0.03791397f, 0.020439148f,
...
TEST(SoftmaxOperator, ThreeDimsAxis1_opset13) {
  ...
  std::vector<float> expected_vals = {
      0.253289f, 0.11198013f, 0.08185529f, 0.35567388f, 0.24795689f, 0.44600812f, 0.46761957f, 0.09471639f, 0.2796827f, 0.3307607f, 0.16864346f, 0.04540785f, 0.27406466f, 0.14939913f, 0.2167266f, 0.1320594f, 0.3749925f, 0.5493636f, 0.21524426f, 0.20455585f,
  ...
  RunTest(x_vals_3dims, expected_vals, three_dimensions, /*opset*/ 13, /*axis*/ 1, {kTensorrtExecutionProvider, kOpenVINOExecutionProvider});  // OpenVINO doesn't support opset-13 yet
}
...
TEST(SoftmaxOperator, ThreeDimsAxis2) {
  ...
  std::vector<float> expected_vals = {
      0.22277209f, 0.20394778f, 0.09983283f, 0.33927578f, 0.13417149f, 0.21729809f, 0.47177994f, 0.06399124f, 0.14778666f, 0.099144064f, 0.1797734f, 0.10023525f, 0.40512702f, 0.17272712f, 0.14213723f, 0.06506401f, 0.3825848f, 0.37533033f, 0.11501635f, 0.062004484f,
...
TEST(SoftmaxOperator, ThreeDimsAxis2_opset13) {
  ...
  RunTest(x_vals_3dims, expected_vals, three_dimensions, /*opset*/ 13, /*axis*/ 2, {kOpenVINOExecutionProvider});  // OpenVINO doesn't support opset-13 yet
}
...
TEST(SoftmaxOperator, ThreeDimsDefaultAxis_opset13) {
  ...
  RunTest(x_vals_3dims, expected_vals, three_dimensions, /*opset*/ 13, /*default axis*/ -1, {kOpenVINOExecutionProvider});  // OpenVINO doesn't support opset-13 yet
}
...
TEST(SoftmaxOperator, DimWithZero) {
  ...
  RunTest(x_vals, expected_vals, dimensions, /*opset*/ -1, /*axis*/ 0, {kTensorrtExecutionProvider,
