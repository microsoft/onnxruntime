...
static std::unordered_set<std::string> GetExcludedExecutionProviders(int version) {
...
TEST(GridsampleTest, test_grid_sample_16_4D_nearest_zeros_align_corners) {
  ...
  test.Run(OpTester::ExpectResult::kExpectSuccess, "", GetExcludedExecutionProviders(16));
}
...
TEST(GridsampleTest, test_grid_sample_20_4D_nearest_zeros_align_corners) {
  ...
  test.AddAttribute("align_corners", align_corners);
  test.AddOutput<float>("Y", Y_shape, Y_data);
  test.Run(OpTester::ExpectResult::kExpectSuccess, "", GetExcludedExecutionProviders(20));
}
