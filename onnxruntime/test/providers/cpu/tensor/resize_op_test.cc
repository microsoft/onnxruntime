...
TEST(ResizeOpTest, ResizeOpLinearDownSampleTest_tf_crop_and_resize) {
  ...
  std::vector<float> Y = {7.600004f, 7.9f, 8.2f, 8.8f, 9.1f, 9.4f, 10.0f, 10.3f, 10.6f};
...
TEST(ResizeOpTest, ResizeOpLinearDownSampleTest_tf_crop_and_resize_with_extrapolation) {
  ...
  std::vector<float> Y = {7.6f, 10.0f, 10.0f, 12.4f, 10.f, 10.0f, 10.0f, 10.0f, 10.0f};
...
TEST(ResizeOpTest, NhwcResizeOpLinearDownSampleTest_tf_crop_and_resize_with_extrapolation) {
  ...
  std::vector<float> Y = {7.6000004f, 10.0f, 10.0f, 12.400001f, 10.f, 10.0f, 10.0f, 10.0f, 10.0f};
  ...
  test.Run(OpTester::ExpectResult::kExpectSuccess, "", {kCudaExecutionProvider, kTensorrtExecutionProvider, kRocmExecutionProvider, kQnnExecutionProvider});
}
...
TEST(ResizeOpTest, NhwcResizeOpLinearDownSampleTest_tf_crop_and_resize_with_extrapolation_uint8) {
  ...
  std::vector<uint8_t> Y = {7, 10, 10, 12, 10, 10, 10, 10, 10};
...
TEST(ResizeOpTest, NhwcResizeOpLinearDownSampleTest_tf_crop_and_resize_with_extrapolation_int8) {
  ...
  std::vector<int8_t> Y = {-2, 10, 10, 0, 10, 10, 10, 10, 10};
...
TEST(ResizeOpTest, NhwcResizeOpLinearDownSampleTest_tf_crop_and_resize_without_extrapolation_uint8) {
  ...
  std::vector<uint8_t> Y = {7, 0, 0, 12, 0, 0, 0, 0, 0};
...
TEST(ResizeOpTest, NhwcResizeOpLinearDownSampleTest_tf_crop_and_resize_without_extrapolation_int8) {
  ...
  std::vector<int8_t> Y = {-2, 0, 0, 0, 0, 0, 0, 0, 0};
...
TEST(ResizeOpTest, ResizeOpLinearUpSampleTest_4DBilinear_asymmetric) {
  ...
  auto run_test = [](bool scales_in_initializer) {
    ...
    std::vector<float> X = {1.0f, 3.0f, 4.0f, 8.0f,
    ...
    std::vector<float> Y = {
        1.0f, 1.5f, 2.0f, 2.5f, 3.0f, 3.0f, 3.0f, 3.0f, 2.5f, 3.25f, 4.0f, 4.75f, 5.5f, 5.5f, 5.5f, 5.5f, 4.0f, 5.0f, 6.0f, 7.0f, 8.0f, 8.0f, 8.0f, 8.0f, 4.0f, 5.0f, 6.0f, 7.0f, 8.0f, 8.0f, 8.0f, 8.0f,
...
TEST(ResizeOpTest, NhwcResizeOpLinearUpSampleTest_4DBilinear_asymmetric_uint8) {
  ...
  auto run_test = [](bool scales_in_initializer) {
    ...
    std::vector<uint8_t> Y = {
        1, 1, 2, 2, 3, 3, 3, 3, 2, 3, 4, 4, 5, 5, 5, 5, 4, 5, 6, 7, 8, 8, 8, 8, 4, 5, 6, 7, 8, 8, 8, 8,
    ...
    test.AddOutput<uint8_t>("Y", {N, static_cast<int64_t>(H * scales[1]), static_cast<int64_t>(W * scales[2]), C}, Y, false, .0f, 1.0f);
    // CUDA: result mismatch due to not implementing NHWC support
    // ROCm: results mismatch
    test.Run(OpTester::ExpectResult::kExpectSuccess, "", {kCudaExecutionProvider, kRocmExecutionProvider, kQnnExecutionProvider});
  };
...
TEST(ResizeOpTest, NhwcResizeOpLinearUpSampleTest_4DBilinear_asymmetric_int8) {
  ...
  auto run_test = [](bool scales_in_initializer) {
    ...
    std::vector<int8_t> Y = {
        1, 0, -1, -2, -3, -3, -3, -3, -1, 0, 0, 1, 2, 2, 2, 2, -4, -1, 2, 5, 8, 8, 8, 8, -4, -1, 2, 5, 8, 8, 8, 8,
    ...
    test.AddOutput<int8_t>("Y", {N, static_cast<int64_t>(H * scales[1]), static_cast<int64_t>(W * scales[2]), C}, Y, false, .0f, 1.0f);
    // TensorRT: results mismatch
    test.Run(OpTester::ExpectResult::kExpectSuccess, "", {kTensorrtExecutionProvider, kQnnExecutionProvider});
  };
...
TEST(ResizeOpTest, ResizeOpLinearUpSampleTest_2DBilinear_align_corners) {
  ...
  std::vector<float> Y = {
      1.0f, 1.2857143f, 1.571428f, 1.857142f, 2.142857f, 2.4285715f, 2.714285f, 3.0f, 2.0f, 2.3809524f, 2.761904f, 3.142857f, 3.523809f, 3.9047618f, 4.285714f, 4.66666f, 3.0f, 3.4761906f, 3.952381f, 4.428571f, 4.904762f, 5.3809524f, 5.857143f, 6.33333f, 4.0f, 4.5714290f, 5.142857f, 5.714286f, 6.285714f, 6.8571430f, 7.428571f, 8.0f};
...
TEST(ResizeOpTest, ResizeOpLinearUpSampleTest_5DTrilinear_pytorch_half_pixel) {
  ...
  std::vector<float> Y = {1.0f, 2.0f, 1.0f, 2.0f, 1.0f, 2.0f, 1.0f, 2.0f, 1.0f, 2.0f, 1.0f, 2.0f, 1.0f, 2.0f, 1.0f, 2.0f, 1.0f, 2.0f, 1.0f, 2.0f, 1.0f, 2.0f, 1.0f, 2.0f, 1.0f, 2.0f, 1.0f, 2.0f, 1.0f, 2.0f, 1.0f, 2.0f};
...
TEST(ResizeOpTest, ResizeOpLinearScalesNoOpTest) {
  ...
  auto run_test = [](bool scales_in_initializer) {
    ...
    std::vector<float> Y = {1.0f, 3.0f, 4.0f, 8.0f,
...
TEST(ResizeOpTest, ResizeOpNearestDownSampleTest_tf_half_pixel) {
  ...
  std::vector<float> Y = {6.0f, 8.0f, 10.0f, 12.0f, 14.0f, 16.0f};
...
TEST(ResizeOpTest, ResizeOpNearestDownSampleTest_tf_crop_and_resize_with_extrapolation) {
  ...
  std::vector<float> Y = {7.0f, 10.0f, 10.0f, 11.0f, 10.f, 10.0f, 10.0f, 10.0f, 10.0f};
...
TEST(ResizeOpTest, ResizeOpNearestUpSampleTest) {
  ...
  std::vector<float> Y = {1.0f, 1.0f, 1.0f, 2.0f, 2.0f, 2.0f, 1.0f, 1.0f, 1.0f, 2.0f, 2.0f, 2.0f, 3.0f, 3.0f, 3.0f, 4.0f, 4.0f, 4.0f, 3.0f, 3.0f, 3.0f, 4.0f, 4.0f, 4.0f};
...
TEST(ResizeOpTest, ResizeOpNearestUpSampleTest_WithSizes_CeilMode) {
  ...
  std::vector<float> Y = {1.0f, 1.0f, 2.0f, 2.0f, 2.0f, 2.0f, 2.0f, 2.0f, 1.0f, 1.0f, 2.0f, 2.0f, 2.0f, 2.0f, 2.0f, 2.0f, 3.0f, 3.0f, 4.0f, 4.0f, 4.0f, 4.0f, 4.0f, 4.0f, 3.0f, 3.0f, 4.0f, 4.0f, 4.0f, 4.0f, 4.0f, 4.0f, 3.0f, 3.0f, 4.0f, 4.0f, 4.0f, 4.0f, 4.0f, 4.0f, 3.0f, 3.0f, 4.0f, 4.0f, 4.0f, 4.0f, 4.0f, 4.0f, 3.0f, 3.0f, 4.0f, 4.0f, 4.0f, 4.0f, 4.0f, 4.0f};
...
TEST(ResizeOpTest, ResizeOpNearestUpSample_Floor_Align_Corners) {
  ...
  std::vector<float> Y = {1.0f, 1.0f, 1.0f, 2.0f, 2.0f, 3.0f, 3.0f, 4.0f, 1.0f, 1.0f, 1.0f, 2.0f, 2.0f, 3.0f, 3.0f, 4.0f, 1.0f, 1.0f, 1.0f, 2.0f, 2.0f, 3.0f, 3.0f, 4.0f, 5.0f, 5.0f, 5.0f, 6.0f, 6.0f, 7.0f, 7.0f, 8.0f, 5.0f, 5.0f, 5.0f, 6.0f, 6.0f, 7.0f, 7.0f, 8.0f, 9.0f, 9.0f, 9.0f, 10.0f, 10.0f, 11.0f, 11.0f, 12.0f, 9.0f, 9.0f, 9.0f, 10.0f, 10.0f, 11.0f, 11.0f, 12.0f, 13.0f, 13.0f, 13.0f, 14.0f, 14.0f, 15.0f, 15.0f, 16.0f};
...
TEST(ResizeOpTest, ResizeOpNearestUpSample_Nearest2xOptimization_Scales) {
  auto run_test = [](bool scales_in_initializer) {
    ...
    std::vector<float> Y = {1.0f, 1.0f, 2.0f, 2.0f, 1.0f, 1.0f, 2.0f, 2.0f, 3.0f, 3.0f, 4.0f, 4.0f, 3.0f, 3.0f, 4.0f, 4.0f};
...
TEST(ResizeOpTest, ResizeOpCubicDownSampleTest) {
  ...
  std::vector<float> Y = {1.47119f, 2.78125f, 4.08252f, 6.71143f, 8.02148f, 9.32275f, 11.9165f, 13.2266f, 14.5278f};
...
TEST(ResizeOpTest, ResizeOpCubicDownSampleTest_exclude_outside) {
  ...
  std::vector<float> Y = {1.36813f, 2.6695f, 4.01334f, 6.57363f, 7.875f, 9.21884f, 11.949f, 13.2503f, 14.5942f};
...
TEST(ResizeOpTest, ResizeOpCubicDownSampleTest_coeff) {
  ...
  std::vector<float> Y = {1.38574f, 2.68359f, 4.00684f, 6.57715f, 7.875f, 9.19824f, 11.8701f, 13.168f, 14.4912f};
...
TEST(ResizeOpTest, ResizeOpCubicDownSampleTest_with_roi) {
  ...
  std::vector<float> Y = {7.744f, 8.13475f, 8.488f, 8.752f, 9.14275f, 9.496f, 9.76f, 10.1507f, 10.504f};
...
TEST(ResizeOpTest, ResizeOpCubicDownSampleTest_asymmetric) {
  ...
  std::vector<float> Y = {1.0f, 2.29688f, 3.59375f, 6.1875f, 7.48438f, 8.78125f, 11.375f, 12.6719f, 13.9688f};
...
TEST(ResizeOpTest, ResizeOpCubicUpSampleTest) {
  ...
  std::vector<float> Y = {1.0f, 1.40625f, 2.0f, 2.5f, 3.0f, 3.59375f, 4.0f, 4.09375f, 2.625f, 3.03125f, 3.625f, 4.125f, 4.625f, 5.21875f, 5.625f, 5.71875f, 5.0f, 5.40625f, 6.0f, 6.5f, 7.0f, 7.59375f, 8.0f, 8.09375f, 7.0f, 7.40625f, 8.0f, 8.5f, 9.0f, 9.59375f, 10.0f, 10.0938f, 9.0f, 9.40625f, 10.0f, 10.5f, 11.0f, 11.5938f, 12.0f, 12.0938f, 11.375f, 11.7813f, 12.375f, 12.875f, 13.375f, 13.9688f, 14.375f, 14.4688f, 13.0f, 13.4063f, 14.0f, 14.5f, 15.0f, 15.5938f, 16.0f, 16.0938f, 13.375f, 13.7813f, 14.375f, 14.875f, 15.375f, 15.9688f, 16.375f, 16.4688f};
...
TEST(ResizeOpTest, ResizeOpCubicUpSampleTest_tf_half_pixel_for_nn) {
  ...
  std::vector<float> Y = {1.95703f, 2.43359f, 3.0625f, 3.46875f, 4.09766f, 4.57422f, 4.87109f, 4.80078f, 3.86328f, 4.33984f, 4.96875f, 5.375f, 6.00391f, 6.48047f, 6.77734f, 6.70703f, 6.37891f, 6.85547f, 7.48438f, 7.89063f, 8.51953f, 8.99609f, 9.29297f, 9.22266f, 8.00391f, 8.48047f, 9.10938f, 9.51563f, 10.1445f, 10.6211f, 10.918f, 10.8477f, 10.5195f, 10.9961f, 11.625f, 12.0313f, 12.6602f, 13.1367f, 13.4336f, 13.3633f, 12.4258f, 12.9023f, 13.5313f, 13.9375f, 14.5664f, 15.043f, 15.3398f, 15.2695f, 13.6133f, 14.0898f, 14.7188f, 15.125f, 15.7539f, 16.2305f, 16.5273f, 16.457f, 13.332f, 13.8086f, 14.4375f, 14.8438f, 15.4727f, 15.9492f, 16.2461f, 16.1758f};
...
TEST(ResizeOpTest, ResizeOp_MissingRoiAndMissingScalesOptionalInputs) {
  ...
  std::vector<float> X = {
      1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 6.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 11.0f, 1.0f, 1.0f, 1.0f, 1.0f};
...
void ResizeOpTypeCheck_Ver_10() {
  ...
  std::vector<T> Y = {1, 1, 1, 2, 2, 2, 1, 1, 1, 2, 2, 2, 3, 3, 3, 4, 4, 4, 3, 3, 3, 4, 4, 4};
...
void TestAntialiasing(std::map<std::string, std::string> attributes,
                      ...
                      std::vector<T1> output_shape_or_scale,
...
TEST(ResizeOpTest, Antialias_Bilinear_No_ExcludeOutside) {
  ...
  std::vector<float> Y = {2.3636363f, 3.590909f, 4.818182f, 7.2727275f, 8.5f, 9.727273f, 12.181818f, 13.409091f, 14.636364f};
...
TEST(ResizeOpTest, Antialias_Bilinear_ExcludeOutside) {
  std::vector<float> X(16);
  std::iota(X.begin(), X.end(), 1.f);
  std::vector<float> Y = {2.5f, 3.7f, 4.9f, 7.3f, 8.5f, 9.7f, 12.1f, 13.3f, 14.5f};
...
TEST(ResizeOpTest, Antialias_Bilinear_dtype) {
  {
    ...
    std::vector<uint8_t> Y = {1, 3, 4, 6, 8, 9, 11, 13, 14};
    TestAntialiasing({{"mode", "linear"}, {"exclude_outside", "1"}}, {1, 1, 4, 4}, X, {1, 1, 3, 3}, Y);
  }
  {
    std::vector<int8_t> X(16);
    std::iota(X.begin(), X.end(), int8_t(0));
    std::vector<int8_t> Y = {1, 3, 4, 6, 8, 9, 11, 13, 14};
    TestAntialiasing({{"mode", "linear"}, {"exclude_outside", "1"}}, {1, 1, 4, 4}, X, {1, 1, 3, 3}, Y);
  }
  {
    std::vector<int32_t> X(16);
    std::iota(X.begin(), X.end(), 0);
    std::vector<int32_t> Y = {1, 3, 4, 6, 8, 9, 11, 13, 14};
    TestAntialiasing({{"mode", "linear"}, {"exclude_outside", "1"}}, {1, 1, 4, 4}, X, {1, 1, 3, 3}, Y);
  }
}
...
TEST(ResizeOpTest, Antialias_Trilinear_No_ExcludeOutside) {
  ...
  std::vector<float> Y = {5.7272725f, 6.9545455f, 8.181818f, 10.636364f, 11.863636f, 13.090909f, 15.545455f, 16.772728f, 18.f, 25.363636f, 26.59091f, 27.818182f, 30.272728f, 31.5f, 32.727272f, 35.18182f, 36.409092f, 37.636364f, 45.f, 46.227272f, 47.454544f, 49.909092f, 51.136364f, 52.363636f, 54.81818f, 56.045456f, 57.272728f};
...
TEST(ResizeOpTest, Antialias_Trilinear_ExcludeOutside) {
  std::vector<float> X(16 * 4);
  std::iota(X.begin(), X.end(), 0.f);
  std::vector<float> Y = {6.3f, 7.5f, 8.7f, 11.1f, 12.3f, 13.5f, 15.9f, 17.1f, 18.3f, 25.5f, 26.7f, 27.9f, 30.3f, 31.5f, 32.7f, 35.1f, 36.3f, 37.5f, 44.7f, 45.9f, 47.1f, 49.5f, 50.7f, 51.9f, 54.3f, 55.5f, 56.7f};
...
TEST(ResizeOpTest, Antialias_Bicubic_No_ExcludeOutside) {
  ...
  std::vector<float> Y = {2.175381f, 3.655320f, 5.204702f, 6.684640f, 10.245370f, 11.725308f, 13.274692f, 14.754630f, 18.315359f, 19.795298f, 21.344681f, 22.824619f, 26.175381f, 27.655319f, 29.204702f, 30.684641f, 34.245369f, 35.725307f, 37.274693f, 38.754631f, 42.315361f, 43.795300f, 45.344681f, 46.824619f};
...
TEST(ResizeOpTest, Antialias_Linear_AlignCorners) {
  ...
  std::vector<float> Y = {
      3.9166667f, 6.4166665f, 13.916667f, 16.416666f, 25.25f, 27.75f, 35.25f, 37.75f, 46.583332f, 49.083332f, 56.583332f, 59.083332f, 67.916664f, 70.416664f, 77.916664f, 80.416664f, 89.25f, 91.75f, 99.25f, 101.75f, 110.583336f, 113.083336f, 120.583336f, 123.083336f, 131.91667f, 134.41667f, 141.91667f, 144.41667f, 153.25f, 155.75f, 163.25f, 165.75f, 174.58333f, 177.08333f, 184.58333f, 187.08333f, 195.91667f, 198.41667f, 205.91667f, 208.41667f, 217.25f, 219.75f, 227.25f, 229.75f, 238.58333f, 241.08333f, 248.58333f, 251.08333f};
  TestAntialiasing(
...
TEST(ResizeOpTest, Antialias_Bicubic_ExcludeOutside) {
  std::vector<float> X(48);
  std::iota(X.begin(), X.end(), 1.0f);
  std::vector<float> Y = {2.222252f, 3.670954f, 5.259818f, 6.708520f, 10.256866f, 11.705568f, 13.294432f, 14.743134f, 18.291479f, 19.740183f, 21.329046f, 22.777748f, 26.222252f, 27.670954f, 29.259817f, 30.708521f, 34.256866f, 35.705566f, 37.294434f, 38.743134f, 42.291481f, 43.740181f, 45.329044f, 46.777748f};
...
TEST(ResizeOpTest, Antialias_Axes_and_Scale) {
  ...
  std::iota(X.begin(), X.end(), 0.f);
  std::vector<float> Y = {6.3f, 7.5f, 8.7f, 11.1f, 12.3f, 13.5f, 15.9f, 17.1f, 18.3f, 25.5f, 26.7f, 27.9f, 30.3f, 31.5f, 32.7f, 35.1f, 36.3f, 37.5f, 44.7f, 45.9f, 47.1f, 49.5f, 50.7f, 51.9f, 54.3f, 55.5f, 56.7f};
  TestAntialiasing({{"mode", "linear"}, {"exclude_outside", "1"}, {"axes", "{2,3,4}"}, {"output_shape", "{1,1,3,3,3}"}}, {1, 1, 4, 4, 4}, X, std::vector<float>{3 / 4.0f, 3 / 4.0f, 3 / 4.0f}, Y);
}
...
TEST(ResizeOpTest, Antialias_Axes_and_Size) {
  ...
  std::iota(X.begin(), X.end(), 0.f);
  std::vector<float> Y = {6.3f, 7.5f, 8.7f, 11.1f, 12.3f, 13.5f, 15.9f, 17.1f, 18.3f, 25.5f, 26.7f, 27.9f, 30.3f, 31.5f, 32.7f, 35.1f, 36.3f, 37.5f, 44.7f, 45.9f, 47.1f, 49.5f, 50.7f, 51.9f, 54.3f, 55.5f, 56.7f};
  TestAntialiasing({{"mode", "linear"}, {"exclude_outside", "1"}, {"axes", "{2,3,4}"}, {"output_shape", "{1,1,3,3,3}"}}, {1, 1, 4, 4, 4}, X, {3, 3, 3}, Y);
}
...
TEST(ResizeOpTest, Antialias_Use_Extrapolation) {
  std::vector<float> X(16 * 4);
  std::iota(X.begin(), X.end(), 0.f);
  std::vector<float> Y = {4.5555553f, 5.4385967f, 6.1666665f, 9.888889f, 10.77193f, 11.5f, 15.222222f, 16.105263f, 16.833334f, 16.20468f, 17.08772f, 17.81579f, 21.538012f, 22.421053f, 23.149124f, 26.871346f, 27.754387f, 28.482456f, 30.333334f, 31.216375f, 31.944447f, 35.666668f, 36.54971f, 37.27778f, 41., 41.88304f, 42.61111f};
  TestAntialiasing(
