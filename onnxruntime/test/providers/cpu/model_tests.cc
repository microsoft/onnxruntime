...
#ifdef USE_TENSORRT
  // tensorrt: only enable opset 10 to 18 of onnx tests
  provider_names[provider_name_tensorrt] = {opset10, opset11, opset12, opset13, opset14, opset15, opset16, opset17, opset18};
#endif
#ifdef USE_MIGRAPHX
