...
TEST_P(ModelTest, Run) {
  ...
  std::set<BrokenTest> broken_tests = {
      ...
      {"bernoulli", "Expected equality of these values", {}},
      {"bernoulli_double", "Expected equality of these values", {}},
      {"bernoulli_double_expanded", "Expected equality of these values", {}},
      {"bernoulli_expanded", "Expected equality of these values", {}},
      {"bernoulli_seed", "Expected equality of these values", {}},
      {"bernoulli_seed_expanded", "Expected equality of these values", {}},
      ...
      {"gru_batchwise", "Unexpected input data type"},
      {"lstm_batchwise", "Unexpected input data type"},
      {"optional_get_element", "Unexpected input data type"},
      {"optional_get_element_sequence", "Unexpected input data type"},
      {"optional_has_element", "Unexpected input data type"},
      {"optional_has_element_empty", "Unexpected input data type"},
      {"shape_end_1", "Unexpected input data type"},
      {"shape_end_negative_1", "Unexpected input data type"},
      {"shape_start_1", "Unexpected input data type"},
      {"shape_start_1_end_2", "Unexpected input data type"},
      {"shape_start_1_end_negative_1", "Unexpected input data type"},
      {"shape_start_negative_1", "Unexpected input data type"},
      {"simple_rnn_batchwise", "Unexpected input data type"},
