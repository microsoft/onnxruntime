...
static void RunUpsampleTestOnCPU(const std::string& op_type,
  ...
  if (opset <= 7) {
    const size_t input_rank = input_def.GetShape().size();
    const std::vector<float>& scales = scales_def.GetRawData();

    if (opset == 1) {
      attrs.push_back(utils::MakeAttribute("width_scale", scales.at(input_rank - 1)));
      attrs.push_back(utils::MakeAttribute("height_scale", scales.at(input_rank - 2)));
    } else { // Opset-7
...
// Test Upsample with initializer scales input.
TEST_F(QnnCPUBackendTests, Upsample_IniScales) {
  RunUpsampleTestOnCPU("Upsample",
                       TestInputDef<float>({1, 3, 4, 4}, false, -10.0f, 10.0f),
...
TEST_F(QnnCPUBackendTests, Upsample_4D_linear) {
  RunUpsampleTestOnCPU("Upsample",
                       TestInputDef<float>({1, 3, 4, 4}, false, -10.0f, 10.0f),
                       TestInputDef<float>({4}, true, {1.0f, 1.0f, 1.5f, 1.5f}),
...
// Test Upsample with opset-9
TEST_F(QnnCPUBackendTests, Upsample_4D_opset_9) {
  RunUpsampleTestOnCPU("Upsample",
                       TestInputDef<float>({1, 3, 4, 4}, false, -10.0f, 10.0f),
                       TestInputDef<float>({4}, true, {1.0f, 1.0f, 1.5f, 1.5f}),
                       {utils::MakeAttribute("mode", "nearest")}, // Attributes
...
// Test Upsample with opset-7
TEST_F(QnnCPUBackendTests, Upsample_4D_opset_7) {
  RunUpsampleTestOnCPU("Upsample",
                       TestInputDef<float>({1, 3, 4, 4}, false, -10.0f, 10.0f),
                       TestInputDef<float>({4}, true, {1.0f, 1.0f, 1.5f, 1.5f}),
                       {utils::MakeAttribute("mode", "nearest")}, // Attributes
...
// Test Upsample with opset-1
TEST_F(QnnCPUBackendTests, Upsample_4D_opset_1) {
  RunUpsampleTestOnCPU("Upsample",
                       TestInputDef<float>({1, 3, 4, 4}, false, -10.0f, 10.0f),
                       TestInputDef<float>({4}, true, {1.0f, 1.0f, 1.5f, 1.5f}),
                       {utils::MakeAttribute("mode", "nearest")}, // Attributes
...
// Test QDQ Upsample 4D with initializer scales input.
TEST_F(QnnHTPBackendTests, Upsample_4D) {
  RunQDQUpsampleTestOnHTP<uint8_t>("Upsample",
                                   TestInputDef<float>({1, 3, 4, 4}, false, -10.0f, 10.0f),
                                   TestInputDef<float>({4}, true, {1.0f, 1.0f, 1.5f, 1.5f}),
                                   {utils::MakeAttribute("mode", "nearest")}, // Attributes
...
// Test QDQ Upsample with mode `linear`
TEST_F(QnnHTPBackendTests, Upsample_4D_linear) {
  RunQDQUpsampleTestOnHTP<uint8_t>("Upsample",
                                   TestInputDef<float>({1, 3, 4, 4}, false, -10.0f, 10.0f),
                                   TestInputDef<float>({4}, true, {1.0f, 1.0f, 1.5f, 1.5f}),
                                   {utils::MakeAttribute("mode", "linear")}, // Attributes
...
// Test QDQ Upsample with opset-9
TEST_F(QnnHTPBackendTests, Upsample_4D_opset_9) {
  RunQDQUpsampleTestOnHTP<uint8_t>("Upsample",
                                   TestInputDef<float>({1, 3, 4, 4}, false, -10.0f, 10.0f),
                                   TestInputDef<float>({4}, true, {1.0f, 1.0f, 1.5f, 1.5f}),
                                   {utils::MakeAttribute("mode", "nearest")}, // Attributes
...
// Test QDQ Upsample with opset-7
TEST_F(QnnHTPBackendTests, Upsample_4D_opset_7) {
  RunQDQUpsampleTestOnHTP<uint8_t>("Upsample",
                                   TestInputDef<float>({1, 3, 4, 4}, false, -10.0f, 10.0f),
                                   TestInputDef<float>({4}, true, {1.0f, 1.0f, 1.5f, 1.5f}),
                                   {utils::MakeAttribute("mode", "nearest")}, // Attributes
...
// Test QDQ Upsample with opset-1
TEST_F(QnnHTPBackendTests, Upsample_4D_opset_1) {
  RunQDQUpsampleTestOnHTP<uint8_t>("Upsample",
                                   TestInputDef<float>({1, 3, 4, 4}, false, -10.0f, 10.0f),
                                   TestInputDef<float>({4}, true, {1.0f, 1.0f, 1.5f, 1.5f}),
                                   {utils::MakeAttribute("mode", "nearest")}, // Attributes
