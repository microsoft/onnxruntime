...
// Test Expand with initializer shape input.
TEST_F(QnnABIGPUBackendTests, Expand_IniShape) {
  RunReshapeExpandTest("Expand", TestInputDef<float>({1}, false, {1.0f}),
                       TestInputDef<int64_t>({2}, true, {2, 3}),
                       {},  // Attributes
                       ExpectedEPNodeAssignment::All,
...
TEST_F(QnnABIGPUBackendTests, Expand_IniShape_Float16) {
...
// Test Expand with 6D output.
TEST_F(QnnABIGPUBackendTests, Expand_6D) {
  RunReshapeExpandTest("Expand", TestInputDef<float>({3}, false, {1.0f, 2.0f, 3.0f}),
                       TestInputDef<int64_t>({6}, true, {1, 2, 3, 4, 5, 3}),
                       {},  // Attributes
                       ExpectedEPNodeAssignment::All,
...
TEST_F(QnnABIGPUBackendTests, Expand_6D_Float16) {
...
TEST_F(QnnABIGPUBackendTests, Expand_4D_Float16) {
...
TEST_F(QnnABIHTPBackendTests, Reshape_AllowZeroAttr_WithZeros_Unsupported) {
...
TEST_F(QnnABIHTPBackendTests, Reshape_AllowZeroAttr_NoZeros_Supported) {
  RunQDQReshapeExpandTestOnHTP<uint8_t>("Reshape",
