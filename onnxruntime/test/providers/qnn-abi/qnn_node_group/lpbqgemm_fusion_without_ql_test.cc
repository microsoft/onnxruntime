...
TEST_F(QnnABIHTPBackendTests, DISABLED_LPBQGemmFusionWithoutQL) {
#else
TEST_F(QnnABIHTPBackendTests, LPBQGemmFusionWithoutQL) {
#endif
  ProviderOptions provider_options = GetProviderOptions();
  RunQnnModelTestABI(BuildLPBQGemmWithoutQLTestCase(),
                     provider_options,
                     /*opset_version=*/21,
