...
std::shared_ptr<IExecutionProviderFactory> CreateExecutionProviderFactory_CUDA(int device_id, bool enable_compiler);
...
#ifdef USE_CUDA
  return CreateExecutionProviderFactory_CUDA(0, false)->CreateProvider();
#else
  return nullptr;
#endif
}
