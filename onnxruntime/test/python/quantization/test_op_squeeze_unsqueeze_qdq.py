...
class TestOpSqueezeUnsqueeze(unittest.TestCase):
    ...
    def run_quantize_squeezes_of_opset(
        ...
        model_uint8_qdq_dyn_path = "squeezes_opset{}_{}{}_qdq_dyn.onnx".format(opset, activation_type_str, weight_type_str)
        ...
        qdqnode_counts = {"Conv": 3, "QuantizeLinear": 7, "DequantizeLinear": 10}
