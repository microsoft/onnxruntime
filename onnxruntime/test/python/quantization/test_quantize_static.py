...
from op_test_utils import check_model_correctness, generate_random_initializer, input_feeds_negone_zero_one
...
class TestStaticQuantization(unittest.TestCase):
    ...
    def test_save_as_external(self):
        data_reader = input_feeds_negone_zero_one(10, {"input": [1, self._channel_size, 1, 3]})
