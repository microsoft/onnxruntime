...
class Conv2D(Base):
    ...
    def export() -> None:
        ...
        expect(onnx_model, inputs=[x_in], outputs=[output_tensor.numpy()], name="test_SimpleConv2DValidPadding")
        ...
        onnx_model = onnx.shape_inference.infer_shapes(onnx_model)
        expect(
            onnx_model, inputs=[x_in], outputs=[output_tensor.numpy()], name="test_SimpleConv2DValidPaddingWithSigmoid"
        )
        ...
        onnx_model = onnx.shape_inference.infer_shapes(onnx_model)
        expect(onnx_model, inputs=[x_in], outputs=[output_tensor.numpy()], name="test_SimpleConv2DSamePadding")
        ...
        onnx_model = onnx.shape_inference.infer_shapes(onnx_model)
        expect(
            onnx_model, inputs=[x_in], outputs=[output_tensor.numpy()], name="test_SimpleConv2DSamePaddingUnknownBatch"
        )
        ...
        onnx_model = onnx.shape_inference.infer_shapes(onnx_model)
        expect(onnx_model, inputs=[x_in], outputs=[output_tensor.numpy()], name="test_SimpleConv2DSamePaddingUnknownHW")
