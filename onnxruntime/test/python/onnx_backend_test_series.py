    ...
    if testname:
        ...
        if c2.supports_device('NGRAPH'):
            current_failing_tests += [
                ...
                '^test_pow_types_float32_int32_cpu', '^test_pow_types_float32_int64_cpu', '^test_pow_types_float_cpu',
                '^test_pow_types_int32_float32_cpu', '^test_pow_types_int_cpu', '^test_pow_types_int64_float32_cpu'
            ]
