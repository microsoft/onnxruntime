    ...
    if testname:
        ...
        if c2.supports_device('NGRAPH'):
            current_failing_tests += [
                ...
                '^test_argmax_keepdims_example_select_last_index_*', '^test_argmax_no_keepdims_example_select_last_index_*',
                '^test_argmin_no_keepdims_example_select_last_index_*','^test_argmin_keepdims_example_select_last_index_*'
