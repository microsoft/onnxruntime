...
transformer_repo = '/bert_ort/liqun/transformers'
nvidia_deep_learning_examples_repo = '/bert_ort/liqun/DeepLearningExamples'
...
class BertModelTest(CommonTestCases.CommonModelTester):
    ...
    class BertModelTester(object):
        ...
        def create_and_check_bert_for_pretraining(self, config, input_ids, token_type_ids, input_mask, sequence_labels, token_labels, choice_labels):
            ...
            option_fp16 = [False] # [True, False]
            option_allreduce_post_accumulation = [False]
            option_use_internal_get_lr_this_step = [False]
            option_use_internal_loss_scaler = [False]
            option_split_batch = [BatchArgsOption.Dict] #, BatchArgsOption.ListAndDict]
