...
TEST_F(GraphTransformationTests, PropagateCastOpsTests) {
  ...
  const std::vector<PropagateCastOpsTestSpecs> test_cases = {
      ...
      {MODEL_FOLDER "propagate_cast/matmul_two_outputs_transpose_before_cast_transpose_second_matmul_add_products.onnx", 2, allow_matmul_transpose},
      {MODEL_FOLDER "propagate_cast/matmul_two_outputs_transpose_after_cast_transpose_second_matmul_add_products.onnx", 2, allow_matmul_transpose},
