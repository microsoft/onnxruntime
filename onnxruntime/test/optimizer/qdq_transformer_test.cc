...
// Tests that the WeightBiasQuantization optimizer still process nodes that contain a type-preserving no
// branch path to QuantizeLinear, E.g., Q -> DQ -> Conv (w/ float weight initializer) -> ReLU -> Q -> DQ
