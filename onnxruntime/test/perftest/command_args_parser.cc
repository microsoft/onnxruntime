...
/*static*/ void CommandLineParser::ShowUsage() {
  printf(
      ...
      "\t\tProvide 'duration' to run the test for a fix duration, and 'times' to repeated for a certain times. default: [times]\n"
      ...
      "\t-r [repeated_times]: Specifies the repeated times if running in 'times' test mode.Default:15.\n"
