...
_VERSION = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='IR_VERSION', index=4, number=4,
      serialized_options=None,
      type=None),
  ],
...
_QUANTINFO = _descriptor.Descriptor(
  name='QuantInfo',
  full_name='onnx.QuantInfo',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='tensor_name', full_name='onnx.QuantInfo.tensor_name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='quant_parameter_tensor_names', full_name='onnx.QuantInfo.quant_parameter_tensor_names', index=1,
...
_QUANTINFO.fields_by_name['quant_parameter_tensor_names'].message_type = _STRINGSTRINGENTRYPROTO
...
_GRAPHPROTO.fields_by_name['quantization_annotation'].message_type = _QUANTINFO
...
DESCRIPTOR.message_types_by_name['QuantInfo'] = _QUANTINFO
...
QuantInfo = _reflection.GeneratedProtocolMessageType('QuantInfo', (_message.Message,), dict(
  DESCRIPTOR = _QUANTINFO,
  __module__ = 'onnx_ml_pb2'
  # @@protoc_insertion_point(class_scope:onnx.QuantInfo)
  ))
_sym_db.RegisterMessage(QuantInfo)
