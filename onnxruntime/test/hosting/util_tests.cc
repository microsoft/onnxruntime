...
TEST(PositiveTests, JsonDeserializationHappyPath) {
  ...
  protobufutil::Status status = onnx::hosting::Util::GetRequestFromJson(input_json, request);
...
TEST(PositiveTests, JsonSerializationHappyPath) {
  ...
  onnx::hosting::PredictResponse response;
  ...
  protobufutil::Status status = onnx::hosting::Util::GenerateResponseInJson(response, json_string);
