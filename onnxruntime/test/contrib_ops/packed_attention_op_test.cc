...
TEST(PackedAttentionTest, PackedWithRelativePositionBias) {
  ...
  std::vector<float> relative_position_bias = {
      0.2f, -0.1f, 0.f, 0.f, 0.4f, 2.5f, 0.f, 0.f, 1.6f, -1.1f, 0.f, 0.f, 0.4f, -2.5f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f,
...
TEST(PackedAttentionTest, PackedBatchWithQKV) {
  ...
  std::vector<float> output_data = {
      ...
      3.1967618465423584f,
      0.51903456449508667f,
      0.63051539659500122f,
      2.9394614696502686f,
      0.65332180261611938f,
      1.000949501991272f,
      0.74175024032592773f,
      2.8231701850891113f};
