...
TEST(GatherNDOpTest, GatherND_simple_int64_int64) {
...
TEST(GatherNDOpTest, GatherND_simple_string_int64) {
  OpTester test("GatherND", 1, onnxruntime::kMSDomain);
...
TEST(GatherNDOpTest, GatherND_simple_int64_int32) {
  OpTester test("GatherND", 1, onnxruntime::kMSDomain);
  test.AddInput<int64_t>("data", {2,2}, {0LL,1LL,2LL,3LL});
...
TEST(GatherNDOpTest, GatherND_3tensor_int64) {
  OpTester test0("GatherND", 1, onnxruntime::kMSDomain);
  test0.AddInput<int16_t>("data", {2,2,2}, {0,1,2,3,4,5,6,7});
  test0.AddInput<int64_t>("indices", {1,1}, {1LL});
  test0.AddOutput<int16_t>("output", {1,2,2}, {4,5,6,7});
  test0.Run();
...
TEST(GatherNDOpTest, GatherND_batched_3tensor_int64) {
  OpTester test0("GatherND", 1, onnxruntime::kMSDomain);
  test0.AddInput<int64_t>("data", {2,2,2}, {0LL,1LL,2LL,3LL,4LL,5LL,6LL,7LL});
  test0.AddInput<int32_t>("indices", {2,1,1}, {1,0});
  test0.AddOutput<int64_t>("output", {2,1,2,2}, {4LL,5LL,6LL,7LL,0LL,1LL,2LL,3LL});
  test0.Run();
