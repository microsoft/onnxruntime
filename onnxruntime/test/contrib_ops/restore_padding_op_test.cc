...
static void RunRestorePaddingTests(
  ...
  RunRestorePadding(input_data, output_data, token_offset_data, batch_size, sequence_length, hidden_size, total_tokens, use_float16, disable_cpu, disable_cuda, disable_rocm);
...
TEST(RestorePaddingTest, RestorePaddingBatch3_TwoWithPadding) {
  ...
  std::vector<float> output_data = {
      0.8f, -0.5f, 0.1f, 0.2f, 0.3f, 0.4f, 0.5f, 0.6f, 0.0f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.0f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.0f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.15f, 0.25f, 1.7f, 1.8f, 1.9f, 2.0f, 2.1f, 2.2f, 0.35f, 0.45f, 2.3f, 2.4f, 2.5f, 2.6f, 2.7f, 2.8f, 0.0f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.0f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.135f, 0.235f, 4.1f, 4.2f, 4.3f, 4.4f, 4.5f, 4.6f, 0.335f, 0.435f, 4.7f, 4.8f, 4.9f, 5.0f, 5.1f, 5.2f, 0.535f, 0.635f, 5.3f, 5.4f, 5.5f, 5.6f, 5.7f, 5.8f, 0.735f, 0.835f, 5.9f, 6.0f, 6.1f, 6.2f, 6.3f, 6.4f};
