...
enum class PrepackSharingMode {
  // session.share_all_prepacked_cpu_initializers = "1": any CPU constant initializer that the kernel
  // pre-packs participates in the shared container, content-addressed by hash(packed_bytes).
  // No OrtApi::AddInitializer call is required. This is the path used by the DQ + MatMul -> MatMulNBits
  // fusion, whose weights are synthesized at session-creation time with auto-generated names.
  kShareAllCpuInitializers,
