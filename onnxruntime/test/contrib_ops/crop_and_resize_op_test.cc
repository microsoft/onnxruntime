...
TEST(CropAndResizeTest, CropAndResize_1122) {
  ...
  test1.AddInput  <int64_t> ("batch_indices",    {3},    {0, 0, 0});
  ...
  test2.AddInput  <int64_t> ("batch_indices",   {3},   {0, 0, 0});
  test2.AddAttribute("crop_height", (int64_t)2);
  test2.AddAttribute("crop_width", (int64_t)2);
  ...
  test3.AddInput  <int64_t> ("batch_indices",   {2},   {0, 0});
  test3.AddAttribute("crop_height", (int64_t)2);
  test3.AddAttribute("crop_width", (int64_t)2);
...
TEST(CropAndResizeTest, CropAndResize_2122) {
  ...
  test1.AddInput  <float> ("rois", {3, 4},   {0.0f, 0.0f, 1.0f, 1.0f, 0.0f, 0.0f, 0.5f, 0.5f, 0.0f, 0.0f, 0.5f, 1.0f});
  test1.AddInput  <int64_t> ("batch_indices",   {3},   {0, 1, 1});
  ...
  test2.AddInput  <float> ("rois",  {3, 4},   {0.0f, 0.0f, 1.0f, 1.0f, 0.0f, 0.0f, 0.5f, 0.5f, 0.0f, 0.0f, 0.5f, 1.0f});
  test2.AddInput  <int64_t> ("batch_indices",   {3},   {0, 1, 1});
  test2.AddAttribute("crop_height", (int64_t)2);
  test2.AddAttribute("crop_width", (int64_t)2);
...
TEST(CropAndResizeTest, CropAndResize_1133) {
	...
	test3.AddInput  <int64_t>("batch_indices", {3}, {0, 0, 0});
	test3.AddAttribute("crop_height", (int64_t)2);
	test3.AddAttribute("crop_width", (int64_t)2);
