...
TEST(SkipLayerNormTest, SkipLayerNormBatch1_Float16) {
  ...
  std::vector<float> output_data = {
      0.28433859348297119f, -0.17090578377246857f, -0.92897164821624756f, 4.6924152374267578f,
      0.46111652255058289f, -0.21333980560302734f, -0.29631003737449646f, 3.5148544311523438f};
...
TEST(SkipLayerNormTest, SkipLayerNormBatch1_NoBeta) {
  ...
  std::vector<float> output_data = {
      0.08433859348297119, -0.27090578377246857, -1.32897164821624756, 3.0924152374267578,
      0.26111652255058289, -0.31333980560302734, -0.69631003737449646, 1.9148544311523438};
