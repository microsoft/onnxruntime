...
TEST(SkipLayerNormTest, SkipLayerNormBatch1) {
  ...
  std::vector<float> skip_data = {
      0.1f, -0.2f, 0.3f, 1.0f, 0.5f, 0.1f, 0.4f, 1.6f};
  ...
  std::vector<float> output_data = {
      0.28433859348297119, -0.17090578377246857, -0.92897164821624756, 4.6924152374267578, 0.46111652255058289, -0.21333980560302734, -0.29631003737449646, 3.5148544311523438};
...
TEST(SkipLayerNormTest, SkipLayerNormBatch1_NoBeta) {
  ...
  std::vector<float> output_data = {
      0.08433859348297119f, -0.27090578377246857f, -1.32897164821624756f, 3.0924152374267578f, 0.26111652255058289f, -0.31333980560302734f, -0.69631003737449646f, 1.9148544311523438f};
...
TEST(SkipLayerNormTest, SkipLayerNormBatch2) {
  ...
  std::vector<float> skip_data = {
      0.1f, -0.2f, 0.3f, 1.0f, 0.5f, 0.1f, 0.4f, 1.6f, 1.8f, -0.3f, 0.0f, 1.f, -0.5f, 0.4f, 0.8f, -0.6f};
  ...
  std::vector<float> output_data = {
      0.28433859348297119, -0.17090578377246857, -0.92897164821624756, 4.6924152374267578, 0.46111652255058289, -0.21333980560302734, -0.29631003737449646, 3.5148544311523438, 0.55470430850982666, -0.15080101788043976, -2.3229825496673584, 3.255286693572998, 0.15631480515003204, 0.21066918969154358, 4.9432611465454102, -1.7957965135574341};
...
TEST(SkipLayerNormTest, SkipLayerNormBatch2_Bias) {
  ...
  std::vector<float> input_data = {
      0.7f, -0.4f, -0.2f, 1.2f, 0.4f, 0.3f, 0.1f, -0.4f, 0.7f, -0.4f, -0.2f, 1.2f, 0.4f, 0.3f, 0.1f, -0.4f};
...
TEST(SkipLayerNormTest, SkipSimplifiedLayerNormBatch1_Float16) {
  ...
  std::vector<float> output_data = {
      0.3491f, -0.1455f, 0.0000f, 3.2005f, 0.3487f, 0.0930f, 2.7899f, -3.0689f};
