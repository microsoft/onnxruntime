...
static void CalculateGlobalAvgPoolU8(
  ...
  for (int64_t b = 0; b < batch; ++b) {
    ...
    for (int64_t c = 0; c < channel; ++c) {
      ...
      r = std::max((int32_t)(std::numeric_limits<T8Bits>::min()), r);
...
void RunQLinearGlobalAveragePool(
  ...
  std::vector<int> tmp_x_data = random.Uniform<int32_t>(x_dims, std::numeric_limits<T8Bits>::min(), std::numeric_limits<T8Bits>::max());
...
TEST(QLinearGlobalAveragePool, Nhwc_1x1x32x32_S8) {
  RunQLinearGlobalAveragePool<int8_t>(true, 1, 1, 32, 32, 128, 1.0, 64, 2.0);
}

TEST(QLinearGlobalAveragePool, Nchw_1x32x32x1_S8) {
  RunQLinearGlobalAveragePool<int8_t>(false, 1, 1, 32, 32, 128, 1.0, 64, 2.0);
}

TEST(QLinearGlobalAveragePool, Nhwc_1x256x8x8_S8) {
  RunQLinearGlobalAveragePool<int8_t>(true, 1, 256, 8, 8, 128, 1.0, 64, 3.0);
}

TEST(QLinearGlobalAveragePool, Nchw_1x8x8x256_S8) {
  RunQLinearGlobalAveragePool<int8_t>(false, 1, 256, 8, 8, 128, 1.0, 64, 3.0);
}

TEST(QLinearGlobalAveragePool, Nhwc_1x255x7x7_S8) {
  RunQLinearGlobalAveragePool<int8_t>(true, 1, 255, 7, 7, 128, 7.0, 128, 21.0);
}

TEST(QLinearGlobalAveragePool, Nchw_1x7x7x255_S8) {
  RunQLinearGlobalAveragePool<int8_t>(false, 1, 255, 7, 7, 128, 7.0, 128, 21.0);
}

TEST(QLinearGlobalAveragePool, Nhwc_1x255x8x8_S8) {
  RunQLinearGlobalAveragePool<int8_t>(true, 1, 255, 8, 8, 128, 1.0, 128, 2.0);
}

TEST(QLinearGlobalAveragePool, Nchw_1x8x8x255_S8) {
  RunQLinearGlobalAveragePool<int8_t>(false, 1, 255, 8, 8, 128, 1.0, 128, 2.0);
}

TEST(QLinearGlobalAveragePool, Nhwc_1x256x7x7_S8) {
  RunQLinearGlobalAveragePool<int8_t>(true, 1, 256, 7, 7, 128, 7.0, 128, 21.0);
}

TEST(QLinearGlobalAveragePool, Nchw_1x7x7x256_S8) {
  RunQLinearGlobalAveragePool<int8_t>(false, 1, 256, 7, 7, 128, 7.0, 128, 21.0);
}

// tests for BatchSize > 1
TEST(QLinearGlobalAveragePool, Nhwc_3x256x8x8_S8) {
  RunQLinearGlobalAveragePool<int8_t>(true, 3, 256, 8, 8, 128, 1.0, 64, 3.0);
}

TEST(QLinearGlobalAveragePool, Nchw_3x8x8x256_S8) {
  RunQLinearGlobalAveragePool<int8_t>(false, 3, 256, 8, 8, 128, 1.0, 64, 3.0);
}

TEST(QLinearGlobalAveragePool, Nhwc_3x255x7x7_S8) {
  RunQLinearGlobalAveragePool<int8_t>(true, 3, 255, 7, 7, 128, 7.0, 128, 21.0);
}

TEST(QLinearGlobalAveragePool, Nchw_3x7x7x255_S8) {
  RunQLinearGlobalAveragePool<int8_t>(false, 3, 255, 7, 7, 128, 7.0, 128, 21.0);
}

TEST(QLinearGlobalAveragePool, Nhwc_3x255x8x8_S8) {
  RunQLinearGlobalAveragePool<int8_t>(true, 3, 255, 8, 8, 128, 1.0, 128, 2.0);
}

TEST(QLinearGlobalAveragePool, Nchw_3x8x8x255_S8) {
  RunQLinearGlobalAveragePool<int8_t>(false, 3, 255, 8, 8, 128, 1.0, 128, 2.0);
}

TEST(QLinearGlobalAveragePool, Nhwc_3x256x7x7_S8) {
  RunQLinearGlobalAveragePool<int8_t>(true, 3, 256, 7, 7, 128, 7.0, 128, 21.0);
}

TEST(QLinearGlobalAveragePool, Nchw_3x7x7x256_S8) {
  RunQLinearGlobalAveragePool<int8_t>(false, 3, 256, 7, 7, 128, 7.0, 128, 21.0);
}
#endif
