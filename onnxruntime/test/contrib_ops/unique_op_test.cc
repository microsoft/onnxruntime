...
TEST(TensorOpTest, Unique_Spec_Example) {
  OpTester test("Unique", 1, onnxruntime::kMSDomain);
  test.AddInput<float>("x", {6}, {2.0, 1.0, 1.0, 3.0, 4.0, 3.0});
...
TEST(TensorOpTest, Unique_Complicated_Example) {
  OpTester test("Unique", 1, onnxruntime::kMSDomain);
  test.AddInput<float>("x", {12}, {2.0, 1.0, 1.0, 3.0, 4.0, 3.0, 2.0, 1.0, 1.0, 3.0, 4.0, 3.0});
  test.AddOutput<float>("uniques", {4}, {2.0f, 1.0f, 3.0f, 4.0f});
...
TEST(TensorOpTest, Unique_Example_SingleElement) {
  OpTester test("Unique", 1, onnxruntime::kMSDomain);
  test.AddInput<float>("x", {1}, {2.0});
...
TEST(TensorOpTest, Unique_AllUniqueElements) {
  OpTester test("Unique", 1, onnxruntime::kMSDomain);
  test.AddInput<float>("x", {2}, {2.0, 3.0});
