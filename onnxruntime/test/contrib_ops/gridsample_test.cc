...
TEST(GridsampleContribOpTest, gridsample_default) {
  ...
  test.AddInput<float>("Grid", {1, 6, 6, 2}, {-1.0000f, -1.0000f, -0.6000f, -1.0000f, -0.2000f, -1.0000f, 0.2000f, -1.0000f, 0.6000f, -1.0000f, 1.0000f, -1.0000f, -1.0000f, -0.6000f, -0.6000f, -0.6000f, -0.2000f, -0.6000f, 0.2000f, -0.6000f, 0.6000f, -0.6000f, 1.0000f, -0.6000f, -1.0000f, -0.2000f, -0.6000f, -0.2000f, -0.2000f, -0.2000f, 0.2000f, -0.2000f, 0.6000f, -0.2000f, 1.0000f, -0.2000f, -1.0000f, 0.2000f, -0.6000f, 0.2000f, -0.2000f, 0.2000f, 0.2000f, 0.2000f, 0.6000f, 0.2000f, 1.0000f, 0.2000f, -1.0000f, 0.6000f, -0.6000f, 0.6000f, -0.2000f, 0.6000f, 0.2000f, 0.6000f, 0.6000f, 0.6000f, 1.0000f, 0.6000f, -1.0000f, 1.0000f, -0.6000f, 1.0000f, -0.2000f, 1.0000f, 0.2000f, 1.0000f, 0.6000f, 1.0000f, 1.0000f, 1.0000f});
  ...
  test.AddOutput<float>("Y", {1, 1, 6, 6}, {0.0000f, 0.1500f, 0.5500f, 0.9500f, 1.3500f, 0.7500f, 0.6000f, 1.5000f, 2.3000f, 3.1000f, 3.9000f, 2.1000f, 2.2000f, 4.7000f, 5.5000f, 6.3000f, 7.1000f, 3.7000f, 3.8000f, 7.9000f, 8.7000f, 9.5000f, 10.3000f, 5.3000f, 5.4000f, 11.1000f, 11.9000f, 12.7000f, 13.5000f, 6.9000f, 3.0000f, 6.1500f, 6.5500f, 6.9500f, 7.3500f, 3.7500f});
  test.Run();
}
...
TEST(GridsampleContribOpTest, gridsample_paddingmode_zeros) {
  ...
  test.AddInput<float>("Grid", {1, 2, 4, 2}, {-10.0000f, -10.0000f, -5.0000f, -5.0000f, -0.2000f, -0.2000f, 10.0000f, 10.0000f, 10.0000f, 10.0000f, -0.2000f, -0.2000f, 5.0000f, 5.0000f, 10.0000f, 10.0000f});
  test.AddAttribute("padding_mode", "zeros");
...
TEST(GridsampleContribOpTest, gridsample_aligncorners_true) {
  OpTester test("GridSample", 1, kMSDomain);
  test.AddInput<float>("X", {1, 1, 3, 2}, {0.0f, 1.0f, 2.0f, 3.0f, 4.0f, 5.0f});
  test.AddInput<float>("Grid", {1, 2, 4, 2}, {-1.0000f, -1.0000f, -0.5000f, -0.5000f, -0.2000f, -0.2000f, 0.0000f, 0.0000f, 0.0000f, 0.0000f, -0.2000f, -0.2000f, 0.5000f, 0.5000f, 1.0000f, 1.0000f});
