...
inline OpData EmbedLayerNormBatch1() {
  ...
  std::vector<float> word_embedding_data = {
      0.2f, 0.1f, 0.4f, -0.6f, 0.3f, 0.2f, 0.5f, 0.6f, 0.6f, 0.7f, 0.0f, -0.1f, 0.8f, 0.6f, 0.9f, 1.2f, 0.1f, 0.3f, 0.5f, 0.9f, 1.0f, -2.0f, 1.1f, 0.8f};

  std::vector<float> position_embedding_data = {
      0.1f, 0.1f, 0.4f, 0.6f, 0.6f, 0.0f, 0.8f, 0.6f, 0.3f, 0.9f, -2.0f, 0.8f};

  std::vector<float> segment_embedding_data = {
      0.3f, 0.4f, 0.9f, 0.1f, 0.7f, 0.3f, 0.5f, 0.2f};
  ...
  return OpData(batch_size, sequence_size, hidden_size, input_ids_data, segment_ids_data, mask_data, word_embedding_data, position_embedding_data, segment_embedding_data, gamma_data, beta_data, output_data, mask_index_data);
}
...
inline OpData EmbedLayerNormBatch2(bool has_mask = true) {
  ...
  return OpData(batch_size, sequence_size, hidden_size, input_ids_data, segment_ids_data, mask_data, word_embedding_data, position_embedding_data, segment_embedding_data, gamma_data, beta_data, output_data, mask_index_data, kEpsilon, has_mask);
}
...
inline OpData EmbedLayerNormBatch1_PositionIds(bool diff_order = false) {
  ...
  if (diff_order) {
    output_data = std::vector<float>{
        0.60000008344650269, -0.044120028614997864, 0.9184914231300354, -1.0603407621383667, 0.61326867341995239, -0.046796366572380066, 0.81048583984375, -1.1954958438873291};
  } else {
    output_data = std::vector<float>{
        0.39587587118148804, 0.03670068085193634, 0.7449488639831543, -1.4981462955474854, 0.61326867341995239, -0.046796366572380066, 0.81048583984375, -1.1954958438873291};
  }
...
inline OpData EmbedLayerNormBatch3_PositionIds_BroadCast() {
  ...
  std::vector<float> output_data;
  output_data = std::vector<float>{
      0.39587587118148804, 0.03670068085193634, 0.7449488639831543, -1.4981462955474854, 0.61326867341995239, -0.046796366572380066, 0.81048583984375, -1.1954958438873291, 0.39587587118148804, 0.03670068085193634, 0.7449488639831543, -1.4981462955474854, 0.61326867341995239, -0.046796366572380066, 0.81048583984375, -1.1954958438873291, 0.39587587118148804, 0.03670068085193634, 0.7449488639831543, -1.4981462955474854, 0.61326867341995239, -0.046796366572380066, 0.81048583984375, -1.1954958438873291};
...
inline OpData EmbedLayerNormBatch1_EmbeddingSum() {
  ...
  std::vector<float> embedding_sum_data = {
      0.40000000596046448, 0.30000001192092896, 0.89999997615814209, 1.2000000476837158, 1.4000000953674316, 0.60000002384185791, 1.7000000476837158, 1.8000000715255737};
