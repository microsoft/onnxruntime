...
TEST(RotaryEmbeddingONNXTest, RotaryEmbedding_ONNX_Interleaved_SmallData_LlamaMSFT) {
  int batch_size = 1;
...
TEST(RotaryEmbeddingONNXTest, RotaryEmbeddingONNX_NotInterleaved_SmallData_LlamaMSFT) {
  int batch_size = 1;
