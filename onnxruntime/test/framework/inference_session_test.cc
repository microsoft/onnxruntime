...
#if USE_TENSORRT
  // previous run with graph being optimized, one of If nodeâ€™s both subgraphs become empty, so TRT EP wonâ€™t assign this If node to TRT and later ORT assign it to CUDA.
