...
select from 'TF8', 'TF16', 'UINT8', 'FLOAT', 'ITENSOR'. \n)");
  ...
  if (enable_qnn) {
    ...
    // float 8, not implemented yet
    broken_tests.insert({"cast_FLOAT8E5M2FNUZ_to_FLOAT", "float 8 not implemented yet"});
    broken_tests.insert({"cast_FLOAT8E5M2FNUZ_to_FLOAT16", "float 8 not implemented yet"});
    broken_tests.insert({"cast_FLOAT8E5M2_to_FLOAT", "float 8 not implemented yet"});
    broken_tests.insert({"cast_FLOAT8E5M2_to_FLOAT16", "float 8 not implemented yet"});
    broken_tests.insert({"cast_FLOAT_to_FLOAT8E4M3FN", "float 8 not implemented yet"});
    broken_tests.insert({"cast_FLOAT_to_FLOAT8E4M3FNUZ", "float 8 not implemented yet"});
    broken_tests.insert({"cast_FLOAT_to_FLOAT8E5M2", "float 8 not implemented yet"});
    broken_tests.insert({"cast_FLOAT_to_FLOAT8E5M2FNUZ", "float 8 not implemented yet"});
    broken_tests.insert({"cast_no_saturate_FLOAT16_to_FLOAT8E4M3FN", "float 8 not implemented yet"});
    broken_tests.insert({"cast_no_saturate_FLOAT16_to_FLOAT8E4M3FNUZ", "float 8 not implemented yet"});
    broken_tests.insert({"cast_no_saturate_FLOAT16_to_FLOAT8E5M2", "float 8 not implemented yet"});
    broken_tests.insert({"cast_no_saturate_FLOAT16_to_FLOAT8E5M2FNUZ", "float 8 not implemented yet"});
    broken_tests.insert({"cast_no_saturate_FLOAT_to_FLOAT8E4M3FN", "float 8 not implemented yet"});
    broken_tests.insert({"cast_no_saturate_FLOAT_to_FLOAT8E4M3FNUZ", "float 8 not implemented yet"});
    broken_tests.insert({"cast_no_saturate_FLOAT_to_FLOAT8E5M2", "float 8 not implemented yet"});
    broken_tests.insert({"cast_no_saturate_FLOAT_to_FLOAT8E5M2FNUZ", "float 8 not implemented yet"});
    broken_tests.insert({"castlike_FLOAT8E4M3FNUZ_to_FLOAT", "float 8 not implemented yet"});
    broken_tests.insert({"castlike_FLOAT8E4M3FNUZ_to_FLOAT_expanded", "float 8 not implemented yet"});
    broken_tests.insert({"castlike_FLOAT8E4M3FN_to_FLOAT", "float 8 not implemented yet"});
    broken_tests.insert({"castlike_FLOAT8E4M3FN_to_FLOAT_expanded", "float 8 not implemented yet"});
    broken_tests.insert({"castlike_FLOAT8E5M2FNUZ_to_FLOAT", "float 8 not implemented yet"});
    broken_tests.insert({"castlike_FLOAT8E5M2FNUZ_to_FLOAT_expanded", "float 8 not implemented yet"});
    broken_tests.insert({"castlike_FLOAT8E5M2_to_FLOAT", "float 8 not implemented yet"});
    broken_tests.insert({"castlike_FLOAT8E5M2_to_FLOAT_expanded", "float 8 not implemented yet"});
    broken_tests.insert({"castlike_FLOAT_to_FLOAT8E4M3FN", "float 8 not implemented yet"});
    broken_tests.insert({"castlike_FLOAT_to_FLOAT8E4M3FNUZ", "float 8 not implemented yet"});
    broken_tests.insert({"castlike_FLOAT_to_FLOAT8E4M3FNUZ_expanded", "float 8 not implemented yet"});
    broken_tests.insert({"castlike_FLOAT_to_FLOAT8E4M3FN_expanded", "float 8 not implemented yet"});
    broken_tests.insert({"castlike_FLOAT_to_FLOAT8E5M2", "float 8 not implemented yet"});
    broken_tests.insert({"castlike_FLOAT_to_FLOAT8E5M2FNUZ", "float 8 not implemented yet"});
    broken_tests.insert({"castlike_FLOAT_to_FLOAT8E5M2FNUZ_expanded", "float 8 not implemented yet"});
    broken_tests.insert({"castlike_FLOAT_to_FLOAT8E5M2_expanded", "float 8 not implemented yet"});
    broken_tests.insert({"dequantizelinear_e4m3fn", "float 8 not implemented yet"});
    broken_tests.insert({"dequantizelinear_e5m2", "float 8 not implemented yet"});
    broken_tests.insert({"quantizelinear_e4m3fn", "float 8 not implemented yet"});
    broken_tests.insert({"quantizelinear_e5m2", "float 8 not implemented yet"});
  }
