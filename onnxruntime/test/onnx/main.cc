...
int real_main(int argc, char* argv[], Ort::Env& env) {
  ...
  std::set<BrokenTest> broken_tests = {
      ...
      {"softmax_cross_entropy_mean", "result differs", {"onnxtip"}}, 
      {"softmax_cross_entropy_mean_3d", "result differs", {"onnxtip"}},
      {"softmax_cross_entropy_mean_3d_expanded", "result differs", {"onnxtip"}},
      {"softmax_cross_entropy_mean_expanded", "result differs", {"onnxtip"}},
      {"softmax_cross_entropy_mean_weight", "result differs", {"onnxtip"}},
      {"softmax_cross_entropy_mean_weight_expanded", "result differs", {"onnxtip"}},
      {"softmax_cross_entropy_mean_weight_ignore_index", "result differs", {"onnxtip"}},
      {"softmax_cross_entropy_mean_weight_ignore_index_expanded", "result differs", {"onnxtip"}},
      {"softmax_cross_entropy_none", "result differs", {"onnxtip"}},
      {"softmax_cross_entropy_none_expanded", "result differs", {"onnxtip"}},
      {"softmax_cross_entropy_none_weights", "result differs", {"onnxtip"}},
      {"softmax_cross_entropy_none_weights_expanded", "result differs", {"onnxtip"}},
      {"softmax_cross_entropy_sum", "result differs", {"onnxtip"}},
      {"softmax_cross_entropy_sum_expanded", "result differs", {"onnxtip"}},
  };
