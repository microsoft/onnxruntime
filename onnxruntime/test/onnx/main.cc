...
int real_main(int argc, char* argv[], Ort::Env& env) {
  ...
  std::set<BrokenTest> broken_tests = {
      ...
      {"dynamicquantizelinear_expanded", "ReduceMin(11) not implemented yet"},
      {"dynamicquantizelinear_max_adjusted_expanded", "ReduceMin(11) not implemented yet"},
      {"dynamicquantizelinear_min_adjusted_expanded", "ReduceMin(11) not implemented yet"},
