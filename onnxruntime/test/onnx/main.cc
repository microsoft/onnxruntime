...
select from 'TF8', 'TF16', 'UINT8', 'FLOAT', 'ITENSOR'. \n)");
  ...
  if (enable_dml) {
    ...
    broken_tests.insert({"test_identity_cpu", "Optional type not yet supported for identity-16."});
    broken_tests.insert({"test_sequence_map_add_1_sequence_1_tensor_cpu", "Optional type not yet supported for identity-16."});
    broken_tests.insert({"test_sequence_map_add_1_sequence_1_tensor_expanded_cpu", "Optional type not yet supported for identity-16."});
    broken_tests.insert({"test_sequence_map_add_2_sequences_cpu", "Optional type not yet supported for identity-16."});
    broken_tests.insert({"test_sequence_map_add_2_sequences_expanded_cpu", "Optional type not yet supported for identity-16."});
    broken_tests.insert({"test_sequence_map_extract_shapes_cpu", "Optional type not yet supported for identity-16."});
    broken_tests.insert({"test_sequence_map_extract_shapes_expanded_cpu", "Optional type not yet supported for identity-16."});
    broken_tests.insert({"test_sequence_map_identity_1_sequence_1_tensor_cpu", "Optional type not yet supported for identity-16."});
    broken_tests.insert({"test_sequence_map_identity_1_sequence_1_tensor_expanded_cpu", "Optional type not yet supported for identity-16."});
    broken_tests.insert({"test_sequence_map_identity_1_sequence_cpu", "Optional type not yet supported for identity-16."});
    broken_tests.insert({"test_sequence_map_identity_1_sequence_expanded_cpu", "Optional type not yet supported for identity-16."});
    broken_tests.insert({"test_sequence_map_identity_2_sequences_cpu", "Optional type not yet supported for identity-16."});
    broken_tests.insert({"test_sequence_map_identity_2_sequences_expanded_cpu", "Optional type not yet supported for identity-16."});
