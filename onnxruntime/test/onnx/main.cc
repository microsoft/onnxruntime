...
void usage() {
  ...
  printf(
      ...
      "\t    [QNN only] [op_packages]: QNN UDO package, allowed format op_packages|<custom_op_type>:<op_package_path>:<interface_symbol_name>:<target>,<custom_op_type2>:<op_package_path2>:<interface_symbol_name2>:<target2>. \n"
