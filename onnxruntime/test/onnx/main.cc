...
int real_main(int argc, char* argv[], Ort::Env& env) {
  ...
  std::set<BrokenTest> broken_tests = {
      ...
      {"bernoulli_double", "By design. Test data is for informational purpose becasue the generator is non deterministic."},
      {"bernoulli_double_expanded", "By design. Test data is for informational purpose becasue the generator is non deterministic."},
      {"bernoulli_seed", "By design. Test data is for informational purpose becasue the generator is non deterministic."},
      {"bernoulli_seed_expanded", "By design. Test data is for informational purpose becasue the generator is non deterministic."},
      {"bernoulli_expanded", "By design. Test data is for informational purpose becasue the generator is non deterministic."},
