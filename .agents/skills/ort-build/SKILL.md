...
- **Use a subagent to monitor builds** during autonomous work. This keeps polling output out of the main conversation context. A smaller/cheaper model is sufficient for monitoring.
