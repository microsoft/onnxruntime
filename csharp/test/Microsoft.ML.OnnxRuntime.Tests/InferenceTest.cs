...
namespace Microsoft.ML.OnnxRuntime.Tests
{
    public class InferenceTest
    {
        ...
        private void VerifyNativeMethodsExist()
        {
            ...
            "OrtCreateCpuExecutionProviderFactory","OrtCreateMkldnnExecutionProviderFactory",
            "OrtCreateCUDAExecutionProviderFactory", "OrtCreateAllocatorInfo","OrtCreateCpuAllocatorInfo",         
