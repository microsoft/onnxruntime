...
namespace Microsoft.ML.OnnxRuntime.Tests {
 public
  class InferenceTest {
   private
    const string module = "onnxruntime.dll";
   private
    const string propertiesFile = "Properties.txt";

    [Fact] public void CanCreateAndDisposeSessionWithModelPath() {
    ...
    [Fact] private void CanRunInferenceOnAModel() {
      string modelPath = Path.Combine(Directory.GetCurrentDirectory(), "squeezenet.onnx");
    ...
    [Fact] private void ThrowWrongInputName() {
    ...
    [Fact] private void ThrowWrongInputType() {
      var tuple = OpenSessionSqueezeNet();
      var session = tuple.Item1;
      var inputData = tuple.Item2;
      var inputMeta = session.InputMetadata;
    ...
    [Fact] private void ThrowWrongDimensions() {
      var tuple = OpenSessionSqueezeNet();
      var session = tuple.Item1;
      var inputMeta = session.InputMetadata;
      var container = new List<NamedOnnxValue>();
    ...
    [Fact] private void ThrowExtraInputs() {
      var tuple = OpenSessionSqueezeNet();
      var session = tuple.Item1;
      var inputData = tuple.Item2;
      var tensor = tuple.Item3;
    ...
    [Fact] private void TestMultiThreads() {
      var numThreads = 10;
      var loop = 10;
      var tuple = OpenSessionSqueezeNet();
      var session = tuple.Item1;
    ...
    [Fact] private void TestPreTrainedModelsOpset7And8() {
    ...
    [Fact] private void TestModelInputFloat() {
    ...
    [Fact(Skip = "Boolean tensor not supported yet")] private void TestModelInputBOOL() {
      // model takes 1x5 input of fixed type, echoes back
    ...
    [Fact] private void TestModelInputINT32() {
      // model takes 1x5 input of fixed type, echoes back
    ...
    [Fact] private void TestModelInputDOUBLE() {
      // model takes 1x5 input of fixed type, echoes back
    ...
    [Fact(Skip = "String tensor not supported yet")] private void TestModelInputSTRING() {
      // model takes 1x5 input of fixed type, echoes back
    ...
    [Fact(Skip = "Int8 not supported yet")] private void TestModelInputINT8() {
      // model takes 1x5 input of fixed type, echoes back
    ...
    [Fact] private void TestModelInputUINT8() {
      // model takes 1x5 input of fixed type, echoes back
    ...
    [Fact] private void TestModelInputUINT16() {
      // model takes 1x5 input of fixed type, echoes back
    ...
    [Fact] private void TestModelInputINT16() {
      // model takes 1x5 input of fixed type, echoes back
    ...
    [Fact] private void TestModelInputUINT32() {
      // model takes 1x5 input of fixed type, echoes back
    ...
    [Fact] private void TestModelInputUINT64() {
      // model takes 1x5 input of fixed type, echoes back
    ...
    [Fact(Skip = "FLOAT16 not available in C#")] private void TestModelInputFLOAT16() {
      // model takes 1x5 input of fixed type, echoes back
    ...
    [Fact] private void TestModelSequenceOfMapIntFloat() {
    ...
    [Fact] private void TestModelSequenceOfMapStringFloat() {
      // test model trained using lightgbm classifier
      // produces 2 named outputs
      //   "label" is a tensor,
      //   "probabilities" is a sequence<map<int64, float>>
    ...
    [DllImport("kernel32", CharSet = CharSet.Ansi)] static extern UIntPtr GetProcAddress(IntPtr hModule, string procName);

    [Fact] private void VerifyNativeMethodsExist() {
