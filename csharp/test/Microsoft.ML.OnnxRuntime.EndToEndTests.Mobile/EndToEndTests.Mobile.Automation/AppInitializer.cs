...
public class AppInitializer
{
    public static IApp StartApp(Platform platform)
    {
        ...
        // msbuild
        // <path_to_repo>/csharp/test/Microsoft.ML.OnnxRuntime.Tests.Droid/Microsoft.ML.OnnxRuntime.Tests.Droid.csproj
        // /p:Configuration=Debug /t:PackageForAndroid
        if (platform == Platform.Android)
        {
            return ConfigureApp
                ...
                .ApkFile(
                    "../../../../../Microsoft.ML.OnnxRuntime.Tests.Droid/bin/Release/com.microsoft.onnxruntime_tests_droid.apk")
#endif
                .StartApp();
        }
