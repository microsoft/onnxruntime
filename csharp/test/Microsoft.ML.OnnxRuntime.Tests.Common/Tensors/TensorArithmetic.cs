...
internal class BoolArithmetic : ITensorArithmetic<bool>
{
    ...
    public void And(DenseTensor<bool> left, DenseTensor<bool> right, DenseTensor<bool> result)
    {
        ...
        else
        {
            ...
            {
                colMajorIndex =
                    ArrayUtilities.TransformIndexByStrides(rowMajorIndex, rowMajorStrides, false, columnMajorStrides);
    ...
    public void And(DenseTensor<bool> tensor, bool scalar, DenseTensor<bool> result)
    {
        ...
        else
        {
            ...
            var rowMajorStrides = !result.IsReversedStride ? result.strides : tensor.strides;
            var columnMajorStrides = result.IsReversedStride ? result.strides : tensor.strides;
            for (; rowMajorIndex < resultSpan.Length; rowMajorIndex++)
            {
                colMajorIndex =
                    ArrayUtilities.TransformIndexByStrides(rowMajorIndex, rowMajorStrides, false, columnMajorStrides);
    ...
    public void Contract(DenseTensor<bool> left, DenseTensor<bool> right, int[] leftAxes, int[] rightAxes,
...
internal class ByteArithmetic : ITensorArithmetic<byte>
{
    ...
    public void Contract(Tensor<byte> left, Tensor<byte> right, int[] leftAxes, int[] rightAxes, Tensor<byte> result)
    {
        ...
        ArrayUtilities.SplitStrides(right.strides, rightAxes, rightNonSummingStrides, rightNonSummingStridesOffset,
                                    rightSummingStrides, 0);
        ...
        for (int resultIndex = 0; resultIndex < result.Length; resultIndex++)
        {
            ...
            int leftIndexNonSumming = ArrayUtilities.TransformIndexByStrides(
                resultIndex, resultStrides, result.IsReversedStride, leftNonSummingStrides);
            int rightIndexNonSumming = ArrayUtilities.TransformIndexByStrides(
                resultIndex, resultStrides, result.IsReversedStride, rightNonSummingStrides);

            for (int summingIndex = 0; summingIndex < summingLength; summingIndex++)
            {
                int leftIndexSumming =
                    ArrayUtilities.TransformIndexByStrides(summingIndex, summingStrides, false, leftSummingStrides);
                int rightIndexSumming =
                    ArrayUtilities.TransformIndexByStrides(summingIndex, summingStrides, false, rightSummingStrides);
    ...
    public void Contract(DenseTensor<byte> left, DenseTensor<byte> right, int[] leftAxes, int[] rightAxes,
...
internal class CharArithmetic : ITensorArithmetic<char>
{
    ...
    public void Contract(DenseTensor<char> left, DenseTensor<char> right, int[] leftAxes, int[] rightAxes,
...
internal class DecimalArithmetic : ITensorArithmetic<decimal>
{
    ...
    public void Contract(Tensor<decimal> left, Tensor<decimal> right, int[] leftAxes, int[] rightAxes,
    ...
    public void Contract(DenseTensor<decimal> left, DenseTensor<decimal> right, int[] leftAxes, int[] rightAxes,
...
internal class DoubleArithmetic : ITensorArithmetic<double>
{
    ...
    public void Contract(Tensor<double> left, Tensor<double> right, int[] leftAxes, int[] rightAxes,
    ...
    public void Contract(DenseTensor<double> left, DenseTensor<double> right, int[] leftAxes, int[] rightAxes,
...
internal class FloatArithmetic : ITensorArithmetic<float>
{
    ...
    public void Contract(DenseTensor<float> left, DenseTensor<float> right, int[] leftAxes, int[] rightAxes,
...
internal class IntArithmetic : ITensorArithmetic<int>
{
    ...
    public void Contract(DenseTensor<int> left, DenseTensor<int> right, int[] leftAxes, int[] rightAxes,
...
internal class LongArithmetic : ITensorArithmetic<long>
{
    ...
    public void Contract(DenseTensor<long> left, DenseTensor<long> right, int[] leftAxes, int[] rightAxes,
...
internal class SByteArithmetic : ITensorArithmetic<sbyte>
{
    ...
    public void Contract(DenseTensor<sbyte> left, DenseTensor<sbyte> right, int[] leftAxes, int[] rightAxes,
...
internal class ShortArithmetic : ITensorArithmetic<short>
{
    ...
    public void Contract(DenseTensor<short> left, DenseTensor<short> right, int[] leftAxes, int[] rightAxes,
...
internal class UIntArithmetic : ITensorArithmetic<uint>
{
    ...
    public void Contract(DenseTensor<uint> left, DenseTensor<uint> right, int[] leftAxes, int[] rightAxes,
...
internal class ULongArithmetic : ITensorArithmetic<ulong>
{
    ...
    public void Contract(DenseTensor<ulong> left, DenseTensor<ulong> right, int[] leftAxes, int[] rightAxes,
...
internal class UShortArithmetic : ITensorArithmetic<ushort>
{
    ...
    public void Contract(Tensor<ushort> left, Tensor<ushort> right, int[] leftAxes, int[] rightAxes,
    ...
    public void Contract(DenseTensor<ushort> left, DenseTensor<ushort> right, int[] leftAxes, int[] rightAxes,
