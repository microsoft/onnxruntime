...
public class OrtIoBindingAllocationTest
{
    ...
    public void TestIOBindingWithOrtAllocation()
    {
        ...
        using (var dispList = new DisposableListTest<IDisposable>())
        {
            ...
            {
                var externalInputAllocation = new OrtExternalAllocation(
                    cpuMemInfo, inputShape, Tensors.TensorElementType.Float, allocPtr, sizeInBytes);
            ...
            // 4. Some negative tests for external allocation
            {
                ...
                {
                    new OrtExternalAllocation(cpuMemInfo, inputShape, Tensors.TensorElementType.Float, allocPtr,
                                              sizeInBytes - 10);
                };
                ...
                {
                    new OrtExternalAllocation(cpuMemInfo, inputShape, Tensors.TensorElementType.String, allocPtr,
                                              sizeInBytes);
                };
