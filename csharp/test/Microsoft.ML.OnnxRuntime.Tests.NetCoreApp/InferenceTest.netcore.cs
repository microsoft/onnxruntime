        ...
        private static Dictionary<string, string> GetSkippedModels(DirectoryInfo modelsDirInfo)
        {
            var skipModels = new Dictionary<string, string>() {
                ...
                */
                ...
                { "test_cast_FLOAT8E5M2FNUZ_to_FLOAT", "Output mismatch"},
                { "test_cast_FLOAT8E5M2FNUZ_to_FLOAT16", "Output mismatch"},
                { "test_cast_FLOAT8E5M2_to_FLOAT", "Output mismatch"},
                { "test_cast_FLOAT8E5M2_to_FLOAT16", "Output mismatch"},
                { "test_cast_FLOAT_to_FLOAT8E4M3FN", "Output mismatch"},
                ...
                { "test_cast_no_saturate_FLOAT16_to_FLOAT8E5M2FNUZ", "Output mismatch"},
                { "test_cast_no_saturate_FLOAT_to_FLOAT8E4M3FN", "Output mismatch"},
                ...
                { "test_castlike_FLOAT8E4M3FN_to_FLOAT_expanded", "Output mismatch"},
                { "test_castlike_FLOAT8E5M2FNUZ_to_FLOAT", "Output mismatch"},
                ...
                { "test_castlike_FLOAT_to_FLOAT8E4M3FN_expanded", "Output mismatch"},
                { "test_castlike_FLOAT_to_FLOAT8E5M2", "Output mismatch"},
