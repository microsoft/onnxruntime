    ...
    public partial class InferenceTest
    {
        ...
        private static Dictionary<string, string> GetSkippedModels(DirectoryInfo modelsDirInfo)
        {
            var skipModels = new Dictionary<string, string>() {
                ...
                { "cast_FLOAT8E5M2_to_FLOAT", "type error"},
                { "cast_FLOAT8E5M2_to_FLOAT16", "type error"},
                { "cast_FLOAT_to_FLOAT8E4M3FN", "type error"},
                { "cast_FLOAT_to_FLOAT8E4M3FNUZ", "type error"},
                { "cast_FLOAT_to_FLOAT8E5M2", "type error"},
                { "cast_FLOAT_to_FLOAT8E5M2FNUZ", "type error"},
                { "cast_no_saturate_FLOAT16_to_FLOAT8E4M3FN", "type error"},
                { "cast_no_saturate_FLOAT16_to_FLOAT8E4M3FNUZ", "type error"},
                { "cast_no_saturate_FLOAT16_to_FLOAT8E5M2", "type error"},
                { "cast_no_saturate_FLOAT16_to_FLOAT8E5M2FNUZ", "type error"},
                { "cast_no_saturate_FLOAT_to_FLOAT8E4M3FN", "type error"},
                { "cast_no_saturate_FLOAT_to_FLOAT8E4M3FNUZ", "type error"},
                { "cast_no_saturate_FLOAT_to_FLOAT8E5M2", "type error"},
                { "cast_no_saturate_FLOAT_to_FLOAT8E5M2FNUZ", "type error"},
                { "castlike_FLOAT8E4M3FNUZ_to_FLOAT", "type error"},
                { "castlike_FLOAT8E4M3FNUZ_to_FLOAT_expanded", "type error"},
                { "castlike_FLOAT8E4M3FN_to_FLOAT", "type error"},
                { "castlike_FLOAT8E4M3FN_to_FLOAT_expanded", "type error"},
                { "castlike_FLOAT8E5M2FNUZ_to_FLOAT", "type error"},
                { "castlike_FLOAT8E5M2FNUZ_to_FLOAT_expanded", "type error"},
                { "castlike_FLOAT8E5M2_to_FLOAT", "type error"},
                { "castlike_FLOAT8E5M2_to_FLOAT_expanded", "type error"},
                { "castlike_FLOAT_to_FLOAT8E4M3FN", "type error"},
                { "castlike_FLOAT_to_FLOAT8E4M3FNUZ", "type error"},
                { "castlike_FLOAT_to_FLOAT8E4M3FNUZ_expanded", "type error"},
                { "castlike_FLOAT_to_FLOAT8E4M3FN_expanded", "type error"},
                { "castlike_FLOAT_to_FLOAT8E5M2", "type error"},
                { "castlike_FLOAT_to_FLOAT8E5M2FNUZ", "type error"},
                { "castlike_FLOAT_to_FLOAT8E5M2FNUZ_expanded", "type error"},
                { "castlike_FLOAT_to_FLOAT8E5M2_expanded", "type error"},
                { "castlike_FLOAT_to_STRING_expanded_model", "type error"},
                { "castlike_FLOAT_to_STRING_model", "type error"},
                { "castlike_FLOAT_to_BFLOAT16_expanded_model", "type error"},
                { "castlike_FLOAT_to_BFLOAT16_model", "type error"},
                { "castlike_BFLOAT16_to_FLOAT_expanded_model", "type error"},
                { "castlike_BFLOAT16_to_FLOAT_model", "type error"},
                { "castlike_FLOAT_to_STRING_expanded_model", "type error"},
                { "castlike_FLOAT_to_STRING_model", "type error"},
                { "castlike_FLOAT_to_BFLOAT16_expanded_model", "type error"},
                { "castlike_FLOAT_to_BFLOAT16_model", "type error"},
                { "castlike_BFLOAT16_to_FLOAT_expanded_model", "type error"},
                { "castlike_BFLOAT16_to_FLOAT_model", "type error"},
                { "dequantizelinear_e4m3fn", "type error"},
