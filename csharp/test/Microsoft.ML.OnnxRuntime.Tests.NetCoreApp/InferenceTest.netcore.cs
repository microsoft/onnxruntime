    ...
    public partial class InferenceTest
    {
        ...
        private static Dictionary<string, string> GetSkippedModels(DirectoryInfo modelsDirInfo)
        {
            ...
            var skipModels = new Dictionary<string, string>() {
                ...
                { "test_cast_FLOAT8E5M2_to_FLOAT", "type error"},
                { "test_cast_FLOAT8E5M2_to_FLOAT16", "type error"},
                { "test_cast_FLOAT_to_FLOAT8E4M3FN", "type error"},
                { "test_cast_FLOAT_to_FLOAT8E4M3FNUZ", "type error"},
                { "test_cast_FLOAT_to_FLOAT8E5M2", "type error"},
                { "test_cast_FLOAT_to_FLOAT8E5M2FNUZ", "type error"},
                { "test_cast_no_saturate_FLOAT16_to_FLOAT8E4M3FN", "type error"},
                { "test_cast_no_saturate_FLOAT16_to_FLOAT8E4M3FNUZ", "type error"},
                { "test_cast_no_saturate_FLOAT16_to_FLOAT8E5M2", "type error"},
                { "test_cast_no_saturate_FLOAT16_to_FLOAT8E5M2FNUZ", "type error"},
                { "test_cast_no_saturate_FLOAT_to_FLOAT8E4M3FN", "type error"},
                { "test_cast_no_saturate_FLOAT_to_FLOAT8E4M3FNUZ", "type error"},
                { "test_cast_no_saturate_FLOAT_to_FLOAT8E5M2", "type error"},
                { "test_cast_no_saturate_FLOAT_to_FLOAT8E5M2FNUZ", "type error"},
                { "test_castlike_FLOAT8E4M3FNUZ_to_FLOAT", "type error"},
                { "test_castlike_FLOAT8E4M3FNUZ_to_FLOAT_expanded", "type error"},
                { "test_castlike_FLOAT8E4M3FN_to_FLOAT", "type error"},
                { "test_castlike_FLOAT8E4M3FN_to_FLOAT_expanded", "type error"},
                { "test_castlike_FLOAT8E5M2FNUZ_to_FLOAT", "type error"},
                { "test_castlike_FLOAT8E5M2FNUZ_to_FLOAT_expanded", "type error"},
                { "test_castlike_FLOAT8E5M2_to_FLOAT", "type error"},
                { "test_castlike_FLOAT8E5M2_to_FLOAT_expanded", "type error"},
                { "test_castlike_FLOAT_to_FLOAT8E4M3FN", "type error"},
                { "test_castlike_FLOAT_to_FLOAT8E4M3FNUZ", "type error"},
                { "test_castlike_FLOAT_to_FLOAT8E4M3FNUZ_expanded", "type error"},
                { "test_castlike_FLOAT_to_FLOAT8E4M3FN_expanded", "type error"},
                { "test_castlike_FLOAT_to_FLOAT8E5M2", "type error"},
                ...
                { "test_castlike_FLOAT_to_STRING_model", "type error"},
                { "test_castlike_FLOAT_to_BFLOAT16_expanded_model", "type error"},
                { "test_castlike_FLOAT_to_BFLOAT16_model", "type error"},
                { "test_castlike_BFLOAT16_to_FLOAT_expanded_model", "type error"},
                { "test_castlike_BFLOAT16_to_FLOAT_model", "type error"},
                { "test_dequantizelinear_e4m3fn", "type error"},
