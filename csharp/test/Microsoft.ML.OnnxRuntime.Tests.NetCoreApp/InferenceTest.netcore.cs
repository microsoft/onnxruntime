  ...
  public partial class InferenceTest
  {
        ...
        private static Dictionary<string, string> GetSkippedModels(DirectoryInfo modelsDirInfo)
        {
            var skipModels = new Dictionary<string, string>() {
                ...
                { "mask_rcnn", "Expected model values were recorded with buggy implementation of RoiAlign. See https://github.com/microsoft/onnxruntime/pull/7354/." },
                { "mask_rcnn_R_50_FPN_1x", "Expected model values were recorded with buggy implementation of RoiAlign. See https://github.com/microsoft/onnxruntime/pull/7354/." },
