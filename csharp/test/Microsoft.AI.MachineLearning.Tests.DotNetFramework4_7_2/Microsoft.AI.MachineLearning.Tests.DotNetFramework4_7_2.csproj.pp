...
<Project ToolsVersion="15.0" xmlns="http://schemas.microsoft.com/developer/msbuild/2003">
  <Import Project="packages\Microsoft.Windows.CsWinRT.0.1.0-prerelease.200902.3\build\Microsoft.Windows.CsWinRT.props" Condition="Exists('packages\Microsoft.Windows.CsWinRT.0.1.0-prerelease.200902.3\build\Microsoft.Windows.CsWinRT.props')" />
  ...
  <ItemGroup>
    ...
    <Reference Include="Microsoft.Windows.SDK.NET, Version=10.0.18362.3, Culture=neutral, processorArchitecture=MSIL">
      <HintPath>packages\Microsoft.Windows.SDK.NET.10.0.18362.8-preview\lib\netstandard2.0\Microsoft.Windows.SDK.NET.dll</HintPath>
    </Reference>
    ...
    <Reference Include="winrt.runtime, Version=0.1.0.1677, Culture=neutral, processorArchitecture=MSIL">
      <HintPath>packages\Microsoft.Windows.CsWinRT.0.1.0-prerelease.200902.3\lib\netstandard2.0\winrt.runtime.dll</HintPath>
    </Reference>
  </ItemGroup>
  <ItemGroup>
  ...
  <Target Name="EnsureNuGetPackageBuildImports" BeforeTargets="PrepareForBuild">
    ...
    <Error Condition="!Exists('packages\Microsoft.Windows.CsWinRT.0.1.0-prerelease.200902.3\build\Microsoft.Windows.CsWinRT.props')" Text="$([System.String]::Format('$(ErrorText)', 'packages\Microsoft.Windows.CsWinRT.0.1.0-prerelease.200902.3\build\Microsoft.Windows.CsWinRT.props'))" />
    <Error Condition="!Exists('packages\Microsoft.Windows.CsWinRT.0.1.0-prerelease.200902.3\build\Microsoft.Windows.CsWinRT.targets')" Text="$([System.String]::Format('$(ErrorText)', 'packages\Microsoft.Windows.CsWinRT.0.1.0-prerelease.200902.3\build\Microsoft.Windows.CsWinRT.targets'))" />
  ...
  <Import Project="packages\Microsoft.Windows.CsWinRT.0.1.0-prerelease.200902.3\build\Microsoft.Windows.CsWinRT.targets" Condition="Exists('packages\Microsoft.Windows.CsWinRT.0.1.0-prerelease.200902.3\build\Microsoft.Windows.CsWinRT.targets')" />
