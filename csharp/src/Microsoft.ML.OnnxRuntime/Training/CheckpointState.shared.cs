...
namespace Microsoft.ML.OnnxRuntime
{
    ...
    public class CheckpointState : SafeHandle
    {
            ...
            : base(IntPtr.Zero, true)
        {
            ...
            {
                throw new InvalidOperationException("Training is disabled in the current build. Please build ONNXRuntime from source with the build flags enable_training and enable_training. \n");
            }
        }
