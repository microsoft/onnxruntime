...
namespace Microsoft.ML.OnnxRuntime
{
    ...
    /// It sets up logging, creates system wide thread-pools and other necessary things for 
    /// OnnxRuntime to function.Create or access OrtEnv by calling the Instance() method.
    /// Call this method before doing anything else in your application.
    /// </summary>
