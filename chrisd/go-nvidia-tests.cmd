...
echo "Go NVidia!"
echo.
build\RelWithDebInfo\winappsdk_onnxruntime_perf_test --winappsdk_version 1.8 -e nvtensorrtrtx --required_device_type gpu -t 10 -I "C:\models\in\PSD1.quant.onnx"
echo.
