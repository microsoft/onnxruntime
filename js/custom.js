...
function equalHeight() {
    if (window.innerWidth > 767) {
        ...
        var maxHeight = 0;
        $(".equalHeight-1 h2").height('auto');
        $(".equalHeight-1 h2").each(function () {
            if ($(this).height() > maxHeight) {
                maxHeight = $(this).height();
            }
        });
        $(".equalHeight-1 h2").height(maxHeight);
        ...
        var maxHeight = 0;
        $(".equalHeight-2 h2").height('auto');
        $(".equalHeight-2 h2").each(function () {
            if ($(this).height() > maxHeight) {
                maxHeight = $(this).height();
            }
        });
        $(".equalHeight-2 h2").height(maxHeight);
...
function carouselNormalization() {
	var items = $('#ONNXCarousel .item'), heights = [], tallest; 
	if (items.length) {
