...
| ConvTranspose | ai.onnx(7-10, 11+) | convTranspose2d | ✓ | ✓ | Only supports 3-D or 4-D input and 'W' (weight). WebNN CPU backend only supports default dilations and groups |
| Cos | ai.onnx(7+) | cos | ✓ | ✓ | |
