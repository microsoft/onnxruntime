...
| GroupQueryAttention | com.microsoft(1+) | add, cast, concat, constant, cumulativeSum, div, expand, lesser, matmul, reshape, scatterND, softmax, transpose, where | Only supports past_sequence_length of past kv equal to present_sequence_length of present kv. Does not support cos_cache and sin_cache inputs |
