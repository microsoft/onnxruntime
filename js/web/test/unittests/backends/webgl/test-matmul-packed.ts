...
//       biasValue: 2,
//       expectedOutput: new Float32Array([92, 102, 112, 122, 204, 230, 256, 282, 316, 358, 400, 442, 428, 486, 544,
//       602]),
//     },
//     {
//       elementCountA: 12,
...
//           webglInferenceHandler.session.textureManager.glContext, testData.rawInputA ? testData.rawInputA :
//           inputDataA, gl.RGBA, inputTextureShapeA[0], inputTextureShapeA[1]);
//       const webglTextureB = createTextureFromArray(
//           webglInferenceHandler.session.textureManager.glContext, testData.rawInputB ? testData.rawInputB :
//           inputDataB, gl.RGBA, inputTextureShapeB[0], inputTextureShapeB[1]);

//       const webglTextureBias = biasTensor && testData.biasValue ?
//           createTextureFromArray(
//               webglInferenceHandler.session.textureManager.glContext, new Float32Array([testData.biasValue, 0, 0,
//               0]), gl.RGBA, 1, 1) :
//           undefined;
