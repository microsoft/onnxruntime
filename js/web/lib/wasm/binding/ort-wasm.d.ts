...
export interface OrtWasmModule extends EmscriptenModule {
  ...
  _OrtTrainingGetInputOutputCount?(sessionHandle: number, inputCountOffset: number, outputCountOffset: number,
    isEvalModel: boolean): number;
  _OrtTrainingGetInputOutputName?(sessionHandle: number, index: number, isInput: boolean, isEvalModel: boolean): number;
