...
//         [
//           inputs[0].dims[0], this.blocksize, this.blocksize, inputs[0].dims[1] / this.blocksizeSqr,
//           inputs[0].dims[2], inputs[0].dims[3]
//         ] :
//         [
//           inputs[0].dims[0], inputs[0].dims[1] / this.blocksizeSqr, this.blocksize, this.blocksize,
//           inputs[0].dims[2], inputs[0].dims[3]
//         ];
