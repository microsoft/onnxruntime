...
// // We provide a wrapper class so that the kernel can switch between packed and unpacked depending on the inputs on
// the
// // fly.
...
//     const codeLines: string[] = [`float fetchDataFromCorrectTexture(int textureIndex, int
//     indices[${tensorRank}]) {`]; for (let i = 0; i < numberOfTensors; ++i) {
//       if (i === 0) {
//         codeLines.push(
//             '\t' +
