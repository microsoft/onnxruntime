...
class SessionState(object):
    ...
    def Kernels(self):
        ...
        if o != 0:
            ...
            from onnxruntime.experimental.fbs.KernelCreateInfos import KernelCreateInfos
    ...
    def SubGraphSessionStates(self, j):
        ...
        if o != 0:
            ...
            from onnxruntime.experimental.fbs.SubGraphSessionState import SubGraphSessionState
