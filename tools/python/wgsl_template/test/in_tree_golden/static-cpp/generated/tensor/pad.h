...
ss << __str_343;
ss << GetElementAt(__str_327, __str_328, __var_output.Rank());
ss << __str_3;
// 34 |     let lower_pads = getElementAt(uniforms.lower_pads, dim, output.rank);
ss << __str_344;
ss << GetElementAt(__str_329, __str_328, __var_output.Rank());
ss << __str_189;
// 35 |     let data_shape = i32(getElementAt(uniforms.data_shape, dim, output.rank));
ss << __str_345;
ss << GetElementAt(__str_330, __str_328, __var_output.Rank());
ss << __str_3;
...
ss << __str_365;
ss << GetElementAt(__str_331, __str_328, __var_output.Rank() - 1);
ss << __str_12;
// 72 | #endif
}
...
ss << __str_212;
ss << __var_output.SetByOffset(__str_210, __str_332);
ss << __str_189;
// 77 | #endif
}
// 78 | } // MAIN
