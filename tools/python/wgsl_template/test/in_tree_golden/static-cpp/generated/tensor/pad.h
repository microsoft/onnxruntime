...
ss << __str_344;
ss << shader_helper.GuardAgainstOutOfBoundsWorkgroupSizes(__str_336);
ss << __str_188;
// 16 | 
ss << __str_12;
...
ss << __str_349;
ss << __var_output.OffsetToIndices(__str_337);
ss << __str_188;
...
ss << __str_344;
ss << __var_output.SetByOffset(__str_337, __str_343);
ss << __str_188;
// 77 | #endif
}
// 78 | } // MAIN
