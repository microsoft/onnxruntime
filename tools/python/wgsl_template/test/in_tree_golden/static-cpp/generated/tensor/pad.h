...
ss << __str_366;
ss << GetElementAt(__str_350, __str_351, __var_output.Rank());
ss << __str_3;
// 34 |     let lower_pads = getElementAt(uniforms.lower_pads, dim, output.rank);
ss << __str_367;
ss << GetElementAt(__str_352, __str_351, __var_output.Rank());
ss << __str_188;
// 35 |     let data_shape = i32(getElementAt(uniforms.data_shape, dim, output.rank));
ss << __str_368;
ss << GetElementAt(__str_353, __str_351, __var_output.Rank());
ss << __str_3;
...
ss << __str_388;
ss << GetElementAt(__str_354, __str_351, __var_output.Rank() - 1);
ss << __str_12;
// 72 | #endif
}
...
ss << __str_211;
ss << __var_output.SetByOffset(__str_209, __str_355);
ss << __str_188;
// 77 | #endif
}
// 78 | } // MAIN
