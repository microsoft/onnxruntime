...
nohup $ANDROID_HOME/emulator/emulator -avd android_emulator -partition-size 2048 -memory 8192 -timezone America/Los_Angeles -no-snapshot -no-audio -no-boot-anim -no-window -port 5682 &
