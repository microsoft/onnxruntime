...
nohup $ANDROID_HOME/emulator/emulator -avd android_emulator -partition-size 2048 -no-snapshot -no-audio -memory 4096 -timezone America/Los_Angeles -no-boot-anim -no-window &
