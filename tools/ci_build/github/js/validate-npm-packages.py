...
ort_common_ver = ort_node_common_ver if RELEASE_NODE else (
                   ort_web_common_ver if RELEASE_WEB else ort_react_native_common_ver)
...
if tag == 'latest' or tag == '':
  ...
  if ('-' in ort_common_ver.replace('-rev', '') or
      '-' in ort_web_ver.replace('-rev', '') or
      '-' in ort_react_native_ver.replace('-rev', '')):
...
if ('-' not in ort_common_ver.replace('-rev', '') and
    '-' not in ort_web_ver.replace('-rev', '') and
    '-' not in ort_react_native_ver.replace('-rev', '') and
    '+' not in ort_common_ver.replace('-rev', '') and
    '+' not in ort_web_ver.replace('-rev', '') and
    '+' not in ort_react_native_ver.replace('-rev', '')):
