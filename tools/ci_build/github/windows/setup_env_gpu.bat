...
set PATH=%AGENT_TEMPDIRECTORY%\TensorRT-10.10.0.31.Windows10.x86_64.cuda-12.9\lib;%PATH%

@REM The default version is still cuda v12.2, because set cuda v11.8 after it
set PATH=%PATH%;%AGENT_TEMPDIRECTORY%\TensorRT-10.10.0.31.Windows10.x86_64.cuda-11.8\lib
