...
@REM The default version is still cuda v11.8, because set cuda v12.3 after it
if exist PATH=%AGENT_TEMPDIRECTORY%\v12.3\ (
    ...
    set PATH=%PATH%;C:\Program Files\NVIDIA GPU Computing Toolkit\CUDA\v12.3\bin;C:\Program Files\NVIDIA GPU Computing Toolkit\CUDA\v12.3\extras\CUPTI\lib64
)
