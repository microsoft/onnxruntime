...
[System.Environment]::SetEnvironmentVariable('PATH', $env:PATH + ";$env:USERPROFILE/.nuget/packages/google.protobuf.tools/**/tools/windows_x64", [System.EnvironmentVariableTarget]::User)
