...
set PATH=%AGENT_TEMPDIRECTORY%\TensorRT-10.0.0.6.Windows10.x86_64.cuda-12.4\lib;%PATH%

@REM The default version is cuda v12.3, because set cuda v11.8 after it
set PATH=%PATH%;%AGENT_TEMPDIRECTORY%\TensorRT-10.0.0.6.Windows10.x86_64.cuda-11.8\lib
