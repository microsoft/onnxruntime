...
BUILD_ARGS=("--build_dir" "/build" "--config" "$BUILD_CONFIG" "--update" "--build" "--skip_submodule_sync" "--parallel" "--nvcc_threads 1" "--use_binskim_compliant_compile_flags" "--build_wheel" "--use_vcpkg")
