...
python3.8 -m pip install -U --user onnx
...
python3.8 -m pip install -U --user $FULL_BUILD_DIR/Debug/dist/*
...
python3.8 $ORT_ROOT/tools/python/convert_onnx_models_to_ort.py --use_nnapi \
    $TMPDIR/.test_data/ort_minimal_e2e_test_data

# Uninstall the ORT python wheel
python3.8 -m pip uninstall -y onnxruntime_noopenmp
