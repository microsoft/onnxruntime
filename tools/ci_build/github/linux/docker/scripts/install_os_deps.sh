...
if [[ $SYS_LONG_BIT = "64" && "$GLIBC_VERSION" -gt "9" ]]; then
  ...
  GetFile https://github.com/Kitware/CMake/releases/download/v3.27.2/cmake-3.27.2-Linux-x86_64.tar.gz /tmp/src/cmake-3.27.2-Linux-x86_64.tar.gz
  tar -zxf /tmp/src/cmake-3.27.2-Linux-x86_64.tar.gz --strip=1 -C /usr
  ...
  echo "Installing cmake"
  GetFile https://github.com/Kitware/CMake/releases/download/v3.27.2/cmake-3.27.2.tar.gz /tmp/src/cmake-3.27.2.tar.gz
  tar -xf /tmp/src/cmake-3.27.2.tar.gz -C /tmp/src
  pushd .
  cd /tmp/src/cmake-3.27.2
