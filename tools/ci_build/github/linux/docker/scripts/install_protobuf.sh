...
GetFile https://github.com/protocolbuffers/protobuf/archive/v3.19.4.tar.gz /tmp/src/v3.19.4.tar.gz
tar -xf /tmp/src/v3.19.4.tar.gz -C /tmp/src
cd /tmp/src/protobuf-3.19.4
