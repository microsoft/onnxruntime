...
GetFile https://github.com/protocolbuffers/protobuf/archive/v3.17.3.tar.gz /tmp/src/v3.17.3.tar.gz
tar -xf /tmp/src/v3.17.3.tar.gz -C /tmp/src
cd /tmp/src/protobuf-3.17.3
