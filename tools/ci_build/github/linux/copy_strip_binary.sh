...
cp $SOURCE_DIR/orttraining/orttraining/training_api/include/onnxruntime_training_c_cxx_api.h  $BINARY_DIR/$ARTIFACT_NAME/include
cp $SOURCE_DIR/orttraining/orttraining/training_api/include/onnxruntime_training_c_cxx_inline.h  $BINARY_DIR/$ARTIFACT_NAME/include
