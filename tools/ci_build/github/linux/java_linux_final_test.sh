...
java -jar ./junit-platform-console-standalone-1.6.2.jar -cp .:./test:./protobuf-java-3.9.2.jar:./onnxruntime-${VERSION_NUMBER=}.jar --scan-class-path --fail-if-no-tests --disable-banner
