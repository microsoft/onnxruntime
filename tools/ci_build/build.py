...
def run_android_tests(args, source_dir, config, cwd):
    ...
    def run_adb_shell(cmd):
        ...
        if args.android_coverage and args.android:
            adb_shell('cd /data/local/tmp && GCOV_PREFIX=/data/local/tmp GCOV_PREFIX_STRIP={} {}'.format(cwd.count(os.sep)+1, cmd))
        else:
    ...
    if args.android_abi == 'x86_64':
        ...
        if args.build_shared_lib:
            ...
            run_adb_shell('export LD_LIBRARY_PATH=$LD_LIBRARY_PATH:/data/local/tmp && ' +
