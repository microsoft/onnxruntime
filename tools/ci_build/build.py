...
def parse_arguments():
    ...
    parser.add_argument("--emsdk_version", default="sdk-main-64bit", help="Specify version of emsdk")
...
def generate_build_tree(
    ...
    cmake_args += [
        ...
        "-Donnxruntime_ENABLE_WEBASSEMBLY_MEMORY=" + ("ON" if args.enable_wasm_memory64 else "OFF"),
