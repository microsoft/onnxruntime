...
def run_training_python_frontend_e2e_tests(cwd):
    ...
    if ngpus > 1:
        ...
        run_subprocess(['mpirun', '-n', str(ngpus), '-x', 'NCCL_DEBUG=INFO', '-x', 'NCCL_SOCKET_IFNAME=^docker0,lo', sys.executable, 'orttraining_run_glue.py'], cwd=cwd)
    ...
    # this test is unstable. skip it to unblock the pipeline. a task is created to fix the issue (895948).
    # run_subprocess([
    #     sys.executable, 'orttraining_test_transformers.py',
