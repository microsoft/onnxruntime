...
def parse_arguments():
    ...
    parser.add_argument(
        "--extra_tensorrt_plugin_lib_paths", nargs="+", help="Directories for extra TRT plugin libs"
    )
...
def generate_build_tree(
    ...
    cmake_args += [
        ...
        "-Donnxruntime_USE_EXTRA_TENSORRT_PLUGINS="
        + ("ON" if args.extra_tensorrt_plugin_libs else "OFF"),
        ...
        "-Donnxruntime_SEARCH_EXTRA_TENSORRT_PLUGIN_LIBS="
        + ("ON" if args.extra_tensorrt_plugin_lib_paths else "OFF"),
