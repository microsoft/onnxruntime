...
def parse_arguments():
    ...
    parser.add_argument("--enable_wasm_fp16", action="store_true", help="Enable WebAssembly fp16 support")
...
def generate_build_tree(
    ...
    cmake_args += [
        ...
        "-Donnxruntime_ENABLE_WEBASSEMBLY_FLOAT16=" + ("ON" if args.enable_wasm_fp16 else "OFF"),
