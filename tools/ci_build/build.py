    ...
    for config in configs:
        ...
        if not ctest_path:
            ...
            if args.use_tensorrt:
                ...
                # However, in C-API application test in package pipelines, with this flag will cause
                # ORT TRT to deadlock, so we remove this flag for package pipelines.
                # For package pipelines with TRT 8.5 GA, we observe increased testing time, hence
                # increase the timeout as workaround.
