...
# This file is used by DML Nuget Pipeline,Nuget GPU TensorRT Pipeline,Nuget WindowsAI Pipeline,Zip-Nuget Packaging NoContribOps Pipeline,Zip-Nuget-Java Packaging Pipeline
import argparse
import sys
import os
