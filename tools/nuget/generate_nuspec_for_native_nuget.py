...
def generate_dependencies(list, package_name, version):
    if (package_name == 'Microsoft.AI.MachineLearning'):
        ...
        list.append('<dependency id="Microsoft.Windows.SDK.NET"' + ' version="10.0.18362.8-preview"/>')
        list.append('<dependency id="Microsoft.Windows.CsWinRT"' + ' version="0.1.0-prerelease.200902.3"/>')
        list.append('</group>')
