...
|Erf|*in* input:**T**<br> *out* output:**T**|13+|**T** = tensor(double), tensor(float), tensor(float16), tensor(bfloat16)|
|||[9, 12]|**T** = tensor(double), tensor(float), tensor(float16), tensor(bfloat16)|
