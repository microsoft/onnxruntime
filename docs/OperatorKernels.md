...
|SimplifiedLayerNormalization|*in* X:**T**<br> *in* scale:**V**<br> *out* Y:**V**<br> *out* inv_std_var:**U**|1+|**T** = tensor(bfloat16), tensor(double), tensor(float)<br/> **U** = tensor(bfloat16), tensor(double), tensor(float)<br/> **V** = tensor(double), tensor(float)|
