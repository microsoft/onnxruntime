...
|BeamSearch|*in* input_ids:**I**<br> *in* max_length:**I**<br> *in* min_length:**I**<br> *in* num_beams:**I**<br> *in* num_return_sequences:**I**<br> *in* temperature:**T**<br> *in* length_penalty:**T**<br> *in* repetition_penalty:**T**<br> *in* vocab_mask:**M**<br> *in* prefix_vocab_mask:**M**<br> *in* vocab_ids_len:**M**<br> *in* prefix_lens:**M**<br> *in* ecs_min_chars:**I**<br> *in* ecs_log_prob_threshold:**T**<br> *in* ecs_cost:**T**<br> *in* prefix_uppercase:**N**<br> *out* sequences:**I**<br> *out* sequences_scores:**T**<br> *out* scores:**T**|1+|**T** = tensor(float), tensor(float16)|
