...
If you are using a pre-built ONNX Runtime [iOS](../install.md#install-on-ios), [Android](../install.md#android) or [web](../install.md#web) package], the build configuration file is not used and can be ignored.
