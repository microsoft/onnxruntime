...
The onnxruntime microbench is a python tool which can be used to test operator's performance.
It is convenient to compare the performance of an oparator on different platforms with different precisions.
...
As a quickstart, you can follow the scripts [here](https://github.com/microsoft/onnxruntime/tree/main/onnxruntime/python/tools/microbench)
