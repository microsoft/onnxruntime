...
* sess_options.set_graph_optimization_level(2). Default is 1. Please see [onnxruntime_c_api.h](../include/onnxruntime/core/session/onnxruntime_c_api.h#L241)  (enum GraphOptimizationLevel) for the full list of all optimization levels. Please refer to the [Graph Optimizations Doc] (ONNX_Runtime_Graph_Optimizations.md#graph-optimizations-in-onnx-runtime) for details regarding available optimizations and usage.
