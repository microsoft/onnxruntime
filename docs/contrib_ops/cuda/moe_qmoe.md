...
- NVFP4 uses **only** the non-interleaved `ColumnMajor` layout; the opt-in Lever A interleaved path
...
H200. See [qmoe_fp4_experiments.md](qmoe_fp4_experiments.md) for the full profiling data.
