...
### <a name="com.microsoft.Attention"></a><a name="com.microsoft.attention">**com.microsoft.Attention**</a>
  ...
  When unidirectional is 1, and each token only attend to previous tokens.
  ...
  For self attention, kv_sequence_length is the input sequence_length. For cross attention, query and key might have
  different lengths.
