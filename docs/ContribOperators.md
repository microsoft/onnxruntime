...
<dd>Inout sequence used as a prompt for the generation. Can be int32 tokens (batch_size, sequence_length) or spectrogram float data (batch_size, feature_size, sequence_length)</dd>
