...
-|-|-
QNN Execution Provider | A plugin execution provider that brings Qualcomm hardware acceleration to ONNX Runtime — enabling high-performance AI inference on Qualcomm Snapdragon SoCs via the Qualcomm AI Runtime SDK (QAIRT). | https://github.com/onnxruntime/onnxruntime-qnn

## Reference

These other pages in this section provide reference material for plugin EP libraries.
