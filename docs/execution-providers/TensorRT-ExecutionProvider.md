...
| :----------- | :------- | :------------------ |
| main         | 10.14    | **12.0-12.9**       |
| 1.24         | 10.14    | **12.0-12.9**       |
| 1.23         | 10.9     | **12.0-12.8**       |
| 1.22         | 10.9     | **12.0-12.8**       |
...
* Description: control if sparsity can be used by TRT.
  * Check `--sparsity` in `trtexec` command-line flags for [details](https://docs.nvidia.com/deeplearning/tensorrt/10.x.x/reference/command-line-programs.html#commonly-used-command-line-flags).
...
* Description: set maximum number of auxiliary streams per inference stream.
  ...
  * Check `--maxAuxStreams` in `trtexec` command-line flags for [details](https://docs.nvidia.com/deeplearning/tensorrt/10.x.x/reference/command-line-programs.html#commonly-used-command-line-flags).
...
* `ORT_TENSORRT_SPARSITY_ENABLE`: Control if sparsity can be used by TRT. Default 0 = false, 1 = true. Check `--sparsity` in `trtexec` command-line flags for [details](https://docs.nvidia.com/deeplearning/tensorrt/10.x.x/reference/command-line-programs.html#commonly-used-command-line-flags).
