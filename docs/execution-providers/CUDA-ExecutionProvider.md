...
|------------------------------|--------|-----------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 1.18                         | 12.2   | 8.9.2.26 (Linux)<br/>8.9.2.26 (Windows) | The default CUDA version for ORT 1.18.To install CUDA 12 package, please look at [Install ORT](../install). Java CUDA 12 support is back for release 1.18.0                                                                           |
