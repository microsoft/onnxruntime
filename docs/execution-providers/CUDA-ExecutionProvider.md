...
Because of [Nvidia CUDA Minor Version Compatibility](https://docs.nvidia.com/deploy/cuda-compatibility/#minor-version-compatibility), ONNX Runtime built with CUDA 11.8 are compatible with any CUDA 11.x version; ONNX Runtime built with CUDA 12.8 require CUDA 12.8 or newer; ONNX Runtime built with CUDA 13.0 require CUDA 13.0 or newer.
...
Note: Starting with version 1.27, GPU packages published to [PyPI (`onnxruntime-gpu`)](https://pypi.org/project/onnxruntime-gpu/) and [NuGet (`Microsoft.ML.OnnxRuntime.Gpu`)](https://www.nuget.org/packages/Microsoft.ML.OnnxRuntime.Gpu/) are built with **CUDA 13.0** by default. Separate CUDA 12.x GPU packages for these versions are built with **CUDA 12.8** and require CUDA 12.8 or newer. Older GPU package versions are built with **CUDA 12.8** by default.
...
|---------------|-------|-------|----------------------------------------------------------------------|
| 1.30.x        | 13.0  | 9.x   | Available in PyPI and NuGet. Compatible with PyTorch for CUDA 13.x. |
...
| ONNX Runtime  | CUDA   | cuDNN | Notes                                                                |
|---------------|--------|-------|----------------------------------------------------------------------|
| 1.30.x-1.27.x | 12.8   | 9.x   | CUDA 12.x GPU packages. Requires CUDA 12.8 or newer.                 |
