...
|--------------------------|--------|-----------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 1.18                     | 12.4   | 10.0.1.6 (Linux)<br/>10.0.1.6 (Windows) | The default CUDA version for ORT 1.18.To install CUDA 12 package, please look at [Install ORT](../install). Java CUDA 12 support is back for release 1.18                                                                             |
