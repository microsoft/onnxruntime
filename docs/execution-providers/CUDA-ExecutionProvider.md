...
### enable_cuda_graph
Check [using CUDA Graphs in the CUDA EP](../performance/tune-performance.md#%28preview%29-using-cuda-graphs-in-the-cuda-ep) for details on what this flag does.
