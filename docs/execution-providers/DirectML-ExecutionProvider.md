...
The DirectML Execution Provider currently uses DirectML version [1.8.1](https://www.nuget.org/packages/Microsoft.AI.DirectML/1.8.1) and supports up to ONNX opset 12 ([ONNX v1.7](https://github.com/onnx/onnx/releases/tag/v1.7.0)). Evaluating models which require a higher opset version is unsupported and will yield poor performance.
