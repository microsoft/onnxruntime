...
|Android|[**com.microsoft.onnxruntime:onnxruntime-mobile**](https://search.maven.org/artifact/com.microsoft.onnxruntime/onnxruntime-mobile) ||[View](../tutorials/ort-format-model/initial-setup)|
|iOS (C/C++)|CocoaPods: **onnxruntime-mobile-c**||[View](../tutorials/ort-format-model/initial-setup)|
|Objective-C|CocoaPods: **onnxruntime-mobile-objc**||[View](../tutorials/ort-format-model/initial-setup)|
