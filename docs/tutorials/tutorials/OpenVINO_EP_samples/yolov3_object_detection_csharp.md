...
The source code for this sample is available [here](https://github.com/microsoft/onnxruntime/tree/master/onnxruntime-inference-examples/c_sharp/OpenVINO_EP/yolov3_object_detection).
