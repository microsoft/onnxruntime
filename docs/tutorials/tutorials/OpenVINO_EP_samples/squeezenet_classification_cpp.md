...
The source code for this sample is available [here](https://github.com/microsoft/onnxruntime/tree/master/onnxruntime-inference-examples/c_cxx/OpenVINO_EP/squeezenet_classification).
