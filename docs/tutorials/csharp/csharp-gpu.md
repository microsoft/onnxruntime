...
- Follow section [3. Installing cuDNN on Windows](https://docs.nvidia.com/deeplearning/cudnn/archives/cudnn-850/install-guide/index.html#install-windows). NOTE: Skip step 5 in section 3.3 on updating Visual Studio settings, this is only for C++ projects.
