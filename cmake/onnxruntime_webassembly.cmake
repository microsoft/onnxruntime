...
if (onnxruntime_ENABLE_WEBASSEMBLY_THREADS)
  ...
  set_property(TARGET onnxruntime_webassembly APPEND_STRING PROPERTY LINK_FLAGS " -s PTHREAD_POOL_SIZE=\"Math.min(4, Math.ceil((typeof navigator !== 'undefined' ? navigator.hardwareConcurrency : 1) / 2))\"")
else()
  if (onnxruntime_ENABLE_WEBASSEMBLY_SIMD)
