...
set(contrib_ops_excluded_files
  ...
  # decoder_attention_impl.cu is hipified (not manually maintained); the .h is kept manual
  ...
  # matmul_nbits uses the llm/fpA_intB CUTLASS path, which is NVIDIA-specific
  "quantization/matmul_nbits.cc"
  "quantization/matmul_nbits.h"
  "quantization/matmul_nbits.cuh"
  "quantization/matmul_nbits_sm90_validation.h"
  # matmul_4bits and matmul_8bits include matmul_nbits.cuh (excluded above)
  "quantization/matmul_4bits.cu"
  "quantization/matmul_8bits.cu"
  ...
  "bert/causal_conv_with_state.cc"
  "bert/causal_conv_with_state.h"
  "bert/causal_conv_with_state_impl.cu"
  "bert/causal_conv_with_state_impl.h"
  "bert/group_query_attention_qdq.cuh"
  "bert/group_query_attention_qkv.cuh"
  "bert/linear_attention.cc"
  "bert/linear_attention.h"
  "bert/linear_attention_impl.cu"
  "bert/linear_attention_impl.h"
  "bert/paged_attention.cc"
  "bert/paged_attention.h"
  "bert/paged_attention_helper.h"
  "bert/paged_attention_impl.cu"
  "bert/paged_attention_impl.h"
  # rotary_common.cuh: hipify it (uses standard CUDA intrinsics that map to HIP)
  "bert/unfused_attention.cu"
  "bert/unfused_attention.h"
  "moe/qmoe_kernels.cu"
  "moe/qmoe_kernels.h"
  "quantization/gather_block_quantized.cc"
  "quantization/gather_block_quantized.cu"
  "quantization/gather_block_quantized.cuh"
  "quantization/gather_block_quantized.h"
  "quantization/matmul_nbits_sm90_validation.h"
  "collective/custom_*"
  "collective/distributed_*"
  "collective/ipc_*"
  "collective/shard*"
  # The entire llm/ subdirectory uses NVIDIA-specific CUTLASS headers
  # and cannot be hipified for ROCm.
  "llm/*"
  # xqa/ uses SM90 WMMA/TMA/GMMA intrinsics, cuda_fp8.h, and __nv_fp8 types
  # that have no ROCm equivalent on gfx900.
  "bert/xqa/*"
)
...
set(provider_excluded_files
  ...
  "cuda_provider_interface.cc"
  "cuda_graph.cc"
  "cuda_graph.h"
  "cuda_check_memory.cc"
  "cuda_check_memory.h"
  ...
  "cuda_nhwc_kernels.h"
  "cuda_nhwc_ops.h"
  "cuda_common_type_helpers.h"
  "cuda_mempool_arena.cc"
  "cuda_mempool_arena.h"
  "cuda_type_conversion.h"
  "nn/lp_norm.cc"
  "nn/lp_norm.h"
  "nn/lp_norm_impl.cu"
  "nn/lp_norm_impl.h"
  "nn/deform_conv.cc"
  "nn/deform_conv.h"
  "nn/deform_conv_impl.cu"
  "nn/deform_conv_impl.h"
  "nn/rms_norm.cc"
  "nn/rms_norm.h"
  "ml/label_encoder.cc"
  "ml/label_encoder.h"
  "ml/label_encoder_impl.cu"
  "ml/label_encoder_impl.h"
  "llm/*"
  "plugin/*"
)
