...
target_include_directories(onnxruntime_optimizer PRIVATE ${ONNXRUNTIME_ROOT} ${eigen_INCLUDE_DIRS})
...
if(onnxruntime_USE_EIGEN_THREADPOOL)
    target_compile_definitions(onnxruntime_optimizer PUBLIC USE_EIGEN_THREADPOOL)
endif()
