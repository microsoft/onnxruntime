...
# Compiler definitions
onnxruntime_add_include_to_target(winml_adapter onnxruntime_common onnxruntime_framework onnx onnx_proto ${PROTOBUF_LIB} safeint_interface Boost::mp11)
...
onnxruntime_add_include_to_target(winml_lib_image onnx onnx_proto ${PROTOBUF_LIB} re2::re2 Boost::mp11)
...
target_link_libraries(winml_lib_api PRIVATE ${GSL_TARGET} safeint_interface Boost::mp11 onnx onnx_proto)
...
onnxruntime_add_include_to_target(winml_lib_api_experimental PRIVATE ${PROTOBUF_LIB} safeint_interface Boost::mp11 onnx onnx_proto ${GSL_TARGET})
...
target_link_libraries(winml_dll PRIVATE onnx onnx_proto ${PROTOBUF_LIB} safeint_interface Boost::mp11 ${GSL_TARGET})
