...
if (onnxruntime_ENABLE_TRAINING)
  ...
  target_include_directories(onnxruntime_util PRIVATE ${ORTTRAINING_ROOT} ${DLPACK_INCLUDE_DIR})
  target_include_directories(onnxruntime_util PRIVATE ${ORTTRAINING_ROOT} ${PYTHON_INCLUDE_DIR})
  target_link_libraries(onnxruntime_util PRIVATE ${PYTHON_LIBRARIES})
endif()
