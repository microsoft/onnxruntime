    ...
    if(ARM64 AND MLAS_SOURCE_IS_NOT_SET )
        ...
        if (onnxruntime_USE_SVE)
          ...
          if (onnxruntime_SVE_QGEMM_ASM)
            ...
            set_source_files_properties(${MLAS_SRC_DIR}/sve/qgemm_mmla_sve_impl.cpp PROPERTIES COMPILE_FLAGS " -march=armv8.2-a+sve+i8mm -fno-stack-protector ${ORT_SVE_ABI_FLAGS} -DMLAS_SVE_QGEMM_TILE_12X8=1 -DMLAS_SVE_QGEMM_TILE_8X12=1 ")
          endif()
          list(APPEND mlas_private_compile_definitions MLAS_USE_SVE)
        endif()
