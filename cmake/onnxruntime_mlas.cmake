  ...
  setup_mlas_source_for_windows()
    ...
    if(ARM64 AND MLAS_SOURCE_IS_NOT_SET )
        ...
        if (onnxruntime_USE_SVE)
          ...
          option(onnxruntime_SVE_SGEMM_ASM
                 "Build the portable machine-code SVE SGEMM kernels instead of the intrinsics reference" ON)
          if (onnxruntime_SVE_SGEMM_ASM)
            list(APPEND mlas_platform_srcs ${MLAS_SRC_DIR}/aarch64/sgemm_sve_asm.S)
          else()
