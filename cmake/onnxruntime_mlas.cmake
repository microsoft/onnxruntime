    ...
    if(ARM64 AND MLAS_SOURCE_IS_NOT_SET )
        ...
        if (onnxruntime_USE_SVE)
          ...
          if (onnxruntime_SVE_LINEAR_ATTENTION_ASM)
            ...
            set_source_files_properties(${MLAS_SRC_DIR}/sve/linear_attention_sve_impl.cpp PROPERTIES COMPILE_FLAGS " -march=armv8.2-a+sve -fno-stack-protector -fno-jump-tables ${ORT_SVE_ABI_FLAGS} ")
          endif()
          list(APPEND mlas_private_compile_definitions MLAS_USE_SVE)
        endif()
