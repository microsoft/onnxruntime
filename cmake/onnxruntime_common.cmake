...
if (onnxruntime_USE_MIMALLOC)
    ...
    elseif ((${CMAKE_CXX_COMPILER_ID} MATCHES "GNU") AND (${CMAKE_CXX_COMPILER_VERSION} MATCHES "^([0-3](\..*)|4(\.[0-8].*))?$"))
        message(WARNING "Ignoring request to link to mimalloc - GNU toolchain versions < 4.9 is missing required C++11 atomic support")
    else()
