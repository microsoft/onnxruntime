...
if (CMAKE_SYSTEM_NAME STREQUAL "Emscripten")
  ...
  if (onnxruntime_ENABLE_WEBASSEMBLY_THREADS)
    set_property(TARGET onnxruntime_test_all APPEND_STRING PROPERTY LINK_FLAGS " -s DEFAULT_PTHREAD_STACK_SIZE=524288 -s PROXY_TO_PTHREAD=1 -s PTHREAD_POOL_SIZE=16")
  endif()
  if (onnxruntime_USE_JSEP)
