...
add_executable(onnxruntime_nnapi_test ${TEST_SRC_DIR}/providers/nnapi/test.cpp)
add_dependencies(onnxruntime_nnapi_test ${onnxruntime_test_providers_dependencies})
target_link_libraries(onnxruntime_nnapi_test PRIVATE ${onnxruntime_test_providers_libs} ${onnxruntime_EXTERNAL_LIBRARIES})
set_target_properties(onnxruntime_nnapi_test PROPERTIES FOLDER "ONNXRuntimeTest")
target_include_directories(onnxruntime_nnapi_test PRIVATE ${TEST_INC_DIR})
onnxruntime_add_include_to_target(onnxruntime_nnapi_test date_interface gsl)
