...
target_include_directories(custom_op_library ${REPO_ROOT}/include)
if(UNIX)
  if (APPLE)
    set(ONNXRUNTIME_SO_LINK_FLAG "-Xlinker -dead_strip")
  else()
    set(ONNXRUNTIME_SO_LINK_FLAG "-Xlinker --no-undefined -Xlinker --gc-sections")
  endif()
else()
  set(ONNXRUNTIME_SO_LINK_FLAG "-DEF:${REPO_ROOT}/onnxruntime/test/testdata/custom_op_library/custom_op_library.def")
endif()
target_link_libraries(custom_op_library ${CMAKE_CURRENT_BINARY_DIR}/onnxruntime)
