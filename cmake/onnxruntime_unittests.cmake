...
if(WIN32)
  ...
  if(NOT ${CMAKE_GENERATOR_PLATFORM} MATCHES "ARM")
    ...
    set_property(TARGET onnx_test_runner_vstest APPEND_STRING PROPERTY LINK_FLAGS " /INCREMENTAL:NO /OPT:NOREF /PROFILE")
    set_target_properties(onnx_test_runner_vstest PROPERTIES FOLDER "ONNXRuntimeTest")
  endif()
endif()
