...
# create a lib for folder onnxruntime/test/framework
add_library(onnxruntime_framework_test_utils_lib "${TEST_SRC_DIR}/framework/test_utils.cc")
target_include_directories(onnxruntime_framework_test_utils_lib PUBLIC ${ONNXRUNTIME_ROOT} ${eigen_INCLUDE_DIRS} ${extra_includes} ${onnxruntime_graph_header} ${onnxruntime_exec_src_dir} ${CMAKE_CURRENT_BINARY_DIR} ${CMAKE_CURRENT_BINARY_DIR}/onnx ${TEST_SRC_DIR}/util/include)
onnxruntime_add_include_to_target(onnxruntime_framework_test_utils_lib gsl onnx gtest gmock date)

set(training_test_src_dir ${ONNXRUNTIME_ROOT}/test/training)
add_executable(training_poc ${training_test_src_dir}/poc/main.cc)
onnxruntime_add_include_to_target(training_poc gsl)
target_include_directories(training_poc PUBLIC ${ONNXRUNTIME_ROOT} ${eigen_INCLUDE_DIRS} ${extra_includes} ${onnxruntime_graph_header} ${onnxruntime_exec_src_dir} ${CMAKE_CURRENT_BINARY_DIR} ${CMAKE_CURRENT_BINARY_DIR}/onnx)
target_link_libraries(training_poc PRIVATE onnxruntime_framework_test_utils_lib ${onnx_test_libs})
set_target_properties(training_poc PROPERTIES FOLDER "training_poc")
