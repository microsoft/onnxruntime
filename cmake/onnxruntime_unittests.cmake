...
function(AddTest)
  ...
  if (WIN32)
    ...
    target_compile_options(${_UT_TARGET} PRIVATE "$<$<COMPILE_LANGUAGE:CUDA>:SHELL:-Xcompiler -Wno-error=sign-compare -Wno-error=uninitialized>"
            "$<$<NOT:$<COMPILE_LANGUAGE:CUDA>>:-Wno-error=sign-compare -Wno-error=uninitialized>")
  endif()
