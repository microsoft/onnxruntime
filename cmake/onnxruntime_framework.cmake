...
if (onnxruntime_DEBUG_NODE_INPUTS_OUTPUTS)
  ...
  if (onnxruntime_ENABLE_SQL)
    find_package (SQLite3)
    if (SQLITE3_FOUND)
      include_directories(${SQLITE3_INCLUDE_DIRS})
      target_link_libraries (onnxruntime_framework ${SQLITE3_LIBRARIES})
    else()
      message( FATAL_ERROR "Could not locate SQLite3 package." )
    endif (SQLITE3_FOUND)
    target_compile_definitions(onnxruntime_framework PRIVATE ENABLE_SQL)
  endif()
endif()
