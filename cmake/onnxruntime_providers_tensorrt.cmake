...
# Licensed under the MIT License.
  ...
  if (onnxruntime_USE_TENSORRT_BUILTIN_PARSER)
    ...
    if (WIN32)
      ...
      set(VERSION_TO_APPEND "_${NV_TENSORRT_MAJOR}")
      MESSAGE(STATUS "Find NV_TENSORRT_MAJOR is ${NV_TENSORRT_MAJOR}")
    else()
      set(VERSION_TO_APPEND "")
    endif()

    find_library(TENSORRT_LIBRARY_INFER "nvinfer${VERSION_TO_APPEND}"
      HINTS ${TENSORRT_ROOT}
      PATH_SUFFIXES lib lib64 lib/x64)
    find_library(TENSORRT_LIBRARY_INFER_PLUGIN "nvinfer_plugin${VERSION_TO_APPEND}"
      HINTS  ${TENSORRT_ROOT}
      PATH_SUFFIXES lib lib64 lib/x64)
    find_library(TENSORRT_LIBRARY_NVONNXPARSER "nvonnxparser${VERSION_TO_APPEND}"
      HINTS  ${TENSORRT_ROOT}
      PATH_SUFFIXES lib lib64 lib/x64)
