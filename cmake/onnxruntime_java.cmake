...
if (CMAKE_SYSTEM_NAME STREQUAL "Android")
  ...
  if (onnxruntime_BUILD_UNIT_TESTS)
    ...
    add_custom_command(TARGET onnxruntime4j_jni POST_BUILD COMMAND ${GRADLE_EXECUTABLE} assembleDebug assembleDebugAndroidTest spotlessApply WORKING_DIRECTORY ${ANDROID_TEST_PACKAGE_DIR})
  endif()
endif()
