...
#include_directories(AFTER SYSTEM "C:\\libs\\zlib\\include")
...
message("TRITON_ROOT: " ${TRITON_ROOT})
target_include_directories(onnxruntime_providers PRIVATE ${TRITON_ROOT}/include)
link_directories(${TRITON_ROOT}/lib ${CURL_ROOT}/lib ${ZLIB_ROOT}/lib)
target_link_libraries(onnxruntime_providers PRIVATE httpclient_static Ws2_32 zlib libcurl)
