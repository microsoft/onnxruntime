...
if (onnxruntime_USE_TENSORRT)
  ...
  target_link_libraries(onnxruntime_providers_tensorrt PRIVATE ${onnxparser_link_libs} ${trt_link_libs} ${ONNXRUNTIME_CUDA_LIBRARIES} onnxruntime_providers_shared protobuf::libprotobuf)
