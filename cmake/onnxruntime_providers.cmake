...
if (onnxruntime_USE_TENSORRT)
  ...
  if (WIN32)
    ...
    set(trt_link_libs cudnn ${CMAKE_DL_LIBS} ${TENSORRT_LIBRARY} cudart)
  else()
  ...
  target_link_libraries(onnxruntime_providers_tensorrt PRIVATE ${onnxparser_link_libs} ${trt_link_libs} onnxruntime_providers_shared protobuf::libprotobuf)
