...
include(${REPO_ROOT}/cmake/onnxruntime_providers_cpu.cmake)
if (onnxruntime_USE_CUDA)
  include(${REPO_ROOT}/cmake/onnxruntime_providers_cuda.cmake)
endif()

if (onnxruntime_USE_DNNL)
  include(${REPO_ROOT}/cmake/onnxruntime_providers_dnnl.cmake)
endif()

if (onnxruntime_USE_TENSORRT)
  include(${REPO_ROOT}/cmake/onnxruntime_providers_tensorrt.cmake)
endif()

if (onnxruntime_USE_VITISAI)
  include(${REPO_ROOT}/cmake/onnxruntime_providers_vitisai.cmake)
endif()

if (onnxruntime_USE_OPENVINO)
  include(${REPO_ROOT}/cmake/onnxruntime_providers_openvino.cmake)
endif()

if (onnxruntime_USE_COREML)
  include(${REPO_ROOT}/cmake/onnxruntime_providers_coreml.cmake)
endif()

if (onnxruntime_USE_WEBNN)
  include(${REPO_ROOT}/cmake/onnxruntime_providers_webnn.cmake)
endif()

if (onnxruntime_USE_NNAPI_BUILTIN)
  include(${REPO_ROOT}/cmake/onnxruntime_providers_nnapi.cmake)
endif()

if (onnxruntime_USE_JSEP)
  include(${REPO_ROOT}/cmake/onnxruntime_providers_js.cmake)
endif()

if (onnxruntime_USE_QNN)
  include(${REPO_ROOT}/cmake/onnxruntime_providers_qnn.cmake)
endif()

if (onnxruntime_USE_RKNPU)
  include(${REPO_ROOT}/cmake/onnxruntime_providers_rknpu.cmake)
endif()

if (onnxruntime_USE_DML)
  include(${REPO_ROOT}/cmake/onnxruntime_providers_dml.cmake)
endif()

if (onnxruntime_USE_MIGRAPHX)
  include(${REPO_ROOT}/cmake/onnxruntime_providers_migraphx.cmake)
endif()

if (onnxruntime_USE_ACL)
  include(${REPO_ROOT}/cmake/onnxruntime_providers_acl.cmake)
endif()

if (onnxruntime_USE_ARMNN)
  include(${REPO_ROOT}/cmake/onnxruntime_providers_armnn.cmake)
endif()

if (onnxruntime_USE_ROCM)
  include(${REPO_ROOT}/cmake/onnxruntime_providers_rocm.cmake)
endif()

if (onnxruntime_USE_TVM)
  include(${REPO_ROOT}/cmake/onnxruntime_providers_tvm.cmake)
endif()

if (onnxruntime_USE_VSINPU)
  include(${REPO_ROOT}/cmake/onnxruntime_providers_vsinpu.cmake)
endif()

if (onnxruntime_USE_XNNPACK)
  include(${REPO_ROOT}/cmake/onnxruntime_providers_xnnpack.cmake)
endif()

if (onnxruntime_USE_CANN)
  include(${REPO_ROOT}/cmake/onnxruntime_providers_cann.cmake)
endif()

if (onnxruntime_USE_AZURE)
  include(${REPO_ROOT}/cmake/onnxruntime_providers_azure.cmake)
endif()
