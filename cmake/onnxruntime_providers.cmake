...
if (onnxruntime_USE_MKLDNN)
  ...
  target_link_libraries(onnxruntime_providers_mkldnn PRIVATE mkldnn)
  target_link_directories(onnxruntime_providers_mkldnn PRIVATE ${MKLDNN_LIB_DIR})
  ...
  if(WIN32)
    set_property(TARGET onnxruntime_providers_mkldnn APPEND_STRING PROPERTY LINK_FLAGS "-DEF:${ONNXRUNTIME_ROOT}/core/providers/mkldnn/symbols.def")
  endif()
endif()
