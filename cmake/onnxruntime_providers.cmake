...
onnxruntime_add_include_to_target(onnxruntime_providers onnxruntime_framework gsl onnx onnx_proto protobuf::libprotobuf)
target_include_directories(onnxruntime_providers PRIVATE ${ONNXRUNTIME_ROOT} ${eigen_INCLUDE_DIRS} ${gemmlowp_src})
...
if (onnxruntime_USE_CUDA)
  ...
  onnxruntime_add_include_to_target(onnxruntime_providers_cuda onnxruntime_framework gsl onnx onnx_proto protobuf::libprotobuf)
...
if (onnxruntime_USE_MKLDNN)
  ...
  onnxruntime_add_include_to_target(onnxruntime_providers_mkldnn gsl onnxruntime_framework gsl onnx onnx_proto protobuf::libprotobuf)
