...
if (onnxruntime_USE_OPENCL)
  ...
  target_include_directories(onnxruntime_providers_opencl PUBLIC ${PROJECT_SOURCE_DIR}/external/tracy)
  if(onnxruntime_ENABLE_TRACY)
    add_subdirectory(external/tracy EXCLUDE_FROM_ALL)
    # target_compile_definitions(onnxruntime_providers_opencl PUBLIC TRACY_ENABLE)
