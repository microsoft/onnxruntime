...
if (NOT onnxruntime_MINIMAL_BUILD AND NOT onnxruntime_EXTENDED_MINIMAL_BUILD
  ...
  elseif(WIN32)
  set_property(TARGET onnxruntime_providers_shared APPEND_STRING PROPERTY LINK_FLAGS "-DEF:${ONNXRUNTIME_ROOT}/core/providers/shared/symbols.def -CETCOMPAT")
...
if (onnxruntime_USE_CUDA)
  ...
  target_link_libraries(onnxruntime_providers_cuda PRIVATE cublas cudnn curand cufft absl::throw_delegate ${ONNXRUNTIME_PROVIDERS_SHARED})
  ...
  elseif(UNIX)
    ...
    target_link_libraries(onnxruntime_providers_cuda PRIVATE nsync_cpp)
  elseif(WIN32)
    set_property(TARGET onnxruntime_providers_cuda APPEND_STRING PROPERTY LINK_FLAGS "-DEF:${ONNXRUNTIME_ROOT}/core/providers/cuda/symbols.def -CETCOMPAT")
  else()
...
if (onnxruntime_USE_TENSORRT)
  ...
  elseif(WIN32)
    set_property(TARGET onnxruntime_providers_tensorrt APPEND_STRING PROPERTY LINK_FLAGS "-DEF:${ONNXRUNTIME_ROOT}/core/providers/tensorrt/symbols.def -CETCOMPAT")
  else()
...
if (onnxruntime_USE_ROCM)
  ...
  target_link_libraries(onnxruntime_providers_rocm PRIVATE ${ONNXRUNTIME_ROCM_LIBS} ${ONNXRUNTIME_PROVIDERS_SHARED} absl::throw_delegate)
