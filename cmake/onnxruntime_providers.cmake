...
set(cub_src ${ONNXRUNTIME_ROOT}/../cmake/external/cub)
...
if (onnxruntime_USE_CUDA)
  ...
  target_include_directories(onnxruntime_providers_cuda PRIVATE ${ONNXRUNTIME_ROOT} ${onnxruntime_CUDNN_HOME}/include ${eigen_INCLUDE_DIRS} ${cub_src} ${TVM_INCLUDES} PUBLIC ${CMAKE_CUDA_TOOLKIT_INCLUDE_DIRECTORIES})
