...
if (onnxruntime_USE_FEATURIZERS)
  ...
  target_link_libraries(onnxruntime_providers PRIVATE onnxruntime_featurizers)
endif()
...
if (onnxruntime_USE_TENSORRT)
  ...
  target_link_libraries(onnxruntime_providers_tensorrt PRIVATE ${onnxparser_link_libs} ${trt_link_libs})
...
if (onnxruntime_USE_OPENVINO)
  ...
  if (WIN32)
   ...
   if (WIN32)
     ...
     target_link_libraries(onnxruntime_providers_openvino PRIVATE $ENV{INTEL_CVSDK_DIR}/deployment_tools/inference_engine/lib/intel64/Release/inference_engine.lib IE::ie_cpu_extension ${PYTHON_LIBRARIES})
...
if (onnxruntime_USE_NNAPI)
  ...
  target_link_libraries(onnxruntime_providers_nnapi PRIVATE dnnlibrary::dnnlibrary)
