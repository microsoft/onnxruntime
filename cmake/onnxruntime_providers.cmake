...
if (onnxruntime_USE_INTEL)
  ...
  if (onnxruntime_USE_OPENVINO_BINARY)
    set(OPENVINO_INCLUDE_DIR $ENV{INTEL_CVSDK_DIR}/inference-engine/include)
    ...
    set(OPENVINO_LIB_DIR $ENV{INTEL_CVSDK_DIR}/bin/intel64/${CMAKE_BUILD_TYPE}/lib)
    set(OPENVINO_NGRAPH_LIB_DIR $ENV{INTEL_CVSDK_DIR}/bin/intel64/${CMAKE_BUILD_TYPE}/lib)
