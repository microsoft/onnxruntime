...
if (onnxruntime_USE_RKNPU)
  ...
  option(DNN_CMAKE_INSTALL "" OFF)
  option(DNN_BUILD_BIN "" OFF)
  set(RKNPU_DDK_INCLUDE_DIR ${REPO_ROOT}/cmake/external/rknpu_ddk/include)
  if (CMAKE_SIZEOF_VOID_P EQUAL 8)
    set(RKNPU_DDK_LIB_DIR ${REPO_ROOT}/cmake/external/rknpu_ddk/lib64)
  else()
    set(RKNPU_DDK_LIB_DIR ${REPO_ROOT}/cmake/external/rknpu_ddk/lib)
  endif()
  file(GLOB_RECURSE
