...
if (onnxruntime_USE_INTEL)
  ...
  if (onnxruntime_USE_OPENVINO_BINARY)
    ...
    set(OPENVINO_NGRAPH_INCLUDE_DIR $ENV{INTEL_CVSDK_DIR}/include)
    set(OPENVINO_TBB_INCLUDE_DIR $ENV{INTEL_CVSDK_DIR}/deployment_tools/inference_engine/external/tbb/include)
    set(OPENVINO_MKL_TINY_INCLUDE_DIR $ENV{INTEL_CVSDK_DIR}/deployment_tools/inference_engine/external/mkltiny_lnx/include)
    set(OPENVINO_LIB_DIR $ENV{INTEL_CVSDK_DIR}/deployment_tools/inference_engine/lib/intel64)
    set(OPENVINO_NGRAPH_LIB_DIR $ENV{INTEL_CVSDK_DIR}/lib)
    set(OPENVINO_TBB_LIB_DIR $ENV{INTEL_CVSDK_DIR}/deployment_tools/inference_engine/external/tbb/lib)
    set(OPENVINO_MKL_TINY_LIB_DIR $ENV{INTEL_CVSDK_DIR}/deployment_tools/inference_engine/external/mkltiny_lnx/lib)
  endif()
