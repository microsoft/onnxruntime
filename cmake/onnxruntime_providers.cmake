...
#  include_directories("${CMAKE_CURRENT_BINARY_DIR}/onnx")
  ...
  if ((DEFINED ENV{OPENCL_LIBS}) AND (DEFINED ENV{OPENCL_INCS}))
    ...
    list(APPEND OPENVINO_LIB_LIST $ENV{OPENCL_LIBS} openvino::frontend::onnx openvino::runtime ${InferenceEngine_LIBRARIES} ${NGRAPH_LIBRARIES} ngraph::onnx_importer ${PYTHON_LIBRARIES})
  else()
    list(APPEND OPENVINO_LIB_LIST openvino::frontend::onnx openvino::runtime ${InferenceEngine_LIBRARIES} ${NGRAPH_LIBRARIES} ngraph::onnx_importer ${PYTHON_LIBRARIES})
  endif()
