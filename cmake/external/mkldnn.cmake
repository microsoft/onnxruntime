...
if(WIN32)
  ...
  set(MKLDNN_SHARED_LIB "${MKLDNN_LIB_DIR}/mkldnn.dll")
  set(MKLDNN_IMPORT_LIB "${MKLDNN_LIB_DIR}/mkldnn.lib")
  ...
  if (APPLE)
    set(MKLDNN_SHARED_LIB "${MKLDNN_LIB_DIR}/libmkldnn.0.dylib")
    set(MKLML_OS_VERSION_STR "mac")
  else()
    set(MKLDNN_SHARED_LIB "${MKLDNN_LIB_DIR}/libmkldnn.so.0")
...
if (onnxruntime_USE_MKLDNN)
  if (WIN32)
    ...
    set(MKLDNN_LIB ${MKLDNN_IMPORT_LIB})
  else()
    add_library(mkldnn SHARED IMPORTED)
    set(MKLDNN_LIB ${MKLDNN_SHARED_LIB})
  endif()
