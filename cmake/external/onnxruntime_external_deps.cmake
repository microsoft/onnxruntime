...
if (NOT onnxruntime_MINIMAL_BUILD)
  ...
  if (ONNX_FOUND)
    message("Use onnx from preinstalled system lib")
    foreach(_expectedTarget onnx onnx_proto)
      if (NOT TARGET ${_expectedTarget})
        message(FATAL_ERROR "ONNX installation is missing expected target ${_expectedTarget}.")
      endif()
    endforeach()
  else()
    message("Use onnx from submodule")
...
if (NOT DEFINED ONNX_FOUND OR NOT ONNX_FOUND)
