  ...
  if(CMAKE_CUDA_COMPILER)
    ...
    if(NOT WIN32) # Linux
      execute_process(
        COMMAND
          "bash" "-c"
          "${CMAKE_CUDA_COMPILER} --version | grep -E -o 'V[0-9]+.[0-9]+.[0-9]+' | cut -c2-"
...
macro(setup_cuda_architectures)
  ...
  elseif(CMAKE_CUDA_ARCHITECTURES STREQUAL "all")
    ...
    message(
      STATUS
        "Setting CMAKE_CUDA_ARCHITECTURES to all enables a list of architectures OnnxRuntime optimized for, "
        "not all architectures CUDA compiler supports.")
  elseif(CMAKE_CUDA_ARCHITECTURES STREQUAL "all-major")
    unset(CMAKE_CUDA_ARCHITECTURES)
    message(
      STATUS
        "Setting CMAKE_CUDA_ARCHITECTURES to all-major enables a list of architectures OnnxRuntime optimized for, "
