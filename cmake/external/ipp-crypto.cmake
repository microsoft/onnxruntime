...
if (WIN32)
  set(IPP_CRYPTO_DLL_NAME ippcp.dll)
  set_target_properties(ippcp_s PROPERTIES
    IMPORTED_IMPLIB "${IPP_CRYPTO_LIB_DIR}/ippcp.lib"
    IMPORTED_LOCATION "${IPP_CRYPTO_LIB_DIR}/${IPP_CRYPTO_DLL_NAME}"
    IMPORTED_IMPLIB_${IPP_CRYPTO_CONFIG_TYPE} "${IPP_CRYPTO_LIB_DIR}/ippcp.lib"
    IMPORTED_LOCATION_${IPP_CRYPTO_CONFIG_TYPE} "${IPP_CRYPTO_LIB_DIR}/${IPP_CRYPTO_DLL_NAME}"
  )
else()
  set(IPP_CRYPTO_DLL_NAME ${CMAKE_SHARED_LIBRARY_PREFIX}ippcp${CMAKE_SHARED_LIBRARY_SUFFIX})
  set(IPP_CRYPTO_LIB_PATH "${IPP_CRYPTO_LIB_DIR}/${IPP_CRYPTO_DLL_NAME}")
  set_target_properties(ippcp_s PROPERTIES
