...
if(onnxruntime_USE_DNNL AND ((onnxruntime_DNNL_THREAD STREQUAL "eigen") OR (onnxruntime_DNNL_THREAD STREQUAL "ort")))
  message(STATUS "dnnl is set to use a custom threadpool thread")
  set(DNNL_THREAD_CMAKE_ARGS "-DDNNL_CPU_RUNTIME=THREADPOOL")
else()
  message(STATUS "dnnl is set to use openmp")
endif()
...
if (onnxruntime_USE_DNNL)
  ...
  ExternalProject_Add(project_dnnl
    ...
    CMAKE_ARGS -DDNNL_BUILD_TESTS=OFF -DDNNL_ENABLE_CONCURRENT_EXEC=ON -DDNNL_BUILD_EXAMPLES=OFF -DCMAKE_BUILD_TYPE=${CMAKE_BUILD_TYPE} -DCMAKE_INSTALL_PREFIX=${DNNL_INSTALL} ${DNNL_GPU_CMAKE_ARGS} ${DNNL_THREAD_CMAKE_ARGS}  )
