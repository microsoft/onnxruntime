...
if(WIN32)
  ...
  if (APPLE)
    set(DNNL_SHARED_LIB libmkldnn.1.dylib)
    set(MKLML_OS_VERSION_STR "mac")
  else()
    set(DNNL_SHARED_LIB libmkldnn.so.1)
...
if (onnxruntime_USE_MKLML)
  ...
  set(MKML_DIR ${CMAKE_CURRENT_BINARY_DIR}/mklml/src/project_dnnl)
...
if (onnxruntime_USE_DNNL)
  ...
  ExternalProject_Add(project_dnnl
    ...
    CMAKE_ARGS -DDNNL_PRODUCT_BUILD_MODE=OFF -DCMAKE_BUILD_TYPE=${CMAKE_BUILD_TYPE} -DCMAKE_INSTALL_PREFIX=${LDNNL_INSTALL} -DMKLROOT=${MKML_DIR} ${DNNL_CMAKE_EXTRA_ARGS}
  )
  link_directories(${DNNL_LIB_DIR})
  if (onnxruntime_USE_MKLML)
    add_dependencies(project_dnnl project_dnnl)
  endif()
endif()
