...
# Licensed under the MIT License.
  ...
  list(REMOVE_ITEM onnxruntime_providers_qnn_abi_ep_srcs
       "${ONNXRUNTIME_ROOT}/core/providers/qnn-abi/qnn_provider_factory.h"
       "${ONNXRUNTIME_ROOT}/core/providers/qnn-abi/qnn_provider_factory.cc")
  ...
  onnxruntime_add_include_to_target(onnxruntime_providers_qnn_abi_simulation ${GSL_TARGET}
                                                                            safeint_interface
                                                                             nlohmann_json::nlohmann_json)
  target_link_libraries(onnxruntime_providers_qnn_abi_simulation PRIVATE ${ABSEIL_LIBS} ${CMAKE_DL_LIBS})

  add_dependencies(onnxruntime_providers_qnn_abi_simulation ${onnxruntime_EXTERNAL_DEPENDENCIES})
