...
# Licensed under the MIT License.
  ...
  if(onnxruntime_BUILD_WEBGPU_EP_STATIC_LIB)
    ...
    if(WIN32)
      ...
      list(APPEND onnxruntime_providers_webgpu_cc_srcs "${ONNXRUNTIME_ROOT}/core/providers/webgpu/onnxruntime_providers_webgpu.rc")
    endif()
    source_group(TREE ${ONNXRUNTIME_ROOT} FILES ${onnxruntime_providers_webgpu_cc_srcs})

    onnxruntime_add_shared_library_module(onnxruntime_providers_webgpu ${onnxruntime_providers_webgpu_cc_srcs})
    target_include_directories(onnxruntime_providers_webgpu PRIVATE ${REPO_ROOT}/include/onnxruntime/core/session
                                                                    ${GSL_TARGET}
                                                                    onnx
                                                                    Boost::mp11
                                                                    safeint_interface)
