 ...
 *
 * <p> Check {@link #isPresent()} first, if the value is not present many of the methods throw {@link IllegalStateException}.
 * <p> The {@link #getValue()} method returns the appropriate Onnx type which can be further inspected.
 */
