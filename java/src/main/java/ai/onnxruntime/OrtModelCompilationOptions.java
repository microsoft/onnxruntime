...
public final class OrtModelCompilationOptions implements AutoCloseable {
  ...
  public enum OrtCompileApiFlags implements OrtFlags {
    ...
    /**
     * Save a fully-optimized plain ONNX model instead of an EPContext model. The graph optimization
     * level defaults to ORT_ENABLE_ALL (MaxLevel) when this flag is set. The output contains no
     * EPContext nodes and can be reloaded for inference with ORT_DISABLE_ALL.
     */
