...
class ModelZooTests(unittest.TestCase):
    ...
    def __test_model(self, model_path, data_paths):
        ...
        pb_request_headers = {"Content-Type": "application/octet-stream", "Accept": "application/octet-stream"}
        ...
        try:
            ...
            for fname in os.listdir(model_path):
                if (
                    ...
                    and os.path.isfile(os.path.join(model_path, fname))
                ):
            ...
            server_app_proc = test_util.launch_server_app(
                cmd, self.server_ip, self.server_port, self.server_ready_in_seconds
            )
            ...
            if os.path.isdir(test_data_folder):
                for name in os.listdir(test_data_folder):
                    ...
                    if os.path.isdir(os.path.join(test_data_folder, name)):
                        ...
                        model_data_map[os.path.join(model_file_folder, name)] = [
