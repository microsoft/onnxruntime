...
class IExecutionProvider {
  ...
  */
   ...
   */
  virtual int GenerateMetaDefId(const onnxruntime::GraphViewer& graph_viewer, uint64_t& model_hash, bool enhancive_hashing_enable=false) const;
 ...
 private:
  ...
  class ModelMetadefIdGenerator {
   public:
    int GenerateId(const onnxruntime::GraphViewer& graph_viewer, uint64_t& model_hash, bool enhancive_hashing_enable);
