...
// We run SubgraphMemcpyMinimizer
...
static const char* kOrtLoopSubgraphCpuFallbackOptimizerNonCpuToCpuProviderRatio = "session.loop_subgraph_cpu_fallback_optimizer_min_nocpu_cpu_ratio";
