...
/// <summary>
/// Provides maximum input shape overrides for workspace estimation in dynamic-shape models.
/// When set, the framework uses these shapes as upper bounds for workspace pre-computation
