...
// Enable or disable using device allocator for allocating initialized tensor memory. "1": enable; "0": disable.
// The default is "0". Using device allocators means the memory allocation is made using malloc/new.
