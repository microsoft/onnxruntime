...
inline Env& Env::SetPerSessionThreadPoolCallbacks(OrtThreadPoolWorkEnqueueFn on_enqueue,
                                                  OrtThreadPoolWorkStartFn on_start,
                                                  OrtThreadPoolWorkStopFn on_stop,
                                                  OrtThreadPoolWorkAbandonFn on_abandon,
                                                  void* user_context) {
  ThrowOnError(GetApi().SetPerSessionThreadPoolCallbacks(p_, on_enqueue, on_start, on_stop, on_abandon, user_context));
  return *this;
}
