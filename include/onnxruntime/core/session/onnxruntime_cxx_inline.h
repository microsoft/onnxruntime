...
template <typename T>
inline ModelCompilationOptionsImpl<T>& ModelCompilationOptionsImpl<T>::SetInputModelPath(
    const ORTCHAR_T* input_model_path) {
  Ort::ThrowOnError(GetApi().ModelCompilationOptions_SetInputModelPath(this->p_, input_model_path));
  return *this;
}

template <typename T>
inline ModelCompilationOptionsImpl<T>& ModelCompilationOptionsImpl<T>::SetInputModelFromBuffer(
    const void* input_model_data, size_t input_model_data_size) {
  Ort::ThrowOnError(GetApi().ModelCompilationOptions_SetInputModelFromBuffer(this->p_, input_model_data,
                                                                             input_model_data_size));
  return *this;
}

template <typename T>
inline ModelCompilationOptionsImpl<T>& ModelCompilationOptionsImpl<T>::SetOutputModelPath(
    const ORTCHAR_T* output_model_path) {
  Ort::ThrowOnError(GetApi().ModelCompilationOptions_SetOutputModelPath(this->p_, output_model_path));
  return *this;
}

template <typename T>
inline ModelCompilationOptionsImpl<T>& ModelCompilationOptionsImpl<T>::SetOutputModelExternalInitializersFile(
    const ORTCHAR_T* file_path, size_t initializer_size_threshold) {
  Ort::ThrowOnError(GetApi().ModelCompilationOptions_SetOutputModelExternalInitializersFile(
      this->p_,
      file_path,
...
template <typename T>
inline ModelCompilationOptionsImpl<T>& ModelCompilationOptionsImpl<T>::SetOutputModelBuffer(
    OrtAllocator* allocator, void** output_model_buffer_ptr, size_t* output_model_buffer_size_ptr) {
  Ort::ThrowOnError(GetApi().ModelCompilationOptions_SetOutputModelBuffer(this->p_, allocator,
...
template <typename T>
inline ModelCompilationOptionsImpl<T>& ModelCompilationOptionsImpl<T>::SetEpContextEmbedMode(
    bool embed_ep_context_in_model) {
  Ort::ThrowOnError(GetApi().ModelCompilationOptions_SetEpContextEmbedMode(
      this->p_,
...
inline ModelCompilationOptions::ModelCompilationOptions(const Env& env) {
  ThrowOnError(GetApi().CreateModelCompilationOptions(env, &this->p_));
}

inline ModelCompilationOptions::ModelCompilationOptions(const Env& env, SessionOptions& session_options) {
  ThrowOnError(GetApi().CreateModelCompilationOptionsFromSessionOptions(env, session_options, &this->p_));
}

inline Status CompileModel(const Env& env, ConstModelCompilationOptions model_compilation_options) {
  return Ort::Status(GetApi().CompileModel(env, model_compilation_options));
}
