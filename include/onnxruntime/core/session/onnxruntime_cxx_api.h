...
struct SessionOptionsImpl : ConstSessionOptionsImpl<T> {
  ...
  ///< Wraps OrtApi::SessionOptionsAppendExecutionProvider_WebGPU
  SessionOptionsImpl& AppendExecutionProvider_WebGPU(const OrtWebGPUProviderOptions& webgpu_options,
