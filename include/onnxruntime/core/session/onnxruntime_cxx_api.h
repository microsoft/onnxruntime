...
struct SessionOptionsImpl : ConstSessionOptionsImpl<T> {
  ...
  SessionOptionsImpl& AddExternalInitializersFromFilesInMemory(const std::vector<std::basic_string<ORTCHAR_T>>& file_names,
                                                               const std::vector<void*>& buffer_array,
                                                               const std::vector<size_t>& length);  ///< Wraps OrtApi::AddExternalInitializersFromFilesInMemory
