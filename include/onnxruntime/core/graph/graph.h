...
class Graph {
  ...
  */
  ...
  /** Add an initializer tensor to the Graph. 
    ...
    If false, a NodeArg is created ONLY if the graph is not loaded from a model file and a NodeArg
    with the same name as the initialized tensor_proto does not exist.
  */
