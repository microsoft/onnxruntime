...
As of May 2019, ONNX Runtime supports ONNX 1.5. For ONNX Runtime and ONNX versioning compatibility, see [this table](https://github.com/Microsoft/onnxruntime/blob/master/docs/Versioning.md#version-matrix).
