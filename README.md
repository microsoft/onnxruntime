...
|---|---|---|---|
|<ul><li>Default CPU - *MLAS (Microsoft Linear Algebra Subprograms) + Eigen*</li><li>[Intel DNNL](https://www.onnxruntime.ai/docs/reference/execution-providers/DNNL-ExecutionProvider.html)</li></ul>|<ul><li>[NVIDIA CUDA](https://www.onnxruntime.ai/docs/reference/execution-providers/CUDA-ExecutionProvider.html)</li><li>[NVIDIA TensorRT](https://www.onnxruntime.ai/docs/reference/execution-providers/TensorRT-ExecutionProvider.html)</li><li>[DirectML](https://www.onnxruntime.ai/docs/reference/execution-providers/DirectML-ExecutionProvider.html)</li><li>[AMD MIGraphX](https://www.onnxruntime.ai/docs/reference/execution-providers/MIGraphX-ExecutionProvider.html) (*preview*)</li></ul>|<ul><li>[Intel OpenVINO](https://www.onnxruntime.ai/docs/reference/execution-providers/OpenVINO-ExecutionProvider.html)</li><li>[ARM Compute Library](https://www.onnxruntime.ai/docs/reference/execution-providers/ACL-ExecutionProvider.html) (*preview*)</li><li>[Android Neural Networks API](https://www.onnxruntime.ai/docs/reference/execution-providers/NNAPI-ExecutionProvider.html) (*preview*)</li><li>[ARM-NN](https://www.onnxruntime.ai/docs/reference/execution-providers/ArmNN-ExecutionProvider.html) (*preview*)</li><li>[Rockchip NPU](https://www.onnxruntime.ai/docs/reference/execution-providers/RKNPU-ExecutionProvider.html) (*preview*)</li></ul>|<ul><li>[Nuphar Model Compiler](https://www.onnxruntime.ai/docs/reference/execution-providers/Nuphar-ExecutionProvider.html) - (*preview*)</li><li>[Xilinx Vitis-AI](https://www.onnxruntime.ai/docs/reference/execution-providers/Vitis-AI-ExecutionProvider.html) (*preview*)</li></ul>| 
