<p align="center">
  <b>English</b> | <a href="README.fr.md">French</a> | <a href="README.es.md">Español</a> | <a href="README.de.md">Deutsch</a>
</p>
...
* **⚡ For Inference:** Enable faster customer experiences and lower costs. ONNX Runtime supports models from popular frameworks like **PyTorch** and **TensorFlow/Keras**, as well as classical libraries such as **scikit-learn**, **LightGBM**, and **XGBoost**. It's compatible with different hardware, drivers, and operating systems, providing optimal performance by leveraging hardware accelerators and graph optimizations. [Learn more &rarr;](https://www.onnxruntime.ai/docs/#onnx-runtime-for-inferencing)

* **🧠 For Training:** Accelerate model training time on multi-node NVIDIA GPUs for transformer models. It requires just a one-line addition to your existing PyTorch training scripts. [Learn more &rarr;](https://www.onnxruntime.ai/docs/#onnx-runtime-for-training)
...
| :--- | :--- |
| 🌐 **Website** | [onnxruntime.ai](https://onnxruntime.ai) - General information. |
| 📖 **Documentation** | [onnxruntime.ai/docs](https://onnxruntime.ai/docs) - Usage guides and tutorials. |
| 📺 **Video Tutorials** | [youtube.com/@ONNXRuntime](https://www.youtube.com/@ONNXRuntime) - Visual learning. |
| 🛣️ **Roadmap** | [onnxruntime.ai/roadmap](https://onnxruntime.ai/roadmap) - See upcoming features. |
| 💡 **Examples (Inference)** | [microsoft/onnxruntime-inference-examples](https://github.com/microsoft/onnxruntime-inference-examples) - Companion code repository. |
| 🏋️ **Examples (Training)** | [microsoft/onnxruntime-training-examples](https://github.com/microsoft/onnxruntime-training-examples) - Companion code repository. |
